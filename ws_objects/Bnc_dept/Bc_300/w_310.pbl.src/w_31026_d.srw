$PBExportHeader$w_31026_d.srw
$PBExportComments$브랜드,생산지,거래선별 전년대비 실적
forward
global type w_31026_d from w_com010_d
end type
end forward

global type w_31026_d from w_com010_d
end type
global w_31026_d w_31026_d

type variables
string is_brand, is_fr_year, is_to_year, is_fr_season, is_to_season, is_to_ymd, is_make_type
...
dw_print.object.t_make_type.text = "생산형태 : " + idw_make_type.getitemstring(idw_make_type.getrow(),"inter_nm")
end event

event pfc_preopen();call super::pfc_preopen;inv_resize.of_Register(dw_head, "ScaleToRight")
end event

type cb_close from w_com010_d`cb_close within w_31026_d
end type

type cb_delete from w_com010_d`cb_delete within w_31026_d
end type

type cb_insert from w_com010_d`cb_insert within w_31026_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_31026_d
end type

type cb_update from w_com010_d`cb_update within w_31026_d
end type

type cb_print from w_com010_d`cb_print within w_31026_d
end type

type cb_preview from w_com010_d`cb_preview within w_31026_d
end type

type gb_button from w_com010_d`gb_button within w_31026_d
end type

type cb_excel from w_com010_d`cb_excel within w_31026_d
end type

type dw_head from w_com010_d`dw_head within w_31026_d
integer height = 164
string dataobject = "d_31026_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_31026_d
integer beginy = 364
integer endy = 364
end type

type ln_2 from w_com010_d`ln_2 within w_31026_d
integer beginy = 368
integer endy = 368
end type

type dw_body from w_com010_d`dw_body within w_31026_d
integer y = 388
integer height = 1652
string dataobject = "d_31026_d01"
end type

type dw_print from w_com010_d`dw_print within w_31026_d
string dataobject = "d_31026_r01"
end type
