...
if LeftA(is_style_no,1) = 'T' then return
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_32000_e","0")
end event
...
event constructor;this.getchild("season_bae_su",idw_bae_su)
