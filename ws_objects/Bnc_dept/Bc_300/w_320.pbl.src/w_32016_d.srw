	...
	CASE "style_no"				
			...
			END IF
			   gst_cd.ai_div          = ai_div
				...
				gst_cd.default_where   = " where brand not in ('T') "		//WHERE TB_11010_M.PART_FG IN ('1', '2', '3') 
...
if ls_brand = 'N' OR ls_brand = 'J'   OR ls_brand = 'E'   OR ls_brand = 'M'  then
	dw_print.dataobject = 'd_32001_r02'
