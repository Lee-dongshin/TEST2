...
tab_1.tabpage_5.dw_5.SetTransObject(SQLCA)
		...
		Choose Case tab_1.SelectedTab
			Case 1
				il_rows = tab_1.tabpage_1.dw_1.retrieve(is_fr_ymd, is_to_ymd, is_brand, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
				lb_ret_chk1 = True
			Case 2
				il_rows = tab_1.tabpage_2.dw_2.retrieve(is_fr_ymd, is_to_ymd, is_brand, is_style, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
				lb_ret_chk2 = True
			Case 3
				il_rows = tab_1.tabpage_3.dw_3.retrieve(is_fr_ymd, is_to_ymd, is_brand, is_shop_cd, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
				lb_ret_chk3 = True
			Case 4
				il_rows = tab_1.tabpage_4.dw_4.retrieve(is_fr_ymd, is_to_ymd, is_brand, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)			
				lb_ret_chk4 = True
			Case 5
				il_rows = tab_1.tabpage_5.dw_5.retrieve(is_fr_ymd, is_to_ymd, is_brand, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
				lb_ret_chk1 = True
		END Choose
...
il_rows = dw_print.retrieve(is_fr_ymd,is_to_ymd, is_brand, is_fr_rtrn_sale, is_to_rtrn_sale, is_shop_cd, is_year, is_season)		  
			...
			Choose Case newindex
				Case 1
					If lb_ret_chk1 = False Then
						il_rows = This.Tabpage_1.dw_1.Retrieve(is_fr_ymd, is_to_ymd, is_brand, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
						lb_ret_chk1 = True
					End If
				Case 2
					If lb_ret_chk2 = False Then
						il_rows = This.Tabpage_2.dw_2.Retrieve(is_fr_ymd, is_to_ymd, is_brand, is_style, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
						lb_ret_chk2 = True
					End If
				Case 3
					If lb_ret_chk3 = False Then
						il_rows = This.Tabpage_3.dw_3.Retrieve(is_fr_ymd, is_to_ymd, is_brand, is_shop_cd, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
						lb_ret_chk3 = True
					End If
				Case 4
					If lb_ret_chk4 = False Then
						il_rows = This.Tabpage_4.dw_4.Retrieve(is_fr_ymd, is_to_ymd, is_brand, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
						lb_ret_chk4 = True
					End If
				Case 5
					If lb_ret_chk5 = False Then
						il_rows = This.Tabpage_5.dw_5.Retrieve(is_fr_ymd, is_to_ymd, is_brand, is_fr_rtrn_sale, is_to_rtrn_sale, is_year, is_season)
						lb_ret_chk1 = True
					End If
			End Choose
