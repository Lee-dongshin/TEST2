$PBExportHeader$w_47015_d.srw
$PBExportComments$직영몰기간별판매현황
forward
global type w_47015_d from w_com010_d
end type
type dw_1 from datawindow within w_47015_d
end type
end forward
...
global w_47015_d w_47015_d

type variables
DataWindowChild idw_shop_cd
string is_fr_ymd, is_to_ymd, is_brand, is_style, is_chno, is_gubn, is_order_stat, is_stat, is_fr_yymm, is_to_yymm
end variables
...
il_rows = dw_1.retrieve(is_fr_yymm, is_to_yymm, is_brand, is_style, is_chno, is_gubn, is_order_stat, is_stat )
...
type cb_close from w_com010_d`cb_close within w_47015_d
end type

type cb_delete from w_com010_d`cb_delete within w_47015_d
end type

type cb_insert from w_com010_d`cb_insert within w_47015_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_47015_d
end type

type cb_update from w_com010_d`cb_update within w_47015_d
end type

type cb_print from w_com010_d`cb_print within w_47015_d
end type

type cb_preview from w_com010_d`cb_preview within w_47015_d
end type

type gb_button from w_com010_d`gb_button within w_47015_d
end type

type cb_excel from w_com010_d`cb_excel within w_47015_d
end type

type dw_head from w_com010_d`dw_head within w_47015_d
integer x = 5
integer y = 160
integer width = 4114
integer height = 192
string dataobject = "d_47015_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_47015_d
integer beginy = 360
integer endy = 360
end type

type ln_2 from w_com010_d`ln_2 within w_47015_d
integer beginy = 364
integer endy = 364
end type

type dw_body from w_com010_d`dw_body within w_47015_d
integer y = 1336
integer height = 656
string dataobject = "d_47015_d02"
...
type dw_print from w_com010_d`dw_print within w_47015_d
...
/*===========================================================================*/
long ll_rows
string ls_brand, ls_yymm, ls_stat, ls_gubn
...
dw_body.retrieve(ls_yymm, ls_brand, ls_stat, ls_gubn)
