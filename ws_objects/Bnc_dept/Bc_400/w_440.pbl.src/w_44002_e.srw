$PBExportHeader$w_44002_e.srw
$PBExportComments$매장실사등록
forward
global type w_44002_e from w_com010_e
end type
type dw_color from datawindow within w_44002_e
end type
type dw_size from datawindow within w_44002_e
end type
end forward
...
type cb_close from w_com010_e`cb_close within w_44002_e
end type

type cb_delete from w_com010_e`cb_delete within w_44002_e
end type

type cb_insert from w_com010_e`cb_insert within w_44002_e
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_44002_e
end type

type cb_update from w_com010_e`cb_update within w_44002_e
end type

type cb_print from w_com010_e`cb_print within w_44002_e
end type

type cb_preview from w_com010_e`cb_preview within w_44002_e
end type

type gb_button from w_com010_e`gb_button within w_44002_e
end type

type cb_excel from w_com010_e`cb_excel within w_44002_e
end type

type dw_head from w_com010_e`dw_head within w_44002_e
integer y = 160
integer height = 292
string dataobject = "d_44002_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_44002_e
integer beginy = 468
integer endy = 468
end type

type ln_2 from w_com010_e`ln_2 within w_44002_e
integer beginy = 472
integer endy = 472
end type

type dw_body from w_com010_e`dw_body within w_44002_e
integer x = 14
integer y = 484
integer width = 3557
integer height = 1552
...
type dw_print from w_com010_e`dw_print within w_44002_e
integer x = 2510
integer y = 1464
end type
