$PBExportHeader$w_41003_d.srw
$PBExportComments$생산입고명세서
forward
global type w_41003_d from w_com020_d
end type
type dw_list1 from u_dw within w_41003_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_41003_d","0")
end event

type cb_close from w_com020_d`cb_close within w_41003_d
integer taborder = 120
end type

type cb_delete from w_com020_d`cb_delete within w_41003_d
integer taborder = 70
end type

type cb_insert from w_com020_d`cb_insert within w_41003_d
integer taborder = 60
end type

type cb_retrieve from w_com020_d`cb_retrieve within w_41003_d
end type

type cb_update from w_com020_d`cb_update within w_41003_d
integer taborder = 110
end type

type cb_print from w_com020_d`cb_print within w_41003_d
integer taborder = 80
end type

type cb_preview from w_com020_d`cb_preview within w_41003_d
integer taborder = 90
end type

type gb_button from w_com020_d`gb_button within w_41003_d
end type

type cb_excel from w_com020_d`cb_excel within w_41003_d
integer taborder = 100
end type

type dw_head from w_com020_d`dw_head within w_41003_d
integer x = 32
integer y = 164
integer height = 216
string dataobject = "d_41003_h01"
end type
...
type ln_1 from w_com020_d`ln_1 within w_41003_d
integer beginy = 384
integer endy = 384
end type

type ln_2 from w_com020_d`ln_2 within w_41003_d
integer beginy = 388
integer endy = 388
end type

type dw_list from w_com020_d`dw_list within w_41003_d
integer y = 996
integer width = 2619
integer height = 1032
string dataobject = "d_41003_d02"
end type
...
type dw_body from w_com020_d`dw_body within w_41003_d
integer x = 2665
integer y = 996
integer width = 928
integer height = 1036
string dataobject = "d_41003_d03"
end type

type st_1 from w_com020_d`st_1 within w_41003_d
integer x = 2647
integer y = 992
integer height = 1036
end type

type dw_print from w_com020_d`dw_print within w_41003_d
integer x = 1266
integer y = 1576
end type
