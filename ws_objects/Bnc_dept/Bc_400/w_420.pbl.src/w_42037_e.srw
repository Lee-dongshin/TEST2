$PBExportHeader$w_42037_e.srw
$PBExportComments$매장 반품 승인 작업
forward
global type w_42037_e from w_com020_e
end type
type hpb_1 from hprogressbar within w_42037_e
end type
type st_2 from statictext within w_42037_e
end type
type st_3 from statictext within w_42037_e
end type
type rb_1 from radiobutton within w_42037_e
end type
type rb_2 from radiobutton within w_42037_e
end type
end forward
...
dw_print.DataObject = 'd_42037_r01'
...
FOR i=1 TO ll_row_count
  ...
  IF idw_status = DataModified! and ls_proc_yn = "Y" THEN				/* New Record */
	 ...
	 where yymmdd    = :ls_yymmdd
		...
		Rot_Shop_type,	Rqst_Gubn,	Rqst_Date,	Rqst_No,			Rqst_Chno,	Shop_Ymd,
		Brand,		Year,				Season,		Item,				Sojae,		trigger_yn,
		Reg_id,		Reg_Dt,			:gs_user_id,		getdate(),			isnull(PDA_NO,'S001'),		TRAN_CUST,
		BOX_SIZE,	BOX_NO,			Note											  
		 from tb_42021_shop								  
		 where yymmdd    = :ls_yymmdd
		   and out_no    = :ls_out_no
...
type cb_close from w_com020_e`cb_close within w_42037_e
end type

type cb_delete from w_com020_e`cb_delete within w_42037_e
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_42037_e
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_42037_e
end type

type cb_update from w_com020_e`cb_update within w_42037_e
end type

type cb_print from w_com020_e`cb_print within w_42037_e
integer x = 1499
end type

type cb_preview from w_com020_e`cb_preview within w_42037_e
integer x = 1842
end type

type gb_button from w_com020_e`gb_button within w_42037_e
end type

type cb_excel from w_com020_e`cb_excel within w_42037_e
boolean visible = false
integer x = 2185
end type

type dw_head from w_com020_e`dw_head within w_42037_e
integer y = 148
integer width = 3543
integer height = 208
string dataobject = "d_42037_h01"
end type
...
type ln_1 from w_com020_e`ln_1 within w_42037_e
integer beginy = 356
integer endy = 356
end type

type ln_2 from w_com020_e`ln_2 within w_42037_e
integer beginy = 360
integer endy = 360
end type

type dw_list from w_com020_e`dw_list within w_42037_e
integer x = 14
integer y = 376
integer width = 1751
integer height = 1624
string dataobject = "d_42037_d01"
...
type dw_body from w_com020_e`dw_body within w_42037_e
integer x = 1778
integer y = 376
integer width = 1829
integer height = 1624
string dataobject = "d_42037_d02"
end type
...
type st_1 from w_com020_e`st_1 within w_42037_e
integer x = 1765
integer y = 376
integer height = 1624
end type

type dw_print from w_com020_e`dw_print within w_42037_e
integer x = 14
integer y = 432
