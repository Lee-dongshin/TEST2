$PBExportHeader$w_42046_d.srw
$PBExportComments$백화점EDI용 화일 생겅
forward
global type w_42046_d from w_com010_d
end type
type st_1 from statictext within w_42046_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_43046_d","0")
end event
...
if is_opt_gubn = "A" then
	dw_body.DataObject = "d_42046_d01"
	dw_body.SetTransObject(SQLCA)
else	
	dw_body.DataObject = "d_42046_d02"
	dw_body.SetTransObject(SQLCA)
end if	
...
type cb_close from w_com010_d`cb_close within w_42046_d
end type

type cb_delete from w_com010_d`cb_delete within w_42046_d
end type

type cb_insert from w_com010_d`cb_insert within w_42046_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_42046_d
end type

type cb_update from w_com010_d`cb_update within w_42046_d
end type

type cb_print from w_com010_d`cb_print within w_42046_d
boolean visible = false
end type

type cb_preview from w_com010_d`cb_preview within w_42046_d
boolean visible = false
end type

type gb_button from w_com010_d`gb_button within w_42046_d
end type

type cb_excel from w_com010_d`cb_excel within w_42046_d
integer x = 37
integer y = 40
integer width = 384
string text = "화일생성(&E)"
...
type dw_head from w_com010_d`dw_head within w_42046_d
integer y = 168
integer height = 280
string dataobject = "d_42046_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_42046_d
integer beginy = 468
integer endy = 468
end type

type ln_2 from w_com010_d`ln_2 within w_42046_d
integer beginy = 472
integer endy = 472
end type

type dw_body from w_com010_d`dw_body within w_42046_d
integer y = 484
integer height = 1556
string dataobject = "d_42046_d02"
end type

type dw_print from w_com010_d`dw_print within w_42046_d
end type
