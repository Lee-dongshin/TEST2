...
String is_to_shop_cd, is_to_shop_type, is_to_yymmdd, is_to_out_no , is_brand_grp
end variables
...
decimal   ldc_Marjin,	ldc_dc_Rate,ll_Tag_Price
   ...
   select sojae,  year, 
	      season, item, brand
	into :ls_sojae, :ls_year, :ls_season, :ls_item, :ls_brand
   ...
   dw_out.setitem(li_row, "Out_NO", is_to_out_no)
	...
	dw_out.setitem(li_row, "Brand", ls_brand)
