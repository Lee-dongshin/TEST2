...
inv_resize.of_Register(rb_year,  "FixedToRight")

end event

event type long ue_update();string ls_out_ymd, ls_proc_yn, ls_style, ls_color, ls_size
Integer li_deal_seq
...
dwbuffer	lb_source_buffer, &
			lb_target_buffer
string ls_out_ymd, ls_style, ls_color, ls_size
