$PBExportHeader$w_42034_d.srw
$PBExportComments$BOX출고관리조회
forward
global type w_42034_d from w_com010_d
end type
type st_1 from statictext within w_42034_d
end type
type st_2 from statictext within w_42034_d
end type
end forward
...
if is_print_opt = "N" then
	if is_opt_gubn = "A" then 
		dw_body.DataObject = "d_42034_d01"
		dw_body.SetTransObject(SQLCA)
	elseIF is_opt_gubn = "B" then 
		dw_body.DataObject = "d_42034_d02"
		dw_body.SetTransObject(SQLCA)
	else	
		dw_body.DataObject = "d_42034_d03"
		dw_body.SetTransObject(SQLCA)	
	end if	
ELSE
		dw_body.DataObject = "d_42034_d04"
		dw_body.SetTransObject(SQLCA)			
END IF	
...
if is_print_opt = "N" then
	...
	dw_body.ShareData(dw_print)
		...
		dw_print.DataObject = "d_42034_r04"
		dw_print.SetTransObject(SQLCA)		

		ls_datetime = String(ld_datetime, "yyyy/mm/dd-hh:mm:ss")
		
		ls_modify =	"t_yymmdd.Text = '" + String(is_TO_yymmdd, '@@@@/@@/@@') + "'" + &														
						"t_mng_cust.Text = '" + idw_mng_cust.GetItemString(idw_mng_cust.GetRow(), "inter_display") + "'"  		
		dw_print.Modify(ls_modify)
	
	dw_print.Object.DataWindow.Print.Orientation = 1  // 0:세로, 1:가로
//	dw_print.Object.DataWindow.Zoom = 78
	dw_print.retrieve(is_brand, is_frm_yymmdd, is_TO_yymmdd, is_mng_cust, is_except_gubn)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_42034_d","0")
end event

type cb_close from w_com010_d`cb_close within w_42034_d
end type

type cb_delete from w_com010_d`cb_delete within w_42034_d
end type

type cb_insert from w_com010_d`cb_insert within w_42034_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_42034_d
end type

type cb_update from w_com010_d`cb_update within w_42034_d
end type

type cb_print from w_com010_d`cb_print within w_42034_d
end type

type cb_preview from w_com010_d`cb_preview within w_42034_d
end type

type gb_button from w_com010_d`gb_button within w_42034_d
end type

type cb_excel from w_com010_d`cb_excel within w_42034_d
end type

type dw_head from w_com010_d`dw_head within w_42034_d
integer x = 18
integer y = 156
integer width = 3506
integer height = 216
string dataobject = "d_42034_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_42034_d
integer beginy = 384
integer endy = 384
end type

type ln_2 from w_com010_d`ln_2 within w_42034_d
integer beginy = 388
integer endy = 388
end type

type dw_body from w_com010_d`dw_body within w_42034_d
integer x = 9
integer y = 392
integer width = 3598
integer height = 1620
string dataobject = "d_42034_d02"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

type dw_print from w_com010_d`dw_print within w_42034_d
integer x = 2368
integer y = 1068
string dataobject = "d_42034_r01"
end type
