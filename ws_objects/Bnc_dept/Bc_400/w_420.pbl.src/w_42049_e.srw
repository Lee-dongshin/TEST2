...
type rb_year_season from radiobutton within w_42049_e
end type
end forward
...
this.rb_year_season=create rb_year_season
...
this.Control[iCurrent+6]=this.rb_year_season
end on
...
//	and   BRAND      = :is_brand
	...
	if ll_ok > 0  then 
		...
		return -1
			...
			from tb_52031_WORK with (nolock)
