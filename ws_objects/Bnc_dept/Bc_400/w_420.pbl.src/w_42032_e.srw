$PBExportHeader$w_42032_e.srw
$PBExportComments$박스출고(Assist)
forward
global type w_42032_e from w_com010_e
end type
type cb_new from cb_retrieve within w_42032_e
end type
type dw_1 from datawindow within w_42032_e
end type
end forward
...
dw_print.retrieve(is_brand,is_out_date, is_out_no, is_mng_cust, is_work_date, is_out_ymd, is_reg_dt)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_42032_e","0")
end event
...
type cb_close from w_com010_e`cb_close within w_42032_e
integer taborder = 110
end type

type cb_delete from w_com010_e`cb_delete within w_42032_e
integer taborder = 60
boolean enabled = true
end type

type cb_insert from w_com010_e`cb_insert within w_42032_e
integer taborder = 50
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_42032_e
end type

type cb_update from w_com010_e`cb_update within w_42032_e
integer taborder = 100
end type

type cb_print from w_com010_e`cb_print within w_42032_e
integer taborder = 70
end type

type cb_preview from w_com010_e`cb_preview within w_42032_e
integer taborder = 80
end type

type gb_button from w_com010_e`gb_button within w_42032_e
end type

type cb_excel from w_com010_e`cb_excel within w_42032_e
integer taborder = 90
end type

type dw_head from w_com010_e`dw_head within w_42032_e
integer x = 23
integer y = 168
integer width = 3584
integer height = 188
string dataobject = "d_42032_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_42032_e
integer beginy = 360
integer endy = 360
end type

type ln_2 from w_com010_e`ln_2 within w_42032_e
integer beginy = 364
integer endy = 364
end type

type dw_body from w_com010_e`dw_body within w_42032_e
integer x = 14
integer y = 376
integer height = 1672
integer taborder = 40
string dataobject = "d_42032_d01"
end type
...
event dw_body::itemfocuschanged;call super::itemfocuschanged;This.SelectRow(0, FALSE)
This.SelectRow(row, TRUE)
end event

type dw_print from w_com010_e`dw_print within w_42032_e
integer x = 1321
integer y = 100
