$PBExportHeader$w_42012_d.srw
$PBExportComments$매장별 출고현황(소재별)
forward
global type w_42012_d from w_com010_d
end type
end forward

global type w_42012_d from w_com010_d
end type
global w_42012_d w_42012_d

type variables
String is_brand, is_yymmdd_st, is_yymmdd_ed, is_shop_cd, is_shop_type, is_shop_div, is_year, is_season
DataWindowChild idw_brand, idw_shop_type, idw_shop_div, idw_year, idw_season
end variables
...
il_rows = dw_body.retrieve(is_brand, is_yymmdd_st, is_yymmdd_ed, is_shop_cd, is_shop_type, is_shop_div, is_year, is_season)
...
dw_print.retrieve(is_brand, is_yymmdd_st, is_yymmdd_ed, is_shop_cd, is_shop_type, is_shop_div, is_year, is_season)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_42012_d","0")
end event

type cb_close from w_com010_d`cb_close within w_42012_d
end type

type cb_delete from w_com010_d`cb_delete within w_42012_d
end type

type cb_insert from w_com010_d`cb_insert within w_42012_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_42012_d
end type

type cb_update from w_com010_d`cb_update within w_42012_d
end type

type cb_print from w_com010_d`cb_print within w_42012_d
end type

type cb_preview from w_com010_d`cb_preview within w_42012_d
end type

type gb_button from w_com010_d`gb_button within w_42012_d
end type

type cb_excel from w_com010_d`cb_excel within w_42012_d
end type

type dw_head from w_com010_d`dw_head within w_42012_d
integer y = 152
integer height = 320
string dataobject = "d_42012_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_42012_d
integer beginy = 476
integer endy = 476
end type

type ln_2 from w_com010_d`ln_2 within w_42012_d
integer beginy = 480
integer endy = 480
end type

type dw_body from w_com010_d`dw_body within w_42012_d
integer x = 9
integer y = 492
integer width = 3593
integer height = 1552
string dataobject = "d_42012_d01"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

type dw_print from w_com010_d`dw_print within w_42012_d
integer x = 155
integer y = 188
string dataobject = "d_42012_r01"
end type
