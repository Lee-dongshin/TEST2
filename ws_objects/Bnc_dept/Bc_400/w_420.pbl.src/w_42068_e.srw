$PBExportHeader$w_42068_e.srw
$PBExportComments$매장 반품 미승인건 작업
forward
global type w_42068_e from w_com020_e
end type
type hpb_1 from hprogressbar within w_42068_e
end type
type st_2 from statictext within w_42068_e
end type
type st_3 from statictext within w_42068_e
end type
end forward
...
String ls_ErrMsg, ls_proc_yn, ls_box_ymd, ls_box_no, ls_yymmdd, ls_out_no, ls_no, ls_out_no_house, ls_no_house
String ls_shop_cd, ls_shop_type, ls_rtn_ymd
long i, ll_row_count, ll_sqlcode, ll_cnt
datetime ld_datetime

IF dw_body.AcceptText() <> 1 THEN RETURN -1

IF MessageBox("확인", "선택한 제품을 반송처리 하시겠습니까 ?", Question!, YesNo! ) = 2 THEN 
	RETURN 0 
END IF
...
ls_rtn_ymd = string(ld_datetime,"yyyymmdd")
...
FOR i=1 TO ll_row_count
  ...
  IF idw_status = DataModified! and ls_proc_yn = "Y" THEN				/* New Record */
	 ...
	 insert into tb_42037_h								  
			select yymmdd, Shop_CD, Shop_Type, Out_NO, House_CD, Jup_gubn, Sale_Type, Margin_Rate, disc_Rate, NO,
					Style, Chno, Color, Size, class, Tag_Price, Curr_Price, Out_Price, Qty, Tag_Amt, Curr_Amt, Rtrn_collect, Vat,
					Rot_Shop, Rot_Shop_type, Rqst_Gubn, Rqst_Date, Rqst_No, Rqst_Chno, Shop_Ymd, Brand, Year, Season, Item,
					Sojae, trigger_yn, Reg_id, Reg_Dt, Mod_id, Mod_Dt, PDA_NO, TRAN_CUST, BOX_SIZE, BOX_NO,
					'반품적용: ' + :gs_user_id + '-' + :ls_rtn_ymd,
					'N'							  
		  from tb_42021_shop
        ...
        delete 
		 ...
		 where yymmdd    = :ls_yymmdd
		   and out_no    = :ls_out_no
			...
			update tb_42026_h set proc_yn = 'R'
...
//창고내역 수정
			update tb_42026_h_house set proc_yn = 'R'
		    where box_ymd  = :ls_box_ymd
		    and   shop_cd  = :ls_shop_cd
		    and   box_no   = :ls_box_no
...
messagebox("처리 완료!", "총" + string(ll_cnt) + "개의 제품이 반송처리 되었습니다!")
dw_body.reset()
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_42038_e","0")
end event

type cb_close from w_com020_e`cb_close within w_42068_e
end type

type cb_delete from w_com020_e`cb_delete within w_42068_e
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_42068_e
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_42068_e
end type

type cb_update from w_com020_e`cb_update within w_42068_e
string text = "처리(&S)"
end type

type cb_print from w_com020_e`cb_print within w_42068_e
integer x = 1499
end type

type cb_preview from w_com020_e`cb_preview within w_42068_e
boolean visible = false
end type

type gb_button from w_com020_e`gb_button within w_42068_e
end type

type cb_excel from w_com020_e`cb_excel within w_42068_e
boolean visible = false
end type

type dw_head from w_com020_e`dw_head within w_42068_e
integer y = 144
integer width = 3323
integer height = 208
string dataobject = "d_42068_h01"
end type
...
type ln_1 from w_com020_e`ln_1 within w_42068_e
integer beginy = 352
integer endy = 352
end type

type ln_2 from w_com020_e`ln_2 within w_42068_e
integer beginy = 356
integer endy = 356
end type

type dw_list from w_com020_e`dw_list within w_42068_e
integer x = 14
integer y = 364
integer width = 2263
integer height = 1636
string dataobject = "d_42068_d01"
...
type dw_body from w_com020_e`dw_body within w_42068_e
integer x = 2299
integer y = 364
integer width = 1307
integer height = 1640
string dataobject = "d_42068_d02"
end type
...
CHOOSE CASE dwo.name
	CASE "cb_select"
		If This.Object.cb_select.Text = '전체반송' then
			ls_select = 'Y'
			This.Object.cb_select.Text = '전체제외'
			ib_changed = true
		...
		Else
			ls_select = 'N'
			This.Object.cb_select.Text = '전체반송'
			ib_changed = false
         cb_update.enabled = false
		End If
...
type st_1 from w_com020_e`st_1 within w_42068_e
integer x = 2277
integer y = 364
integer height = 1656
end type

type dw_print from w_com020_e`dw_print within w_42068_e
string dataobject = "d_42068_r01"
end type
