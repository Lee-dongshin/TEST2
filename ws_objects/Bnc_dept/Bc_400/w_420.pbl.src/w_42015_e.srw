...
String is_shop_cd, is_shop_type , is_brand_grp
...
CHOOSE CASE as_column
	...
	CASE "style_no"		
		   ...
		   gst_cd.ai_div          = ai_div
			...
			gst_cd.default_where   = "WHERE  '" + is_brand_grp + "' like '%' + brand + '%'" //"WHERE brand = '" + is_brand + "' "
			IF is_shop_type = '1' THEN 
...
IF gf_style_outno (is_yymmdd, is_brand, ls_out_no1 ) = FALSE THEN
	RETURN -1 
END IF

/*
select right( convert(char(05), convert(decimal(5), isnull(max(bill_no)  + 1 , 0) ) + 10001),4)
into :ls_out_no1
from tb_99000_m
...
FOR i=1 TO ll_row_count
   ...
   IF idw_status = NewModified! THEN				/* New Record */
      ...
      dw_body.Setitem(i, "shop_type", is_shop_type)
		IF is_jup_gubn = '02' and LenA(is_shop_cd) = 6 THEN
         dw_1.Setitem(i, "out_no", ls_out_no1)
