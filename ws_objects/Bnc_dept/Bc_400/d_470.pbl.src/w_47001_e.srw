...
string ls_sale_ymd, ls_invoice_no, ls_prod_no, ls_settle_ymd, ls_tran_ymd,ls_style_chk	, ls_db, ls_order_no_sub,ls_invoice_no_rtn, ls_db_original
long ll_qty	
...
//						if ( ls_shop_cd = 'ND1970' or ls_shop_cd = 'JD1970' ) then 
//							messagebox("ls_order_no_sub", (len(trim(ls_order_no_sub))))
//							messagebox("ls_order_no_sub", ls_order_no_sub)
//							messagebox("ls_order_no", (len(trim(ls_order_no))))
//						end if
						
						if ( ls_shop_cd = 'ND1970' or ls_shop_cd = 'JD1970' ) and LenA(trim(ls_order_no_sub)) >= LenA(trim(ls_order_no))  then
