$PBExportHeader$w_43025_e.srw
$PBExportComments$실사재고 수기등록(스캐너)
forward
global type w_43025_e from w_com010_e
end type
type dw_color from datawindow within w_43025_e
end type
type dw_size from datawindow within w_43025_e
end type
type dw_view from datawindow within w_43025_e
end type
end forward
...
type cb_close from w_com010_e`cb_close within w_43025_e
integer taborder = 130
end type

type cb_delete from w_com010_e`cb_delete within w_43025_e
integer taborder = 70
end type

type cb_insert from w_com010_e`cb_insert within w_43025_e
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_43025_e
end type

type cb_update from w_com010_e`cb_update within w_43025_e
integer taborder = 120
end type

type cb_print from w_com010_e`cb_print within w_43025_e
integer taborder = 90
end type

type cb_preview from w_com010_e`cb_preview within w_43025_e
integer taborder = 100
end type

type gb_button from w_com010_e`gb_button within w_43025_e
end type

type cb_excel from w_com010_e`cb_excel within w_43025_e
boolean visible = false
integer taborder = 110
end type

type dw_head from w_com010_e`dw_head within w_43025_e
integer y = 160
integer width = 3406
integer height = 224
string dataobject = "d_43025_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_43025_e
integer beginy = 384
integer endy = 384
end type

type ln_2 from w_com010_e`ln_2 within w_43025_e
integer beginy = 388
integer endy = 388
end type

type dw_body from w_com010_e`dw_body within w_43025_e
event ue_set_column ( long al_row )
integer x = 14
integer y = 400
integer height = 1612
string dataobject = "d_43025_D01"
...
type dw_print from w_com010_e`dw_print within w_43025_e
integer x = 2510
integer y = 1464
