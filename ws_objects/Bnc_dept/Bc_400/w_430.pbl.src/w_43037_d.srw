...
type st_2 from statictext within w_43037_d
end type
type rb_i from radiobutton within w_43037_d
end type
type rb_j from radiobutton within w_43037_d
end type
type rb_k from radiobutton within w_43037_d
end type
type rb_l from radiobutton within w_43037_d
end type
...
type variables
Datawindowchild idw_brand, idw_shop_type, idw_year, idw_season, idw_house_cd, idw_shop_brand
String is_brand, is_shop_cd, is_yymmdd, is_shop_type, is_year, is_season, is_style_no, is_gubn, is_house_cd, is_shop_brand
...
this.Control[iCurrent+21]=this.rb_i
this.Control[iCurrent+22]=this.rb_j
this.Control[iCurrent+23]=this.rb_k
this.Control[iCurrent+24]=this.rb_l
...
if IsNull(is_shop_brand) or Trim(is_shop_brand) = "" then
   MessageBox(ls_title,"매장브랜드 코드를 입력하십시요!")
   dw_head.SetFocus()
...
il_rows = dw_body.retrieve(is_yymmdd, is_brand, is_shop_cd, is_shop_type, is_house_cd, is_style_no, is_year, is_season, '%','%','%',is_shop_div,is_shop_div2,is_shop_div3,is_shop_div4,is_shop_div5,is_shop_div6,is_shop_div7,is_shop_div8,is_shop_div9,is_shop_div10,'%' ,is_gubn, is_shop_brand)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
idw_shop_brand.InsertRow(1)
idw_shop_brand.SetItem(1, "inter_cd", '%')
idw_shop_brand.SetItem(1, "inter_nm", '전체')
end event
...
long textcolor = 255
long backcolor = 67108864
string text = "※ 당일 기준이외의 경우 조회에 상당한 시간이 필요합니다."
boolean focusrectangle = false
end type
