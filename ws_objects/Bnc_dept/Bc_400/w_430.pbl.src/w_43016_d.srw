...
string is_brand, is_shop_cd, is_shop_type, is_style, is_chno, is_st_brand
...
il_rows = dw_body.retrieve(is_base_yymmdd, is_silsa_yymmdd, is_brand, is_shop_cd, is_shop_type, is_year, is_season,  is_style_opt,is_opt_visible,is_st_brand)
IF il_rows > 0 THEN
   dw_body.SetFocus()
