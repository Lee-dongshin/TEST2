...
type variables
DataWindowChild idw_brand, idw_shop_type, idw_year,idw_season, idw_sojae, idw_item, idw_st_brand
string is_brand, is_yymmdd, is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_chno_gubn, is_st_brand
...
il_rows = dw_body.retrieve(is_yymmdd, is_brand, is_shop_cd, IS_SHOP_TYPE,  is_year, is_season, is_sojae, is_item, is_chno_gubn, is_st_brand)
IF il_rows > 0 THEN
   dw_body.SetFocus()
