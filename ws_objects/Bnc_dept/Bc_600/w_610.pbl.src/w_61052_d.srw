...
if rb_1.checked  then
	...
	ll_row1 = dw_print.retrieve(is_brand, is_year, is_season,is_sojae,is_item,is_frm_yymmdd, is_to_yymmdd,il_ranking, is_opt_orderby, is_dep_fg, is_shop_cd, is_fr_out_ymd, is_to_out_ymd, is_plan_fg, is_spot, is_bujin, is_halin, is_halin_exc )	
elseif rb_2.checked then 
	...
	ll_row1 = dw_print.retrieve(is_brand, is_year, is_season,is_sojae,is_item,il_out_day,il_sale_qty,il_sale_rate,il_ranking, is_opt_orderby, is_shop_cd, is_fr_out_ymd, is_to_out_ymd, is_plan_fg, is_spot, is_bujin, is_halin, is_frm_yymmdd, is_to_yymmdd, is_dep_fg, is_halin_exc)	
end if
