$PBExportHeader$w_61038_old.srw
$PBExportComments$경영정보손익
forward
global type w_61038_old from w_com010_d
end type
end forward

global type w_61038_old from w_com010_d
end type
global w_61038_old w_61038_old
...
on w_61038_old.create
call super::create
end on

on w_61038_old.destroy
call super::destroy
...
type cb_close from w_com010_d`cb_close within w_61038_old
end type

type cb_delete from w_com010_d`cb_delete within w_61038_old
end type

type cb_insert from w_com010_d`cb_insert within w_61038_old
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_61038_old
end type

type cb_update from w_com010_d`cb_update within w_61038_old
end type

type cb_print from w_com010_d`cb_print within w_61038_old
end type

type cb_preview from w_com010_d`cb_preview within w_61038_old
end type

type gb_button from w_com010_d`gb_button within w_61038_old
end type

type cb_excel from w_com010_d`cb_excel within w_61038_old
end type

type dw_head from w_com010_d`dw_head within w_61038_old
...
type ln_1 from w_com010_d`ln_1 within w_61038_old
end type

type ln_2 from w_com010_d`ln_2 within w_61038_old
end type

type dw_body from w_com010_d`dw_body within w_61038_old
string dataobject = "d_61038_d01"
end type

type dw_print from w_com010_d`dw_print within w_61038_old
