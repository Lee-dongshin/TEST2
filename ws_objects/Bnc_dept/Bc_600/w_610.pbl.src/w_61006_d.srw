...
type dw_4 from datawindow within w_61006_d
end type
type rb_5 from radiobutton within w_61006_d
end type
end forward
...
long backcolor = 67108864
string text = "라빠레트 사업부(2014.05월부로 면세점 구분)"
borderstyle borderstyle = stylelowered!
end type
...
tab_1.tabpage_1.dw_1.dataObject = "d_61006_d11"
tab_1.tabpage_1.dw_1.SetTransObject(SQLCA)

tab_1.tabpage_2.dw_2.dataObject = "d_61006_d12"
tab_1.tabpage_2.dw_2.SetTransObject(SQLCA)

tab_1.tabpage_3.dw_3.dataObject = "d_61006_d13"
tab_1.tabpage_3.dw_3.SetTransObject(SQLCA)
