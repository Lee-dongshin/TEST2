$PBExportHeader$w_81002_e.srw
$PBExportComments$역량평가등록(개인)
forward
global type w_81002_e from w_com010_e
end type
end forward

global type w_81002_e from w_com010_e
end type
global w_81002_e w_81002_e
...
type cb_close from w_com010_e`cb_close within w_81002_e
end type

type cb_delete from w_com010_e`cb_delete within w_81002_e
end type

type cb_insert from w_com010_e`cb_insert within w_81002_e
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_81002_e
end type

type cb_update from w_com010_e`cb_update within w_81002_e
end type

type cb_print from w_com010_e`cb_print within w_81002_e
end type

type cb_preview from w_com010_e`cb_preview within w_81002_e
end type

type gb_button from w_com010_e`gb_button within w_81002_e
end type

type cb_excel from w_com010_e`cb_excel within w_81002_e
end type

type dw_head from w_com010_e`dw_head within w_81002_e
integer y = 160
integer width = 3561
integer height = 168
string dataobject = "d_81002_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_81002_e
integer beginy = 344
integer endy = 344
end type

type ln_2 from w_com010_e`ln_2 within w_81002_e
integer beginy = 348
integer endy = 348
end type

type dw_body from w_com010_e`dw_body within w_81002_e
integer y = 368
integer height = 1672
string dataobject = "d_81002_d01"
end type
...
type dw_print from w_com010_e`dw_print within w_81002_e
integer x = 1998
integer y = 480
end type
