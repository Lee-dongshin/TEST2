$PBExportHeader$w_81107_e.srw
$PBExportComments$인사평가(2차상사)
forward
global type w_81107_e from w_com020_e
end type
type dw_1 from datawindow within w_81107_e
end type
type dw_2 from datawindow within w_81107_e
end type
end forward
...
il_rows = dw_print.retrieve(is_yyyy, is_key_value, is_jikgun_type, is_first_staff, is_second_staff, 'C')
...
type cb_close from w_com020_e`cb_close within w_81107_e
end type

type cb_delete from w_com020_e`cb_delete within w_81107_e
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_81107_e
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_81107_e
end type

type cb_update from w_com020_e`cb_update within w_81107_e
end type

type cb_print from w_com020_e`cb_print within w_81107_e
boolean visible = false
end type

type cb_preview from w_com020_e`cb_preview within w_81107_e
end type

type gb_button from w_com020_e`gb_button within w_81107_e
end type

type cb_excel from w_com020_e`cb_excel within w_81107_e
end type

type dw_head from w_com020_e`dw_head within w_81107_e
integer y = 164
integer height = 164
string dataobject = "d_81107_H01"
end type

type ln_1 from w_com020_e`ln_1 within w_81107_e
integer beginy = 352
integer endy = 352
end type

type ln_2 from w_com020_e`ln_2 within w_81107_e
integer beginy = 356
integer endy = 356
end type

type dw_list from w_com020_e`dw_list within w_81107_e
integer y = 380
integer width = 1065
integer height = 1660
string dataobject = "d_81107_L01"
end type
...
type dw_body from w_com020_e`dw_body within w_81107_e
integer x = 1111
integer y = 720
integer width = 2491
integer height = 616
string dataobject = "d_81107_d01"
...
type st_1 from w_com020_e`st_1 within w_81107_e
integer x = 1093
integer y = 380
integer height = 1660
end type
...
type dw_print from w_com020_e`dw_print within w_81107_e
integer x = 110
integer y = 896
	...
	CASE "cf_flag"	     //  Popup 검색창이 존재하는 항목 
		...
		if data = '1' then 
			for i = 1 to dw_body.rowcount()
				ls_grade = dw_body.getitemstring(i,"second_grade")
				...
				if ls_value_code <> 'C' and (isnull(ls_grade) or ls_grade = '') then
					...
					dw_body.setfocus()
					dw_body.setrow(i)
					dw_body.setcolumn('second_grade')
					return 1
				elseif ls_value_code = 'C' then
					ls_grade = dw_body.getitemstring(i,"second_grade")
					ls_sub_title = dw_body.getitemstring(i,"sub_title")
					if MidA(ls_sub_title,4,10)='2차 상사' and (isnull(ls_grade) or ls_grade = '') then
						messagebox('확인','2차 상사 평가를 입력해 주세요..')
						dw_body.setfocus()
						dw_body.setrow(i)
						dw_body.setcolumn('second_grade')
						return 1						
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_81107_d03"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type

event ue_dw_1_set;string ls_second_decision

IF dw_2.AcceptText() <> 1 THEN RETURN 

ls_second_decision = dw_2.getitemstring(1,'second_decision')
