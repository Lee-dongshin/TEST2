...
public function integer wf_empb_cust ();String ls_cust_cd, ls_cust_nm, ls_cust_snm, ls_saup_no, ls_upte, ls_jongmok, ls_bank, ls_jumn_no
	...
	CASE "empno_h"
		is_brand = Trim(dw_head.GetItemString(1, "brand"))
			...
			gst_cd.datawindow_nm   = "d_com930" 	
				...
				gst_cd.default_where   = " WHERE DEPT_CODE in ( '1000','5010','5001','5003','5004','N223','N221','5000','5200','5010','K000','K120','T400','R400','S300','RB20', 'X400', 'X100','L220', 'S400', 'N222','N220','V960','G410', 'I900','N751','N740','N741', 'B081','B082','B083','D020','A030','A031','A032','A033','D020','B030','B031','D020','Q900','Q970')  " + &
								 "   AND GOOUT_GUBN = '1' "
...
//			gst_cd.Item_where = " CUSTCODE LIKE '" + as_data + "%' "
	...
	CASE "empno"
		...
		End If
			...
			gst_cd.datawindow_nm   = "d_com930" 			
				...
				gst_cd.default_where   =  " WHERE DEPT_CODE in ( '1000','5010','5001','5003','5004','N223','N221','5000','5200','5010','K000','K120','T400','R400','S300','RB20', 'X400', 'X100','L220', 'S400', 'N222','N220','V960','G410', 'I900','N751','N740','N741','B081','B082','B083','D020','A030','A031','A032','A033','D020','B030','B031','D020','Q900','Q970','H970') " + &		
								 "   AND GOOUT_GUBN = '1' "
	...
	CASE "emp_cust"
		...
		IF ai_div = 1 THEN
			...
			If LeftA(as_data, 1) <> is_brand or MidA(as_data, 3, 4) < '4000' or MidA(as_data, 3, 4) > '4899' Then
				MessageBox("입력오류", "판매사원 거래처 코드는 브랜드 코드로 시작하고" + &
				                       "~n~r~'4000~' 과 ~'4899~' 사이의 코드로 끝납니다!")
				Return 1
			End If
...
//				dw_empb.SetItem(al_row, "emp_cust", as_data)
		...
		gst_cd.default_where   = "WHERE BRAND = ~'" + is_brand + "~' " + &
										 "  AND SUBSTRING(CUSTCODE, 3, 4) BETWEEN ~'4000~' AND ~'4899~' "
