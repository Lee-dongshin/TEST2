$PBExportHeader$w_59002_d.srw
$PBExportComments$판매현황조회(해외)
forward
global type w_59002_d from w_com010_d
end type
type rb_date from radiobutton within w_59002_d
end type
type rb_shop from radiobutton within w_59002_d
end type
type rb_sojae from radiobutton within w_59002_d
end type
type rb_item from radiobutton within w_59002_d
end type
type rb_style from radiobutton within w_59002_d
end type
type rb_mcs from radiobutton within w_59002_d
end type
type rb_style_no from radiobutton within w_59002_d
end type
type rb_mncs from radiobutton within w_59002_d
end type
type rb_mc from radiobutton within w_59002_d
end type
type rb_shop_tag from radiobutton within w_59002_d
end type
type gb_1 from groupbox within w_59002_d
end type
type dw_detail from datawindow within w_59002_d
end type
type rb_yymm from radiobutton within w_59002_d
end type
type dw_1 from u_dw within w_59002_d
end type
type dw_2 from datawindow within w_59002_d
end type
type cbx_except from checkbox within w_59002_d
end type
type st_1 from statictext within w_59002_d
end type
type st_2 from statictext within w_59002_d
end type
type rb_cust_il from radiobutton within w_59002_d
end type
type rb_cust_wol from radiobutton within w_59002_d
end type
end forward
...
string is_except_eshop, is_dotcom, is_amt_gubn
end variables
...
is_amt_gubn = Trim(dw_head.GetItemString(1, "amt_gubn"))
if IsNull(is_amt_gubn) or is_amt_gubn = "" then
   MessageBox(ls_title,"매출구분을 선택하십시요!")
   dw_head.SetFocus()
   dw_head.SetColumn("amt_gubn")
   return false
end if

is_item_gubn = Trim(dw_head.GetItemString(1, "item_gubn"))
if IsNull(is_item_gubn) or is_item_gubn = "" then
   MessageBox(ls_title,"ITEM구분을 선택하십시요!")
   dw_head.SetFocus()
   dw_head.SetColumn("item_gubn")
   return false
end if
...
if cbx_except.visible then
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_ps_except, is_plan_dc, is_except_eshop, IS_DOTCOM, is_amt_gubn)
else		
	if rb_mc.checked then
		il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, IS_DOTCOM, is_amt_gubn, is_item_gubn)
	else
		il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, IS_DOTCOM, is_amt_gubn)
	end if							
end if										
...
this.Control[iCurrent+20]=this.rb_cust_wol
end on

on w_59002_d.destroy
call super::destroy
...
type cb_close from w_com010_d`cb_close within w_59002_d
end type

type cb_delete from w_com010_d`cb_delete within w_59002_d
end type

type cb_insert from w_com010_d`cb_insert within w_59002_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_59002_d
end type

type cb_update from w_com010_d`cb_update within w_59002_d
end type

type cb_print from w_com010_d`cb_print within w_59002_d
end type

type cb_preview from w_com010_d`cb_preview within w_59002_d
end type

type gb_button from w_com010_d`gb_button within w_59002_d
end type

type cb_excel from w_com010_d`cb_excel within w_59002_d
end type

type dw_head from w_com010_d`dw_head within w_59002_d
integer y = 304
integer width = 3968
integer height = 364
string dataobject = "d_59002_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_59002_d
integer beginy = 676
integer endy = 676
end type

type ln_2 from w_com010_d`ln_2 within w_59002_d
integer beginy = 680
integer endy = 680
end type

type dw_body from w_com010_d`dw_body within w_59002_d
integer x = 14
integer y = 688
integer height = 1352
string dataobject = "d_59002_d01"
...
type dw_print from w_com010_d`dw_print within w_59002_d
string dataobject = "d_59002_r01"
end type
...
dw_body.DataObject  = 'd_59002_d01'
dw_print.DataObject = 'd_59002_r01'
...
dw_body.DataObject  = 'd_59002_d02'
dw_print.DataObject = 'd_59002_r02'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d03'
dw_print.DataObject = 'd_59002_r03'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d04'
dw_print.DataObject = 'd_59002_r04'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d05'
dw_print.DataObject = 'd_59002_r05'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d06'
dw_print.DataObject = 'd_59002_r06'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d07'
dw_print.DataObject = 'd_59002_r07'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d08'
dw_print.DataObject = 'd_59002_r08'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d09'
dw_print.DataObject = 'd_59002_r09'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d10'
dw_print.DataObject = 'd_59002_r10'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d13'
dw_print.DataObject = 'd_59002_r13'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
long textcolor = 255
long backcolor = 67108864
string text = "※ 2014/05/01 이전 환율 SGD 1$ = KRW 880￦ 적용"
...
long textcolor = 255
long backcolor = 67108864
string text = "※ 2014/05/01 이후 환율 SGD 1$ = KRW 830￦ 적용"
boolean focusrectangle = false
end type
...
dw_body.DataObject  = 'd_59002_d14'
dw_print.DataObject = 'd_59002_r015'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_59002_d15'
dw_print.DataObject = 'd_59002_r15'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
