$PBExportHeader$w_56220_e.srw
$PBExportComments$입점몰매출세금계산서 등록
forward
global type w_56220_e from w_com010_e
end type
type rb_1 from radiobutton within w_56220_e
end type
type gb_1 from groupbox within w_56220_e
end type
end forward
...
il_rows = dw_body.retrieve( is_yymm, is_seq)
IF il_rows > 0 THEN 
   dw_body.SetFocus() 
END IF 
...
String  ls_shop_cd,   ls_ErrMsg, ls_brand
...
if ll_cnt > 0 then
   dw_body.retrieve( is_yymm,  is_seq)
end if
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_56220_e","0")
end event

type cb_close from w_com010_e`cb_close within w_56220_e
end type

type cb_delete from w_com010_e`cb_delete within w_56220_e
boolean visible = false
integer x = 1737
end type

type cb_insert from w_com010_e`cb_insert within w_56220_e
boolean visible = false
integer x = 1394
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_56220_e
end type

type cb_update from w_com010_e`cb_update within w_56220_e
end type

type cb_print from w_com010_e`cb_print within w_56220_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_56220_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_56220_e
end type

type cb_excel from w_com010_e`cb_excel within w_56220_e
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_56220_e
integer x = 485
integer width = 2843
string dataobject = "d_56220_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_56220_e
integer beginy = 416
integer endy = 416
end type

type ln_2 from w_com010_e`ln_2 within w_56220_e
integer beginy = 420
integer endy = 420
end type

type dw_body from w_com010_e`dw_body within w_56220_e
integer y = 440
integer height = 1608
boolean enabled = false
string dataobject = "d_56220_d01"
...
type dw_print from w_com010_e`dw_print within w_56220_e
end type
