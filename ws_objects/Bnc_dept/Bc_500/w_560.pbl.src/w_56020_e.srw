...
event type long ue_update();call super::ue_update;long i, ll_row_count, ll_stock_qty, ll_proc_qty, ll_qty, ll_cnt, LL_CURR_PRICE
...
FOR i=1 TO ll_row_count
  ...
  LL_CURR_PRICE	 = dw_body.GetItemNumber(i, "CURR_PRICE")
	...
	if ll_proc_qty <> 0 then
		 ...
		 DECLARE sp_56020_proc01 PROCEDURE FOR sp_56020_proc01  
				@BRAND     = :is_brand,   
				@yymmdd    = :is_yymmdd,   
				@shop_cd   = :is_shop_cd,   
				...
				@CURR_PRICE_proc = :ll_curr_price					;
	
			 EXECUTE sp_56020_proc01;
