$PBExportHeader$w_52014_e.srw
$PBExportComments$잔량배분
forward
global type w_52014_e from w_com020_e
end type
type st_remark from statictext within w_52014_e
end type
type dw_assort from datawindow within w_52014_e
end type
type dw_db from datawindow within w_52014_e
end type
type dw_temp from datawindow within w_52014_e
end type
type cb_copy from commandbutton within w_52014_e
end type
type cb_reset from commandbutton within w_52014_e
end type
type dw_reset from datawindow within w_52014_e
end type
type st_info from statictext within w_52014_e
end type
type dw_detail from datawindow within w_52014_e
end type
type rb_in from radiobutton within w_52014_e
end type
type rb_rt from radiobutton within w_52014_e
end type
type rb_dir from radiobutton within w_52014_e
end type
type dw_1 from datawindow within w_52014_e
end type
end forward
...
global w_52014_e w_52014_e

type variables
String  is_brand,  is_year,  is_season, is_sojae, is_item, is_stock_opt, is_chno_opt, is_brand_s,is_DW_sort
String  is_yymmdd, is_style, is_chno,   is_color, is_color_nm , is_house_cd, is_disc_opt, is_fr_ymd, is_to_ymd
Long    il_deal_seq 
Boolean ib_NewDeal
DataStore  ids_copy
DataWindowChild	idw_house_cd,  idw_shop_lv,  idw_area_cd,  idw_shop_lv1, idw_brand_s
...
is_brand_s = dw_head.GetItemString(1, "brand_s")
if IsNull(is_brand_s) or Trim(is_brand_s) = "" then
   MessageBox(ls_title,"매장 브랜드 코드를 입력하십시요!")
   dw_head.SetFocus()
   dw_head.SetColumn("brand_s")
   return false
end if
      ...
      FOR k = 1 TO ll_assort_cnt 
			IF dw_body.GetItemStatus(i, "deal_qty_" + String(k), Primary!) = DataModified! THEN 
               ...
               dw_db.Setitem(ll_find, "deal_seq", il_deal_seq)
					IF rb_dir.checked = TRUE THEN
                  dw_db.Setitem(ll_find, "deal_fg",  '6') 
					elseIF rb_rt.checked = TRUE THEN
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_52014_e","0")
end event
...
type cb_close from w_com020_e`cb_close within w_52014_e
integer x = 3374
integer width = 215
end type

type cb_delete from w_com020_e`cb_delete within w_52014_e
integer x = 2606
integer width = 224
boolean enabled = true
end type

type cb_insert from w_com020_e`cb_insert within w_52014_e
integer x = 2066
integer width = 215
boolean enabled = true
string text = "복사(&C)"
...
type cb_retrieve from w_com020_e`cb_retrieve within w_52014_e
integer x = 3168
integer width = 210
end type

type cb_update from w_com020_e`cb_update within w_52014_e
end type

type cb_print from w_com020_e`cb_print within w_52014_e
...
type cb_preview from w_com020_e`cb_preview within w_52014_e
integer x = 2830
integer width = 334
boolean enabled = true
end type

type gb_button from w_com020_e`gb_button within w_52014_e
end type

type cb_excel from w_com020_e`cb_excel within w_52014_e
integer x = 1778
integer width = 288
end type

type dw_head from w_com020_e`dw_head within w_52014_e
integer height = 288
string dataobject = "d_52014_h01"
end type
...
This.GetChild("brand_s", ldw_child)
ldw_child.SetTransObject(SQLCA)
ldw_child.Retrieve('001')
...
CHOOSE CASE dwo.name
   ...
   CASE "style" 
      IF ib_itemchanged THEN RETURN 1
		...
		IF LenA(trim(data)) = 4 then RETURN 0		
...
type ln_1 from w_com020_e`ln_1 within w_52014_e
integer beginy = 464
integer endy = 464
end type

type ln_2 from w_com020_e`ln_2 within w_52014_e
integer beginy = 468
integer endy = 468
end type

type dw_list from w_com020_e`dw_list within w_52014_e
integer x = 0
integer y = 660
integer width = 1797
integer height = 1360
string title = "품번별 가용재고 List"
string dataobject = "d_52014_d02"
end type
...
ll_rows = dw_1.retrieve(is_brand, is_style, is_color)
...
il_rows = dw_temp.retrieve(is_style, ls_chno, is_color, il_deal_seq, is_brand_s, is_fr_ymd, is_to_ymd)
IF il_rows > 0 THEN 
	wf_temp_set() 
   ...
   ELSEIF rb_dir.checked = TRUE THEN
      ll_row = dw_db.Retrieve(is_yymmdd, il_deal_seq, is_style, is_chno, is_color, '6')
	else	
...
type dw_body from w_com020_e`dw_body within w_52014_e
integer x = 1824
integer y = 476
integer width = 1792
integer height = 1548
string dataobject = "d_52014_d01"
...
type st_1 from w_com020_e`st_1 within w_52014_e
integer x = 1801
integer y = 488
integer height = 1532
end type

type dw_print from w_com020_e`dw_print within w_52014_e
integer x = 1477
integer y = 1140
