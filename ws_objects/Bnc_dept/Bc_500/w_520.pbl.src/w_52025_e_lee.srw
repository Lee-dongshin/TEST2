$PBExportHeader$w_52025_e_lee.srw
$PBExportComments$잔량배분2(품번별)
forward
global type w_52025_e_lee from w_com020_e
end type
type dw_assort from datawindow within w_52025_e_lee
end type
type dw_db from datawindow within w_52025_e_lee
end type
type dw_temp from datawindow within w_52025_e_lee
end type
type cb_copy from commandbutton within w_52025_e_lee
end type
type cb_reset from commandbutton within w_52025_e_lee
end type
type dw_reset from datawindow within w_52025_e_lee
end type
type st_info from statictext within w_52025_e_lee
end type
type dw_detail from datawindow within w_52025_e_lee
end type
type st_remark from statictext within w_52025_e_lee
end type
type rb_in from radiobutton within w_52025_e_lee
end type
type rb_dir from radiobutton within w_52025_e_lee
end type
type rb_rt from radiobutton within w_52025_e_lee
end type
type dw_1 from datawindow within w_52025_e_lee
end type
end forward
...
global w_52025_e_lee w_52025_e_lee

type variables
String  is_brand,  is_year,  is_season, is_sojae, is_item, is_stock_opt, is_disc_opt,is_shop_brand, is_DW_sort
String  is_yymmdd, is_style, is_chno,   is_color, is_color_nm, is_house_cd, is_chno_opt, is_fr_ymd, is_to_ymd, is_dist_grp
Long    il_deal_seq 
Boolean ib_NewDeal
...
//      dw_body.Setitem(ll_row, "sale_ymd", dw_temp.object.sale_ymd[i])								
	END IF 
   ...
   k = dw_assort.find(ls_find, 1, ll_assort_cnt)	
	IF k > 0 THEN 
		...
		dw_body.Setitem(ll_row, "sale_qty_ft_"  + String(k), dw_temp.GetitemNumber(i, "sale_qty_ft"))		
		
		dw_body.Setitem(ll_row, "sale_qty_h_"  + String(k), dw_temp.GetitemNumber(i, "sale_qty_h"))		
		dw_body.Setitem(ll_row, "sale_qty_p_"  + String(k), dw_temp.GetitemNumber(i, "sale_qty_p"))		
		dw_body.Setitem(ll_row, "sale_qty_m_"  + String(k), dw_temp.GetitemNumber(i, "sale_qty_m"))				
		dw_body.Setitem(ll_row, "sale_ymd_"  + String(k), dw_temp.Getitemstring(i, "sale_ymd"))		
		dw_body.Setitem(ll_row, "last_out_ymd_"  + String(k), dw_temp.Getitemstring(i, "last_out_ymd"))				
      lb_Chk = True
	END IF
NEXT
   ...
   if i <= 10 then	
				IF i > il_rows THEN
					ls_modify = ' t_size_'      + String(i) + '.Visible=0' + &					
									' last_out_ymd_' + String(i) + '_t' + '.Visible=0' + &									
									' sale_ymd_'     + String(i) + '_t' + '.Visible=0' + &						
									' sale_qty_p_' + String(i) + '_t' + '.Visible=0' + &									
									' sale_qty_m_' + String(i) + '_t' + '.Visible=0' + &																		
									' sale_qty_h_' + String(i) + '_t' + '.Visible=0' + &		
									' cs_sale_qty_p_'  + String(i) + '.Visible=0' + &									
									' cs_sale_qty_m_'  + String(i) + '.Visible=0' + &																		
									' cs_sale_qty_h_'  + String(i) + '.Visible=0' + &	
									' last_out_ymd_' + String(i) + '.Visible=0' + &									
									' sale_ymd_'     + String(i) + '.Visible=0' + &															
									' sale_qty_p_'    + String(i) + '.Visible=0' + &
									' sale_qty_m_'    + String(i) + '.Visible=0' + &
									' sale_qty_h_'    + String(i) + '.Visible=0' + &																		
									' out_qty_'     + String(i) + '_t' + '.Visible=0' + &									
									' rtrn_qty_'    + String(i) + '_t' + '.Visible=0' + &									
									' sale_qty_'    + String(i) + '_t' + '.Visible=0' + &
									' sale_qty_ft_' + String(i) + '_t' + '.Visible=0' + &									
									' c_stock_'     + String(i) + '_t' + '.Visible=0' + &			
									' deal_qty_'    + String(i) + '_t' + '.Visible=0' + &																		
									' t_ord_'       + String(i) + '.Visible=0' + &
									' out_qty_'     + String(i) + '.Visible=0' + &
									' rtrn_qty_'    + String(i) + '.Visible=0' + &
									' sale_qty_'    + String(i) + '.Visible=0' + &
									' sale_qty_ft_' + String(i) + '.Visible=0' + &									
									...
									' cs_sale_ft_'  + String(i) + '.Visible=0' + &									
				...
				ELSE
					...
					ls_modify = ' t_size_'      + String(i) + '.Text="' + ls_size + '"' + &					
									' last_out_ymd_' + String(i) + '_t' + '.Visible=1' + &									
									' sale_ymd_'     + String(i) + '_t' + '.Visible=1' + &						
									' sale_qty_p_' + String(i) + '_t' + '.Visible=1' + &									
									' sale_qty_m_' + String(i) + '_t' + '.Visible=1' + &																		
									' sale_qty_h_' + String(i) + '_t' + '.Visible=1' + &		
									' cs_sale_qty_p_'  + String(i) + '.Visible=1' + &									
									' cs_sale_qty_m_'  + String(i) + '.Visible=1' + &																		
									' cs_sale_qty_h_'  + String(i) + '.Visible=1' + &	
									' last_out_ymd_' + String(i) + '.Visible=1' + &									
									' sale_ymd_'     + String(i) + '.Visible=1' + &															
									' sale_qty_p_'    + String(i) + '.Visible=1' + &
									' sale_qty_m_'    + String(i) + '.Visible=1' + &
									' sale_qty_h_'    + String(i) + '.Visible=1' + &									
									' t_size_'      + String(i) + '.Visible=1' + &
									' out_qty_'     + String(i) + '_t' + '.Visible=1' + &
									' rtrn_qty_'    + String(i) + '_t' + '.Visible=1' + &
									' sale_qty_'    + String(i) + '_t' + '.Visible=1' + &
									' sale_qty_ft_' + String(i) + '_t' + '.Visible=1' + &									
									' c_stock_'     + String(i) + '_t' + '.Visible=1' + &
									' deal_qty_'    + String(i) + '_t' + '.Visible=1' + &
									...
									' sale_qty_ft_' + String(i) + '.Visible=1' + &									
									...
									' cs_sale_ft_'  + String(i) + '.Visible=1' + &									
...
//										' x="' + String(ll_color_st) + '" y="4" height="56" width="885"' + &
...
//										' font.pitch="1" font.charset="129" background.mode="2" background.color="79741120")'	
   					ls_modify = ls_modify + ' create text(band=header alignment="2" text="' + ls_color + '" border="6" color="0"' + &
										' x="' + String(ll_color_st) + '" y="4" height="56" width="1870"' + &
										' name=t_color_' + String(k) + ' font.face="굴림체" font.height="-9" font.weight="400"  font.family="1"' + &
										' font.pitch="1" font.charset="129" background.mode="2" background.color="79741120")'											
										
						ll_color_st = ll_color_st + 1870 + 13
					ELSE       /* 색상 헤드 타이틀 폭 확장  */
						ll_color_wd = Long(dw_body.Describe(' t_color_' + String(k) + + '.width'))
						ls_modify = ls_modify + ' t_color_' + String(k) + '.width="' + String(ll_color_wd + 1870) + '"'
						ll_color_st = ll_color_st + 1870 + 13
						
						
//						ll_color_wd = Long(dw_body.Describe(' t_color_' + String(k) + + '.width'))
//						ls_modify = ls_modify + ' t_color_' + String(k) + '.width="' + String(ll_color_wd + 864) + '"'
//						ll_color_st = ll_color_st + 885						
//						
//						ll_color_wd = Long(dw_body.Describe(' t_color_' + String(k) + + '.width'))
...
//
					...
					ELSE       /* 색상 헤드 타이틀 폭 확장  */
						ll_color_wd = Long(dw_body.Describe(' t_color_' + String(k) + + '.width'))
						ls_modify = ls_modify + ' t_color_' + String(k) + '.width="' + String(ll_color_wd + 1861) + '"'
						ll_color_st = ll_color_st + 1870 + 13
					END IF						
...
if IsNull(is_dist_grp) or Trim(is_dist_grp) = "" then
   MessageBox(ls_title,"배분 브랜드 지정 코드를 입력하십시요!")
   dw_head.SetFocus()
...
il_rows = dw_list.retrieve(is_brand, is_year, is_season, is_sojae, is_item, is_style, is_chno, is_house_cd,is_stock_opt, is_disc_opt, is_fr_ymd, is_to_ymd )
dw_body.Reset()
IF il_rows > 0 THEN
   dw_list.SetFocus()
END IF
...
//	         IF gf_reserve_reset (ls_ErrMsg)		 = FALSE THEN 						
...
type cb_close from w_com020_e`cb_close within w_52025_e_lee
integer x = 3342
integer width = 242
end type

type cb_delete from w_com020_e`cb_delete within w_52025_e_lee
integer x = 2510
integer width = 242
boolean enabled = true
end type

type cb_insert from w_com020_e`cb_insert within w_52025_e_lee
integer x = 2025
integer width = 242
boolean enabled = true
string text = "복사(&C)"
...
type cb_retrieve from w_com020_e`cb_retrieve within w_52025_e_lee
integer x = 3095
integer width = 242
end type

type cb_update from w_com020_e`cb_update within w_52025_e_lee
end type

type cb_print from w_com020_e`cb_print within w_52025_e_lee
...
type cb_preview from w_com020_e`cb_preview within w_52025_e_lee
boolean visible = false
integer x = 2757
integer width = 334
boolean enabled = true
...
type gb_button from w_com020_e`gb_button within w_52025_e_lee
end type

type cb_excel from w_com020_e`cb_excel within w_52025_e_lee
integer x = 1737
integer width = 288
end type

type dw_head from w_com020_e`dw_head within w_52025_e_lee
integer y = 172
integer height = 348
...
This.GetChild("shop_brand", ldw_child)
ldw_child.SetTransObject(SQLCA)
ldw_child.Retrieve('001')
...
type ln_1 from w_com020_e`ln_1 within w_52025_e_lee
integer beginy = 536
integer endy = 536
end type

type ln_2 from w_com020_e`ln_2 within w_52025_e_lee
integer beginy = 540
integer endy = 540
end type

type dw_list from w_com020_e`dw_list within w_52025_e_lee
integer x = 0
integer y = 836
integer width = 2039
integer height = 1212
...
il_rows = dw_temp.retrieve(is_style, ls_chno, '%', il_deal_seq, is_shop_brand, is_fr_ymd, is_to_ymd, is_dist_grp)
IF il_rows > 0 THEN 
	wf_temp_set() 
	IF rb_rt.checked = TRUE THEN
...
type dw_body from w_com020_e`dw_body within w_52025_e_lee
integer x = 2053
integer y = 548
integer width = 1577
integer height = 1504
...
type st_1 from w_com020_e`st_1 within w_52025_e_lee
integer x = 2039
integer y = 548
integer height = 1500
end type

type dw_print from w_com020_e`dw_print within w_52025_e_lee
integer x = 1477
integer y = 1140
string dataobject = "d_52025_r01"
end type
