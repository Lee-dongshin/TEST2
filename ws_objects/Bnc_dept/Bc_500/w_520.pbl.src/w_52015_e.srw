...
String  is_fr_style, is_fr_chno, is_fr_color, is_house_cd, is_brand
String  is_to_style, is_to_chno, is_to_color, is_yymmdd , is_DW_sort
Long    il_deal_seq
Boolean ib_NewDeal
...
/* 기준 품번 판매내역 처리 */
il_rows = dw_temp.retrieve(is_fr_style, is_fr_chno, is_fr_color, is_brand)
IF il_rows > 0 THEN 
	IF wf_temp_set() THEN 
