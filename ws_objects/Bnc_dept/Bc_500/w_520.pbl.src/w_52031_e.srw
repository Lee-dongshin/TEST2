$PBExportHeader$w_52031_e.srw
$PBExportComments$상설용잔량배분2(품번별)
forward
global type w_52031_e from w_com020_e
end type
type dw_assort from datawindow within w_52031_e
end type
type dw_db from datawindow within w_52031_e
end type
type dw_temp from datawindow within w_52031_e
end type
type cb_copy from commandbutton within w_52031_e
end type
type cb_reset from commandbutton within w_52031_e
end type
type dw_reset from datawindow within w_52031_e
end type
type st_info from statictext within w_52031_e
end type
type dw_detail from datawindow within w_52031_e
end type
type st_remark from statictext within w_52031_e
end type
type rb_in from radiobutton within w_52031_e
end type
type rb_dir from radiobutton within w_52031_e
end type
type rb_rt from radiobutton within w_52031_e
end type
type dw_1 from datawindow within w_52031_e
end type
end forward
...
global w_52031_e w_52031_e

type variables
String  is_brand,  is_year,  is_season, is_sojae, is_item, is_stock_opt, is_disc_opt, is_DW_sort
String  is_yymmdd, is_style, is_chno,   is_color, is_color_nm, is_house_cd, is_chno_opt, is_shop_type, is_fr_ymd, is_to_ymd
Long    il_deal_seq 
Boolean ib_NewDeal
DataWindowChild	idw_house_cd,  idw_shop_lv, idw_area_cd, idw_shop_lv1, idw_shop_type
...
if IsNull(is_shop_type) or Trim(is_shop_type) = "" then
   MessageBox(ls_title,"출고형태를 입력하십시요!")
   dw_head.SetFocus()
   ...
   IF idw_status = NewModified! OR idw_status = DataModified! THEN	
      ...
      FOR k = 1 TO ll_assort_cnt 
			IF dw_body.GetItemStatus(i, "deal_qty_" + String(k), Primary!) = DataModified! THEN 
               ...
               dw_db.Setitem(ll_find, "a_shop_type", is_shop_type)										
				ELSE
...
dw_head.SetItem(1, "house_cd"   ,"010000")
...
type cb_close from w_com020_e`cb_close within w_52031_e
integer x = 3342
integer width = 242
end type

type cb_delete from w_com020_e`cb_delete within w_52031_e
integer x = 2510
integer width = 242
boolean enabled = true
end type

type cb_insert from w_com020_e`cb_insert within w_52031_e
integer x = 2025
integer width = 242
boolean enabled = true
string text = "복사(&C)"
...
type cb_retrieve from w_com020_e`cb_retrieve within w_52031_e
integer x = 3095
integer width = 242
end type

type cb_update from w_com020_e`cb_update within w_52031_e
end type

type cb_print from w_com020_e`cb_print within w_52031_e
...
type cb_preview from w_com020_e`cb_preview within w_52031_e
boolean visible = false
integer x = 2757
integer width = 334
boolean enabled = true
...
type gb_button from w_com020_e`gb_button within w_52031_e
end type

type cb_excel from w_com020_e`cb_excel within w_52031_e
integer x = 1737
integer width = 288
end type

type dw_head from w_com020_e`dw_head within w_52031_e
integer height = 272
string dataobject = "d_52031_h01"
end type
...
ls_filter_str = ''	
ls_filter_str = "shop_cd < '020000' or  shop_cd = 'A10000'  or  shop_cd = '050000'  or  shop_cd = 'M10000' "
...
type ln_1 from w_com020_e`ln_1 within w_52031_e
integer beginy = 452
integer endy = 452
end type

type ln_2 from w_com020_e`ln_2 within w_52031_e
integer beginy = 456
integer endy = 456
end type

type dw_list from w_com020_e`dw_list within w_52031_e
integer x = 0
integer y = 800
integer width = 1413
integer height = 1252
string title = "품번별 가용재고 List"
string dataobject = "d_52031_d02"
end type
...
il_rows = dw_temp.retrieve(is_style, ls_chno, '%', il_deal_seq, is_fr_ymd, is_to_ymd)
IF il_rows > 0 THEN 
	wf_temp_set() 
	IF rb_rt.checked = TRUE THEN
...
type dw_body from w_com020_e`dw_body within w_52031_e
integer x = 1440
integer y = 492
integer width = 2185
integer height = 1560
string dataobject = "d_52031_d01"
...
type st_1 from w_com020_e`st_1 within w_52031_e
integer x = 1417
integer y = 492
integer height = 1560
end type

type dw_print from w_com020_e`dw_print within w_52031_e
integer x = 1477
integer y = 1140
