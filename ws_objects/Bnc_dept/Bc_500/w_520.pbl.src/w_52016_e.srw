$PBExportHeader$w_52016_e.srw
$PBExportComments$판매보충 수기배분
forward
global type w_52016_e from w_com010_e
end type
type cb_refill from commandbutton within w_52016_e
end type
type st_1 from statictext within w_52016_e
end type
type st_2 from statictext within w_52016_e
end type
end forward
...
global w_52016_e w_52016_e

type variables
DataWindowChild idw_brand, idw_year, idw_season, idw_house_cd
String is_brand, is_yymmdd, is_fr_ymd, is_to_ymd , is_gubn, is_year, is_season, is_eshop, is_house_cd
Long   il_deal_seq 
end variables
...
//if is_brand <> "Y" and  is_eshop = "N" and is_house_cd <> "010000" then
//	is_house_cd = "010000"
//end if	
...
FOR i=1 TO ll_row_count
   ...
   IF idw_status = DataModified! THEN		/* Modify Record */
      ...
      ll_new_qty = dw_body.GetitemNumber(i, "deal_qty")
		...
		IF gf_stresv_update (ls_style, ls_chno, ls_color, ls_size, ls_shop_div, ll_new_qty - ll_old_qty, is_house_cd, ls_ErrMsg) = FALSE THEN 
			il_rows = -1
			EXIT
		END IF
   END IF
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_52016_e","0")
end event
...
type cb_close from w_com010_e`cb_close within w_52016_e
end type

type cb_delete from w_com010_e`cb_delete within w_52016_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_52016_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_52016_e
end type

type cb_update from w_com010_e`cb_update within w_52016_e
end type

type cb_print from w_com010_e`cb_print within w_52016_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_52016_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_52016_e
end type

type cb_excel from w_com010_e`cb_excel within w_52016_e
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_52016_e
integer y = 156
integer width = 3415
integer height = 200
string dataobject = "d_52016_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_52016_e
integer beginy = 364
integer endy = 364
end type

type ln_2 from w_com010_e`ln_2 within w_52016_e
integer beginy = 368
integer endy = 368
end type

type dw_body from w_com010_e`dw_body within w_52016_e
integer x = 0
integer y = 372
integer width = 3611
integer height = 1648
string dataobject = "d_52016_d01"
...
type dw_print from w_com010_e`dw_print within w_52016_e
integer x = 2345
integer y = 760
end type
...
if is_brand <> "J" then
	...
	DECLARE SP_REFILL_MID_house PROCEDURE FOR SP_REFILL_MID_house  
			  @brand    = :is_brand, 
			  @yymmdd   = :is_yymmdd,    
			  @fr_ymd   = :is_fr_ymd, 
			  @to_ymd   = :is_to_ymd, 
	...
	EXECUTE SP_REFILL_MID_house;
	
else	
	DECLARE SP_REFILL_MID_house_j PROCEDURE FOR SP_REFILL_MID_house_j  
			  @brand    = :is_brand, 
			  @yymmdd   = :is_yymmdd,    
			  @fr_ymd   = :is_fr_ymd, 
			  @to_ymd   = :is_to_ymd, 
...
long textcolor = 255
long backcolor = 67108864
string text = "※ 출고창고(재고보유) 선택은 온라인전용만 적용됩니다."
boolean focusrectangle = false
end type
