...
type variables
DataWindowChild idw_brand, idw_shop_lv, idw_shop_lv_class
...
This.GetChild("shop_lv_class", idw_shop_lv_class)
idw_shop_lv_class.SetTransObject(SQLCA)
idw_shop_lv_class.Retrieve('096')
//idw_shop_lv_class.InsertRow(1)
//idw_shop_lv_class.SetItem(1, "inter_cd", '%')
//idw_shop_lv_class.SetItem(1, "inter_nm", '전체')
//
