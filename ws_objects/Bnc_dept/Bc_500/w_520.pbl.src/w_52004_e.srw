...
event dw_body::constructor;call super::constructor;This.GetChild("dist_EXAM", idw_dist_grp)
idw_dist_grp.SetTransObject(SQLCA)
idw_dist_grp.Retrieve('036')
