$PBExportHeader$w_52026_e.srw
$PBExportComments$폐점매장재고배분
forward
global type w_52026_e from w_com020_e
end type
type dw_assort from datawindow within w_52026_e
end type
type dw_db from datawindow within w_52026_e
end type
type dw_temp from datawindow within w_52026_e
end type
type cbx_rt from checkbox within w_52026_e
end type
type cb_copy from commandbutton within w_52026_e
end type
type cb_reset from commandbutton within w_52026_e
end type
type dw_reset from datawindow within w_52026_e
end type
type st_info from statictext within w_52026_e
end type
type dw_detail from datawindow within w_52026_e
end type
type st_remark from statictext within w_52026_e
end type
type st_2 from statictext within w_52026_e
end type
end forward
...
global w_52026_e w_52026_e

type variables
String  is_brand,  is_year,  is_season, is_sojae, is_item, is_stock_opt, is_shop_opt
String  is_yymmdd, is_style, is_chno,   is_color, is_color_nm, is_house_cd, is_shop_cd
Long    il_deal_seq 
Boolean ib_NewDeal
...
/* assort 내역 조회 */
il_rows = dw_assort.Retrieve(is_style, is_chno, '%', is_shop_cd)
...
this.Control[iCurrent+4]=this.cbx_rt
...
this.Control[iCurrent+10]=this.st_remark
this.Control[iCurrent+11]=this.st_2
end on

on w_52026_e.destroy
call super::destroy
...
is_shop_opt =  dw_head.GetItemString(1, "shop_opt")
...
il_rows = dw_list.retrieve(is_brand, is_year, is_season, is_sojae, is_item, is_style, is_chno, is_shop_cd,is_stock_opt)
dw_body.Reset()
IF il_rows > 0 THEN
   dw_list.SetFocus()
END IF
   ...
   IF idw_status = NewModified! OR idw_status = DataModified! THEN	
      ...
      FOR k = 1 TO ll_assort_cnt 
			IF dw_body.GetItemStatus(i, "deal_qty_" + String(k), Primary!) = DataModified! THEN 
               ...
               dw_db.Setitem(ll_find, "deal_fg",  '5') 
               ...
               dw_db.Setitem(ll_find, "rshop_cd", is_shop_cd)
					ll_resv_qty = ll_deal_qty
				END IF
			END IF
		NEXT
...
/* 수정일      : 2001..                                                  */
/*===========================================================================*/
String     ls_cust_nm , ls_style, ls_chno, ls_shop_nm,ls_country
Boolean    lb_check 
...
DECLARE SP_52026_DELETE PROCEDURE FOR SP_52026_DELETE 
        @yymmdd    = :is_yymmdd, 
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_52026_e","0")
end event
...
type cb_close from w_com020_e`cb_close within w_52026_e
integer x = 3342
integer width = 242
end type

type cb_delete from w_com020_e`cb_delete within w_52026_e
integer x = 2510
integer width = 242
boolean enabled = true
end type

type cb_insert from w_com020_e`cb_insert within w_52026_e
integer x = 2025
integer width = 242
boolean enabled = true
string text = "복사(&C)"
...
type cb_retrieve from w_com020_e`cb_retrieve within w_52026_e
integer x = 3095
integer width = 242
end type

type cb_update from w_com020_e`cb_update within w_52026_e
end type

type cb_print from w_com020_e`cb_print within w_52026_e
...
type cb_preview from w_com020_e`cb_preview within w_52026_e
integer x = 2757
integer width = 334
boolean enabled = true
end type

type gb_button from w_com020_e`gb_button within w_52026_e
end type

type cb_excel from w_com020_e`cb_excel within w_52026_e
integer x = 1737
integer width = 288
end type

type dw_head from w_com020_e`dw_head within w_52026_e
integer width = 3575
integer height = 204
string dataobject = "d_52026_h01"
end type
...
type ln_1 from w_com020_e`ln_1 within w_52026_e
integer beginy = 372
integer endy = 372
end type

type ln_2 from w_com020_e`ln_2 within w_52026_e
integer beginy = 376
integer endy = 376
end type

type dw_list from w_com020_e`dw_list within w_52026_e
integer x = 0
integer y = 652
integer width = 1061
integer height = 1400
string title = "품번별 가용재고 List"
string dataobject = "d_52026_d02"
end type
...
/* 수정일      : 2002.04.15                                                  */
/*===========================================================================*/
String ls_style_no ,ls_tag_price, ls_out_ymd,ls_country
Long   ll_row, ll_tag_price
...
il_rows = dw_temp.retrieve(is_style, is_chno, '%', il_deal_seq, is_shop_cd)
IF il_rows > 0 THEN 
	wf_temp_set() 
//	IF cbx_rt.checked = TRUE THEN
//      ll_row = dw_db.Retrieve(is_yymmdd, il_deal_seq, is_style, is_chno, '3')
//   ELSE
      ll_row = dw_db.Retrieve(is_yymmdd, il_deal_seq, is_style, is_chno, '5')
//	END IF
	IF ll_row > 0 THEN 
		wf_retrieve_set() 
		IF dw_db.Object.proc_yn[1] = 'Y' THEN 
...
String 	ls_search, ls_color, ls_chno, ls_style
if row > 0 then 
	choose case dwo.name
		case 'style','style_no'
...
type dw_body from w_com020_e`dw_body within w_52026_e
integer x = 1070
integer y = 388
integer width = 2555
integer height = 1664
string dataobject = "d_52026_d01"
...
type st_1 from w_com020_e`st_1 within w_52026_e
integer x = 1061
integer y = 592
integer height = 1456
end type

type dw_print from w_com020_e`dw_print within w_52026_e
integer x = 1477
integer y = 1140
...
string title = "assort"
string dataobject = "d_com520_shop"
boolean hscrollbar = true
...
long textcolor = 255
long backcolor = 79741120
string text = "※배분차수는 반드시 160번대를 사용하세요!"
boolean focusrectangle = false
end type
