...
String  is_style, is_chno, is_deal_type, is_brand, is_DW_sort
...
dw_temp.Retrieve(is_style, is_chno, is_deal_type, is_brand)
...
For i = 1 to ll_row_cnt 
	IF ls_shop_cd <> dw_db.object.shop_cd[i] THEN 
      ...
      dw_body.Setitem(ll_row, "shop_lv1_1", ls_shop_lv1)	
...
il_rows = dw_temp.Retrieve(is_style, is_chno, is_deal_type, is_brand)
IF il_rows < 1 THEN Return False
...
FOR i = 1 to il_rows 
	...
	dw_body.SetItem(i, "shop_lv1_1", dw_temp.Object.shop_lv1[i])		
