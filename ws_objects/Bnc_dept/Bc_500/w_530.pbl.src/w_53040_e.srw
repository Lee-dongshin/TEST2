$PBExportHeader$w_53040_e.srw
$PBExportComments$전용상품판매등록
forward
global type w_53040_e from w_com010_e
end type
type dw_member from datawindow within w_53040_e
end type
type st_1 from statictext within w_53040_e
end type
type cb_input from commandbutton within w_53040_e
end type
type st_2 from statictext within w_53040_e
end type
type dw_member_sale from datawindow within w_53040_e
end type
type dw_list from datawindow within w_53040_e
end type
end forward
...
event open;call super::open;dw_head.Setitem(1, "shop_type", '9')
...
type cb_close from w_com010_e`cb_close within w_53040_e
integer taborder = 140
end type

type cb_delete from w_com010_e`cb_delete within w_53040_e
integer taborder = 130
end type

type cb_insert from w_com010_e`cb_insert within w_53040_e
integer taborder = 70
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_53040_e
integer x = 2839
integer width = 384
integer taborder = 40
string text = "일보조회(&Q)"
...
type cb_update from w_com010_e`cb_update within w_53040_e
end type

type cb_print from w_com010_e`cb_print within w_53040_e
boolean visible = false
integer taborder = 100
end type

type cb_preview from w_com010_e`cb_preview within w_53040_e
boolean visible = false
integer taborder = 110
end type

type gb_button from w_com010_e`gb_button within w_53040_e
end type

type cb_excel from w_com010_e`cb_excel within w_53040_e
boolean visible = false
integer taborder = 120
end type

type dw_head from w_com010_e`dw_head within w_53040_e
integer y = 192
integer width = 3447
integer height = 220
string dataobject = "d_53040_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_53040_e
integer beginy = 456
integer endy = 456
end type

type ln_2 from w_com010_e`ln_2 within w_53040_e
integer beginy = 460
integer endy = 460
end type

type dw_body from w_com010_e`dw_body within w_53040_e
event ue_set_col ( string as_column )
integer x = 9
integer width = 3579
integer height = 1184
integer taborder = 50
string dataobject = "d_53040_d01"
...
type dw_print from w_com010_e`dw_print within w_53040_e
end type
