$PBExportHeader$w_53038_e.srw
$PBExportComments$대만,베트남 판매등록
forward
global type w_53038_e from w_com000
end type
type dw_head from u_dw within w_53038_e
end type
type ln_1 from line within w_53038_e
end type
type ln_2 from line within w_53038_e
end type
type dw_body from u_dw within w_53038_e
end type
type dw_print from u_dw within w_53038_e
end type
end forward
...
/* 수정일      : 2001..                                                  */
/*===========================================================================*/
long i, ll_row_count, ll_sale_qty, ll_sale_amt
string ls_shop_div, ls_sale_no
...
FOR i=1 TO ll_row_count
   ...
   IF idw_status = NewModified! THEN				/* New Record */
		...
		if ll_sale_qty = 0 and ll_sale_amt = 0 then
			dw_body.SetItemStatus(i, 0, Primary!,New!)
		else
			dw_body.Setitem(i, "yymmdd", is_yymmdd)
			dw_body.Setitem(i, "shop_type","1" )
			dw_body.Setitem(i, "sale_no","0001" )
			dw_body.Setitem(i, "no","0001" )
		
			dw_body.Setitem(i, "style","xxxxxxxx" )
			dw_body.Setitem(i, "chno","x" )
			dw_body.Setitem(i, "color","xx" )
			dw_body.Setitem(i, "size","xx" )
			
			dw_body.Setitem(i, "sale_type","11" )
			
			dw_body.Setitem(i, "sale_fg","0" )
			dw_body.Setitem(i, "year","xxxx" )
			dw_body.Setitem(i, "season","x" )
			dw_body.Setitem(i, "sojae","x" )
			dw_body.Setitem(i, "item","x" )
...
type cb_close from w_com000`cb_close within w_53038_e
integer taborder = 100
end type

type cb_delete from w_com000`cb_delete within w_53038_e
boolean visible = false
integer x = 1083
integer taborder = 50
end type

type cb_insert from w_com000`cb_insert within w_53038_e
boolean visible = false
integer x = 741
integer taborder = 40
...
type cb_retrieve from w_com000`cb_retrieve within w_53038_e
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_53038_e
integer taborder = 90
end type

type cb_print from w_com000`cb_print within w_53038_e
integer x = 1426
integer taborder = 60
end type

type cb_preview from w_com000`cb_preview within w_53038_e
integer x = 1769
integer taborder = 70
end type

type gb_button from w_com000`gb_button within w_53038_e
integer taborder = 0
end type

type cb_excel from w_com000`cb_excel within w_53038_e
integer x = 2112
end type
