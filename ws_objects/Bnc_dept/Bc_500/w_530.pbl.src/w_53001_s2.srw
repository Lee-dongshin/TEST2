$PBExportHeader$w_53001_s2.srw
$PBExportComments$판매등록[고객등록]
forward
global type w_53001_s2 from w_com010_e
end type
type st_1 from statictext within w_53001_s2
end type
end forward
...
type cb_close from w_com010_e`cb_close within w_53001_s2
integer x = 731
end type

type cb_delete from w_com010_e`cb_delete within w_53001_s2
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_53001_s2
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_53001_s2
boolean visible = false
end type

type cb_update from w_com010_e`cb_update within w_53001_s2
integer x = 87
end type

type cb_print from w_com010_e`cb_print within w_53001_s2
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_53001_s2
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_53001_s2
integer x = 14
integer width = 1106
end type

type cb_excel from w_com010_e`cb_excel within w_53001_s2
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_53001_s2
integer x = 41
integer y = 184
integer width = 974
integer height = 136
string dataobject = "d_53001_h20"
end type
...
CHOOSE CASE dwo.name
	CASE "jumin"     
		...
		ELSE
			MessageBox("오류", "주민등록번호가 잘못되어 있습니다.")
			RETURN 1
		END IF
END CHOOSE
...
type ln_1 from w_com010_e`ln_1 within w_53001_s2
boolean visible = false
end type

type ln_2 from w_com010_e`ln_2 within w_53001_s2
boolean visible = false
end type

type dw_body from w_com010_e`dw_body within w_53001_s2
integer x = 41
integer y = 332
integer width = 1056
integer height = 244
boolean enabled = false
string dataobject = "d_53001_d20"
...
type dw_print from w_com010_e`dw_print within w_53001_s2
end type
