$PBExportHeader$w_53005_d.srw
$PBExportComments$판매 현황
forward
global type w_53005_d from w_com010_d
end type
type rb_date from radiobutton within w_53005_d
end type
type rb_shop from radiobutton within w_53005_d
end type
type rb_sojae from radiobutton within w_53005_d
end type
type rb_item from radiobutton within w_53005_d
end type
type rb_style from radiobutton within w_53005_d
end type
type rb_mcs from radiobutton within w_53005_d
end type
type rb_style_no from radiobutton within w_53005_d
end type
type rb_mncs from radiobutton within w_53005_d
end type
type rb_mc from radiobutton within w_53005_d
end type
type rb_shop_tag from radiobutton within w_53005_d
end type
type gb_1 from groupbox within w_53005_d
end type
type dw_detail from datawindow within w_53005_d
end type
type rb_yymm from radiobutton within w_53005_d
end type
type dw_1 from u_dw within w_53005_d
end type
type dw_2 from datawindow within w_53005_d
end type
type cbx_except from checkbox within w_53005_d
end type
type rb_detail from radiobutton within w_53005_d
end type
type rb_cust_wol from radiobutton within w_53005_d
end type
type rb_cust_il from radiobutton within w_53005_d
end type
type st_1 from statictext within w_53005_d
end type
type ddlb_1 from dropdownlistbox within w_53005_d
end type
type cbx_1 from checkbox within w_53005_d
end type
type cbx_2 from checkbox within w_53005_d
end type
type cbx_3 from checkbox within w_53005_d
end type
type cbx_6 from checkbox within w_53005_d
end type
type cbx_5 from checkbox within w_53005_d
end type
type cbx_4 from checkbox within w_53005_d
end type
type cbx_7 from checkbox within w_53005_d
end type
type cbx_8 from checkbox within w_53005_d
end type
type cbx_9 from checkbox within w_53005_d
end type
type cbx_10 from checkbox within w_53005_d
end type
type st_2 from statictext within w_53005_d
end type
type st_11 from statictext within w_53005_d
end type
type rb_year from radiobutton within w_53005_d
end type
type ddlb_2 from dropdownlistbox within w_53005_d
end type
type rb_detail_style from radiobutton within w_53005_d
end type
type rb_week from radiobutton within w_53005_d
end type
end forward
...
rb_detail rb_detail
rb_cust_wol rb_cust_wol
rb_cust_il rb_cust_il
st_1 st_1
ddlb_1 ddlb_1
cbx_1 cbx_1
cbx_2 cbx_2
...
rb_year rb_year
ddlb_2 ddlb_2
rb_detail_style rb_detail_style
rb_week rb_week
end type
global w_53005_d w_53005_d

type variables
DataWindowChild idw_brand, idw_shop_div, idw_area_cd, idw_shop_type, idw_st_brand
DataWindowChild idw_season, idw_sojae, idw_item, idw_color,idw_empno

String is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, is_style, is_chno, is_ps_except, is_item_gubn, is_st_brand
...
elseif (gs_brand = 'O' or  gs_brand = 'D' or  gs_brand = 'Y' or  gs_brand = 'U')  and (is_brand = 'N' or is_brand = 'E' or is_brand = 'M' or is_brand = 'F' or is_brand = 'G' or is_brand = 'J' or is_brand = 'X') then
   MessageBox(ls_title,"올리브 직원은 보끄레 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("brand")
   return false	
elseif gs_brand = 'Y' and (is_brand = 'N' or is_brand = 'M' or is_brand = 'E' or is_brand = 'F' or is_brand = 'G' or is_brand = 'J' or is_brand = 'X') then
   MessageBox(ls_title,"올리브 직원은 보끄레 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("brand")
   return false		
...
if is_etc_shop_div = '' and is_etc_shop_div2 = '' and is_etc_shop_div3 = '' and is_etc_shop_div4 = '' and is_etc_shop_div5 = '' and is_etc_shop_div6 = '' and is_etc_shop_div7 = '' and is_etc_shop_div8 = '' and is_etc_shop_div9 = '' and is_etc_shop_div10 = '' then
...
if is_brand = 'L' or is_brand = 'B' or is_brand = 'F' then
	if rb_mc.checked then
		dw_body.DataObject  = 'd_53005_d09_02'
		dw_print.DataObject = 'd_53005_r09_02'
	...
	if rb_mc.checked then
		dw_body.DataObject  = 'd_53005_d09'
		dw_print.DataObject = 'd_53005_r09'
		dw_body.SetTransObject(SQLCA)
		dw_print.SetTransObject(SQLCA)
	end if
end if
...
if cbx_except.visible then
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_ps_except, is_plan_dc, is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_etc_shop_div, is_etc_shop_div2, is_etc_shop_div3, is_etc_shop_div4, is_etc_shop_div5, is_etc_shop_div6, is_etc_shop_div7, is_etc_shop_div8, is_etc_shop_div9, is_etc_shop_div10, is_st_brand)
elseif ddlb_1.visible then									
//	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
//										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_event_gubn, is_etc_shop_div, is_etc_shop_div2, is_etc_shop_div3, is_etc_shop_div4, is_etc_shop_div5, is_etc_shop_div6, is_etc_shop_div7, is_etc_shop_div8, is_etc_shop_div9, is_etc_shop_div10, is_item_gubn, is_st_brand)									
										
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_event_gubn, is_etc_shop_div, is_etc_shop_div2, is_etc_shop_div3, is_etc_shop_div4, is_etc_shop_div5, is_etc_shop_div6, is_etc_shop_div7, is_etc_shop_div8, is_etc_shop_div9, is_etc_shop_div10, is_st_brand)																			
else									
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_etc_shop_div, is_etc_shop_div2, is_etc_shop_div3, is_etc_shop_div4, is_etc_shop_div5, is_etc_shop_div6, is_etc_shop_div7, is_etc_shop_div8, is_etc_shop_div9, is_etc_shop_div10, is_st_brand)									
end if										
...
this.rb_cust_wol=create rb_cust_wol
this.rb_cust_il=create rb_cust_il
...
this.rb_detail_style=create rb_detail_style
this.rb_week=create rb_week
...
this.Control[iCurrent+18]=this.rb_cust_wol
this.Control[iCurrent+19]=this.rb_cust_il
this.Control[iCurrent+20]=this.st_1
this.Control[iCurrent+21]=this.ddlb_1
this.Control[iCurrent+22]=this.cbx_1
this.Control[iCurrent+23]=this.cbx_2
...
this.Control[iCurrent+28]=this.cbx_7
this.Control[iCurrent+29]=this.cbx_8
this.Control[iCurrent+30]=this.cbx_9
this.Control[iCurrent+31]=this.cbx_10
this.Control[iCurrent+32]=this.st_2
this.Control[iCurrent+33]=this.st_11
this.Control[iCurrent+34]=this.rb_year
this.Control[iCurrent+35]=this.ddlb_2
this.Control[iCurrent+36]=this.rb_detail_style
this.Control[iCurrent+37]=this.rb_week
end on

on w_53005_d.destroy
call super::destroy
...
destroy(this.rb_cust_wol)
destroy(this.rb_cust_il)
destroy(this.st_1)
destroy(this.ddlb_1)
destroy(this.cbx_1)
destroy(this.cbx_2)
...
destroy(this.ddlb_2)
destroy(this.rb_detail_style)
destroy(this.rb_week)
end on
...
CHOOSE CASE ai_cb_div
   CASE 1		/* 조회 */
      if al_rows > 0 then
         ...
         dw_head.Enabled     = false
			...
			rb_yymm.Enabled     = false			
			
			rb_week.Enabled     = false
			rb_year.Enabled     = false			
			rb_mncs.Enabled      = false			
			rb_detail_style.Enabled   = false
			...
			rb_cust_il.Enabled  = false
			rb_cust_wol.Enabled = false
   ...
   CASE 5    /* 조건 */
      ...
      dw_head.Enabled     = true
		...
		rb_cust_il.Enabled  = true
		rb_cust_wol.Enabled = true
		
		rb_week.Enabled     = true
		rb_year.Enabled     = true			
		rb_mncs.Enabled      = true			
		rb_detail_style.Enabled   = true
...
dw_head.object.dotcom.visible = 0
dw_head.SETITEM(1, "DOTCOM",'0')
end event
...
if rb_cust_wol.checked then
	if cbx_except.visible then
		il_rows = dw_print.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_ps_except, is_plan_dc, is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_etc_shop_div, is_etc_shop_div2, is_etc_shop_div3, is_etc_shop_div4, is_etc_shop_div5, is_etc_shop_div6, is_etc_shop_div7, is_etc_shop_div8, is_etc_shop_div9, is_etc_shop_div10)
	elseif ddlb_1.visible then									
		il_rows = dw_print.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
											is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_event_gubn, is_etc_shop_div, is_etc_shop_div2, is_etc_shop_div3, is_etc_shop_div4, is_etc_shop_div5, is_etc_shop_div6, is_etc_shop_div7, is_etc_shop_div8, is_etc_shop_div9, is_etc_shop_div10)									
	else
...
type cb_close from w_com010_d`cb_close within w_53005_d
end type

type cb_delete from w_com010_d`cb_delete within w_53005_d
end type

type cb_insert from w_com010_d`cb_insert within w_53005_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_53005_d
end type

type cb_update from w_com010_d`cb_update within w_53005_d
end type

type cb_print from w_com010_d`cb_print within w_53005_d
end type

type cb_preview from w_com010_d`cb_preview within w_53005_d
end type

type gb_button from w_com010_d`gb_button within w_53005_d
end type

type cb_excel from w_com010_d`cb_excel within w_53005_d
end type

type dw_head from w_com010_d`dw_head within w_53005_d
integer y = 304
integer width = 3630
integer height = 372
string dataobject = "d_53005_h01"
end type
...
CHOOSE CASE dwo.name
	CASE "brand"
		...
		If data = 'B' or data = 'L' or data = 'F' then
			st_2.visible = True
			cbx_1.visible = True
			cbx_2.visible = True
			cbx_3.visible = True
...
//		This.SetItem(1, "shop_nm", "")
	...
	CASE "for_lotte"	     //  
		IF ib_itemchanged THEN RETURN 1		
		IF DATA = "Y" THEN 
			MESSAGEBOX("알림!", "해당 옵션을 선택 하는 경우 온라인 매장의 월단위 매출정산을 위해 이월된 데이터는 무시되고 출고기준으로 조회 됩니다!")	
		END IF
...
idw_brand.SetItem(1, "inter_cd", 'X')
...
//if  gl_user_level   = 0  then 
//	ls_filter_str = "inter_cd like '"    + gs_brand + "'" 
//	idw_shop_brand.SetFilter(ls_filter_str)
//	idw_shop_brand.Filter( )
//end if
...
type ln_1 from w_com010_d`ln_1 within w_53005_d
integer beginy = 684
integer endy = 684
end type

type ln_2 from w_com010_d`ln_2 within w_53005_d
integer beginy = 688
integer endy = 688
end type

type dw_body from w_com010_d`dw_body within w_53005_d
integer x = 14
integer y = 700
integer height = 1340
string dataobject = "d_53005_d01"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

event dw_body::doubleclicked;call super::doubleclicked;string ls_shop_nm, ls_style
...
CHOOSE CASE dwo.name   // 매장코드에 km 사이트 link를 위해 shop_nm 에만 더블클릭 이벤트
	CASE "shop_nm"
		...
		IF LenA(is_shop_cd) = 6  THEN		
			...
			dw_1.DataObject  = 'd_53005_d09_03'
			dw_1.SetTransObject(SQLCA)			
			
			il_rows = dw_1.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, is_dotcom, '%', is_for_lotte, is_event_gubn, is_etc_shop_div, is_etc_shop_div2, is_etc_shop_div3, is_etc_shop_div4, is_etc_shop_div5, is_etc_shop_div6, is_etc_shop_div7, is_etc_shop_div8, is_etc_shop_div9, is_etc_shop_div10, is_st_brand)
		...
		IF LenA(ls_style) = 8  THEN		
			...
			dw_1.DataObject  = 'd_53005_d17'
			dw_1.SetTransObject(SQLCA)
			
			il_rows = dw_1.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, ls_style, is_color, is_plan_dc,is_except_eshop, is_dotcom, '%', is_for_lotte, is_event_gubn, is_etc_shop_div, is_etc_shop_div2, is_etc_shop_div3, is_etc_shop_div4, is_etc_shop_div5, is_etc_shop_div6, is_etc_shop_div7, is_etc_shop_div8, is_etc_shop_div9, is_etc_shop_div10, is_st_brand)
...
tmp_chk2 = PosA(dw_body.getitemstring(row, "shop_nm"), '닷컴' ,1)	//닷컴제외


if row > 0 then 
	IF tmp_div <> "D" and tmp_div <> "X" and tmp_div <> "E" and tmp_chk2 = 0 THEN				//쇼핑몰과 기타 일경우 제외

	CHOOSE CASE dwo.name
		case 'style','style_no'
			ls_search 	= this.GetItemString(row,string(dwo.name))
			if LenA(ls_search) >= 8 then  gf_style_color_size_pic(ls_search, '%','%','0','A')		
		...
		CASE "shop_cd" 
				//CHOOSE CASE tmp_cd
					...
					//CASE "O"
						...
						//  ls_url = "http://with.ibeaucre.co.kr/include/proc/loginProc.asp?uid=" +gs_user_id + "&upw=" +gs_user_pw + "&cm=mg&pg=km&shno="+dw_body.getitemstring(row, "shop_cd")
					//CASE "W"					
...
type dw_print from w_com010_d`dw_print within w_53005_d
integer x = 1033
integer y = 704
string dataobject = "d_53005_r01"
end type
...
rb_cust_il.TextColor  = 0
rb_cust_wol.TextColor = 0
rb_detail_style.TextColor = 0
...
dw_head.object.seq_no.visible = 1
dw_head.object.t_2.visible = 1

dw_head.object.color.visible = 1
dw_head.object.t_3.visible = 1

dw_head.object.empno.visible = 1
dw_head.object.t_4.visible = 1

dw_head.object.plan_dc.visible = 1

dw_head.object.dotcom.visible = 0
dw_head.SETITEM(1, "DOTCOM",'0')

dw_body.DataObject  = 'd_53005_d01'
...
dw_head.object.dotcom.visible = 1
dw_head.SETITEM(1, "DOTCOM",'1')

dw_body.DataObject  = 'd_53005_d02'
dw_print.DataObject = 'd_53005_r02'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d03'
dw_print.DataObject = 'd_53005_r03'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d04'
dw_print.DataObject = 'd_53005_r04'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d05'
dw_print.DataObject = 'd_53005_r05'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d06'
dw_print.DataObject = 'd_53005_r06'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d10'
dw_print.DataObject = 'd_53005_r10'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d13'
dw_print.DataObject = 'd_53005_r13'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
boolean bringtotop = true
boolean titlebar = true
string dataobject = "d_53005_d09_03"
boolean controlmenu = true
boolean minbox = true
boolean maxbox = true
boolean hscrollbar = true
...
dw_head.object.dotcom.visible = 1
dw_head.SETITEM(1, "DOTCOM",'1')
dw_head.object.sojae.visible = 0
dw_head.object.sojae_t.visible = 0

dw_head.object.item.visible = 0
dw_head.object.item_t.visible = 0

dw_head.object.seq_no.visible = 0
dw_head.object.t_2.visible = 0

dw_head.object.color.visible = 0

dw_head.object.t_3.visible = 0

dw_head.object.empno.visible = 0
dw_head.object.t_4.visible = 0


dw_head.object.plan_dc.visible = 0


dw_body.DataObject  = 'd_53005_d15'
dw_print.DataObject = 'd_53005_r15'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
rb_style_no.TextColor = 0
rb_detail.TextColor   = 0
rb_cust_il.TextColor        = RGB(0, 0, 255)
rb_cust_wol.TextColor = 0
rb_detail_style.TextColor = 0
cbx_except.visible    = false
st_1.visible  = false
...
dw_body.DataObject  = 'd_53005_d14'
//dw_print.DataObject = 'd_53005_r14'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d16'
dw_print.DataObject = 'd_53005_r16'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d17'
//dw_print.DataObject = 'd_53005_r14'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d18'
dw_print.DataObject = 'd_53005_r18'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
