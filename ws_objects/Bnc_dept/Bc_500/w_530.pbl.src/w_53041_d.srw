...
String is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, is_style, is_chno, is_ps_except, is_shop_stat, is_item_gubn, is_st_brand
...
if cbx_except.visible then
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_shop_div2, is_shop_div3, is_shop_div4, is_shop_div5, is_shop_div6, is_shop_div7, is_shop_div8, is_shop_div9, is_shop_div10, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_ps_except, is_plan_dc, is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_style, is_shop_stat, is_st_brand)
elseif ddlb_1.visible then
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_shop_div2, is_shop_div3, is_shop_div4, is_shop_div5, is_shop_div6, is_shop_div7, is_shop_div8, is_shop_div9, is_shop_div10, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc, is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_style, is_shop_stat, is_event_gubn, is_item_gubn, is_st_brand)
else
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_shop_div2, is_shop_div3, is_shop_div4, is_shop_div5, is_shop_div6, is_shop_div7, is_shop_div8, is_shop_div9, is_shop_div10, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, IS_DOTCOM, is_empno, is_for_lotte, is_style, is_shop_stat, is_st_brand)
end if										
