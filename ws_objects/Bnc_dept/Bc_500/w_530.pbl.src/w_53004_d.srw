$PBExportHeader$w_53004_d.srw
$PBExportComments$점간 이송 승인-미사용
forward
global type w_53004_d from w_com010_d
end type
type gb_1 from groupbox within w_53004_d
end type
type dw_out from u_dw within w_53004_d
end type
type rb_1 from radiobutton within w_53004_d
end type
type rb_2 from radiobutton within w_53004_d
end type
end forward
...
/* 수정일      : 2002.05.28                                                  */
/*===========================================================================*/
Long i, ll_row_count, ll_out_rows	//ll_out_row = 0, 
String ls_out_no, ls_style, ls_to_shop_cd, ls_to_shop_type	//ls_out_row, 
...
FOR i = 1 TO ll_row_count
   ...
   IF idw_status = DataModified! THEN		/* Modify Record */
		If dw_body.GetItemString(i, "proc_yn") = 'Y' Then
			...
			// 마진율 계산
			If wf_style_set(i, ls_style, ls_to_shop_cd, ls_to_shop_type) = False Then
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_53004_d","0")
end event
...
type cb_close from w_com010_d`cb_close within w_53004_d
end type

type cb_delete from w_com010_d`cb_delete within w_53004_d
end type

type cb_insert from w_com010_d`cb_insert within w_53004_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_53004_d
end type

type cb_update from w_com010_d`cb_update within w_53004_d
boolean visible = true
end type

type cb_print from w_com010_d`cb_print within w_53004_d
end type

type cb_preview from w_com010_d`cb_preview within w_53004_d
end type

type gb_button from w_com010_d`gb_button within w_53004_d
end type

type cb_excel from w_com010_d`cb_excel within w_53004_d
end type

type dw_head from w_com010_d`dw_head within w_53004_d
integer x = 311
integer y = 164
integer width = 3255
integer height = 296
string dataobject = "d_53004_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_53004_d
integer beginy = 476
integer endy = 476
end type

type ln_2 from w_com010_d`ln_2 within w_53004_d
integer beginy = 480
integer endy = 480
end type

type dw_body from w_com010_d`dw_body within w_53004_d
integer x = 14
integer y = 496
integer height = 1544
string dataobject = "d_53004_d01"
...
type dw_print from w_com010_d`dw_print within w_53004_d
integer x = 1051
integer y = 352
string dataobject = "d_53004_r01"
end type
...
dw_body.DataObject = "d_53004_d01"
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = "d_53004_r01"
...
dw_body.DataObject = "d_53004_d02"
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = "d_53004_r02"
dw_print.SetTransObject(SQLCA)
