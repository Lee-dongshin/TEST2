$PBExportHeader$w_53001_20051109.srw
$PBExportComments$판매등록
forward
global type w_53001_20051109 from w_com010_e
end type
type dw_member from datawindow within w_53001_20051109
end type
type st_1 from statictext within w_53001_20051109
end type
type cb_input from commandbutton within w_53001_20051109
end type
type dw_list from datawindow within w_53001_20051109
end type
type st_2 from statictext within w_53001_20051109
end type
end forward
...
global w_53001_20051109 w_53001_20051109
...
string  ls_jumin, ls_card_no, ls_sale_fg, ls_style_no, ls_item, ls_coupon_no, ls_coupon_yn,ls_brand
...
//			  
//			
//			if  ld_goods_amt  = 20000   and  ls_brand  <> 'O'   then
//					  messagebox('확인', "2만원권 구매할인권은 올리브 매장에서만 사용가능 합니다 !")
//						return FALSE
//			end if
//			
//			if  ld_coupon_amt  = 20000  and  ls_brand  <> 'O'   then
//						ld_coupon_amt = 0		 	
//			end if
//			
//			
//			if   ld_goods_amt  = 30000   and  ls_brand  = 'O'  then
//					  messagebox('확인', "3만원권 구매할인권은 올리브 매장에서는 사용할수 없습니다 !")
//						return FALSE
//			end if
//			
//			if   ld_coupon_amt  = 30000  and  ls_brand  = 'O'  then	
//					  ld_coupon_amt = 0
//			end if
//			
//			if ld_coupon_amt = 50000  and  ls_brand  = 'O'  then	
...
type cb_close from w_com010_e`cb_close within w_53001_20051109
integer taborder = 140
end type

type cb_delete from w_com010_e`cb_delete within w_53001_20051109
integer taborder = 130
end type

type cb_insert from w_com010_e`cb_insert within w_53001_20051109
integer taborder = 70
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_53001_20051109
integer x = 2839
integer width = 384
integer taborder = 40
string text = "일보조회(&Q)"
...
type cb_update from w_com010_e`cb_update within w_53001_20051109
end type

type cb_print from w_com010_e`cb_print within w_53001_20051109
boolean visible = false
integer taborder = 100
end type

type cb_preview from w_com010_e`cb_preview within w_53001_20051109
boolean visible = false
integer taborder = 110
end type

type gb_button from w_com010_e`gb_button within w_53001_20051109
end type

type cb_excel from w_com010_e`cb_excel within w_53001_20051109
boolean visible = false
integer taborder = 120
end type

type dw_head from w_com010_e`dw_head within w_53001_20051109
integer y = 164
integer width = 3447
integer height = 156
...
type ln_1 from w_com010_e`ln_1 within w_53001_20051109
integer beginy = 380
integer endy = 380
end type

type ln_2 from w_com010_e`ln_2 within w_53001_20051109
integer beginy = 384
integer endy = 384
end type

type dw_body from w_com010_e`dw_body within w_53001_20051109
...
type dw_print from w_com010_e`dw_print within w_53001_20051109
end type
