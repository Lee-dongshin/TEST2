$PBExportHeader$w_55021_d.srw
$PBExportComments$BEST/WORST STYLE조회
forward
global type w_55021_d from w_com010_d
end type
type rb_1 from radiobutton within w_55021_d
end type
type rb_2 from radiobutton within w_55021_d
end type
type rb_sale_rate from radiobutton within w_55021_d
end type
type rb_sale_qty from radiobutton within w_55021_d
end type
type cbx_gubn from checkbox within w_55021_d
end type
type cbx_chn from checkbox within w_55021_d
end type
type cbx_dep_fg from checkbox within w_55021_d
end type
type cbx_plan_fg from checkbox within w_55021_d
end type
type cbx_spot from checkbox within w_55021_d
end type
type cbx_bujin from checkbox within w_55021_d
end type
type cbx_halin from checkbox within w_55021_d
end type
type dw_1 from datawindow within w_55021_d
end type
type cbx_halin_exc from checkbox within w_55021_d
end type
type dw_2 from datawindow within w_55021_d
end type
type gb_1 from groupbox within w_55021_d
end type
end forward
...
///* 수정일      : 2001.01.01                                                  */
///*===========================================================================*/
//string ls_doc_nm, ls_nm, ls_ErrMsg,ls_msg
//long ll_sqlcode,ll_xls_ret
//integer li_ret
//boolean lb_exist
//Pointer Old_pointer
////Oleobject xlapp
...
type cb_close from w_com010_d`cb_close within w_55021_d
integer taborder = 110
end type

type cb_delete from w_com010_d`cb_delete within w_55021_d
integer taborder = 60
end type

type cb_insert from w_com010_d`cb_insert within w_55021_d
integer taborder = 50
boolean enabled = false
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_55021_d
end type

type cb_update from w_com010_d`cb_update within w_55021_d
integer taborder = 100
end type

type cb_print from w_com010_d`cb_print within w_55021_d
integer taborder = 70
end type

type cb_preview from w_com010_d`cb_preview within w_55021_d
integer taborder = 80
end type

type gb_button from w_com010_d`gb_button within w_55021_d
end type

type cb_excel from w_com010_d`cb_excel within w_55021_d
integer taborder = 90
end type

type dw_head from w_com010_d`dw_head within w_55021_d
integer x = 0
integer y = 160
integer width = 4329
integer height = 288
...
type ln_1 from w_com010_d`ln_1 within w_55021_d
integer beginy = 452
integer endx = 4357
integer endy = 452
end type

type ln_2 from w_com010_d`ln_2 within w_55021_d
integer beginy = 456
integer endx = 4357
integer endy = 456
end type

type dw_body from w_com010_d`dw_body within w_55021_d
integer x = 9
integer width = 4347
integer height = 1512
integer taborder = 40
...
type dw_print from w_com010_d`dw_print within w_55021_d
integer x = 2368
integer y = 1628
string dataobject = "d_55021_d01"
end type
...
event clicked;if this.checked then
	...
	if cbx_chn.checked then
		if rb_1.checked then
			dw_body.DataObject = 'd_55021_rc01'  // 미사용
			dw_body.SetTransObject(SQLCA)


			dw_print.DataObject = 'd_55021_rc01' // 미사용
			dw_print.SetTransObject(SQLCA)	
		else
			dw_body.DataObject = 'd_55021_rc03' // 미사용
			dw_body.SetTransObject(SQLCA)

			dw_print.DataObject = 'd_55021_rc03' // 미사용
			dw_print.SetTransObject(SQLCA)	
	...
	if cbx_chn.checked then
		if rb_1.checked then
			dw_body.DataObject = 'd_55021_c01' // 미사용
			dw_body.SetTransObject(SQLCA)
			dw_print.DataObject = 'd_55021_c01' // 미사용
			dw_print.SetTransObject(SQLCA)		
		else
			dw_body.DataObject = 'd_55021_c03' // 미사용
			dw_body.SetTransObject(SQLCA)
			dw_print.DataObject = 'd_55021_c03' // 미사용
			dw_print.SetTransObject(SQLCA)		
