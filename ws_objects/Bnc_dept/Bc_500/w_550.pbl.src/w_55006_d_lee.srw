$PBExportHeader$w_55006_d_lee.srw
$PBExportComments$출고 대비 판매율 현황
forward
global type w_55006_d_lee from w_com010_d
end type
type tab_1 from tab within w_55006_d_lee
end type
...
type dw_shop_item from u_dw within w_55006_d_lee
end type
type dw_shop_style from u_dw within w_55006_d_lee
end type
type dw_style_shop from u_dw within w_55006_d_lee
end type
type dw_shop_item_size_temp2 from u_dw within w_55006_d_lee
end type
type dw_shop_item_size_temp from u_dw within w_55006_d_lee
end type
type dw_shop_item_size from u_dw within w_55006_d_lee
end type
type dw_shop_item_color_size from u_dw within w_55006_d_lee
end type
type dw_shop_item_color_size_temp from u_dw within w_55006_d_lee
end type
end forward
...
dw_shop_item_size_temp dw_shop_item_size_temp
...
global w_55006_d_lee w_55006_d_lee

type variables
DataWindowChild idw_brand, idw_season, idw_sojae, idw_item, idw_color, idw_size

String is_brand, is_year, is_season, is_yymmdd, is_sojae, is_item, is_shop_cd
...
this.dw_shop_item_size_temp=create dw_shop_item_size_temp
...
this.Control[iCurrent+2]=this.dw_shop_item
this.Control[iCurrent+3]=this.dw_shop_style
this.Control[iCurrent+4]=this.dw_style_shop
this.Control[iCurrent+5]=this.dw_shop_item_size_temp2
this.Control[iCurrent+6]=this.dw_shop_item_size_temp
this.Control[iCurrent+7]=this.dw_shop_item_size
this.Control[iCurrent+8]=this.dw_shop_item_color_size
this.Control[iCurrent+9]=this.dw_shop_item_color_size_temp
end on

on w_55006_d_lee.destroy
call super::destroy
...
destroy(this.dw_shop_item_size_temp)
...
Choose Case ii_tab_chk
	...
	Case 3
		...
		End If
	Case 4
		il_rows = dw_shop_style.retrieve(is_brand, is_year, is_season, is_yymmdd, is_sojae, is_item, is_shop_cd, &
													is_shop_type, is_style, is_chno, is_color, is_size)
		IF il_rows > 0 THEN
			ib_tab4_chk = True
			dw_shop_style.SetFocus()
		End If
	Case 5
...
Choose Case ii_tab_chk
	...
	Case 5
		dw_print.DataObject = 'd_55006_r05'
		dw_print.SetTransObject(SQLCA)
...
type cb_close from w_com010_d`cb_close within w_55006_d_lee
integer taborder = 190
end type

type cb_delete from w_com010_d`cb_delete within w_55006_d_lee
integer taborder = 140
end type

type cb_insert from w_com010_d`cb_insert within w_55006_d_lee
integer taborder = 120
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_55006_d_lee
integer taborder = 80
end type

type cb_update from w_com010_d`cb_update within w_55006_d_lee
integer taborder = 180
end type

type cb_print from w_com010_d`cb_print within w_55006_d_lee
integer taborder = 150
end type

type cb_preview from w_com010_d`cb_preview within w_55006_d_lee
integer taborder = 160
end type

type gb_button from w_com010_d`gb_button within w_55006_d_lee
end type

type cb_excel from w_com010_d`cb_excel within w_55006_d_lee
integer taborder = 170
end type

type dw_head from w_com010_d`dw_head within w_55006_d_lee
integer height = 412
...
CHOOSE CASE dwo.name
	CASE "color"
		ls_style_no = dw_head.GetItemString(1, "style_no")
		If LenA(ls_style_no) = 8 Then
			This.SetItem(1, "size", "")
			idw_size.Retrieve(ls_style_no, '%', data)
			idw_size.InsertRow(1)
			idw_size.SetItem(1, "size", '%')
			idw_size.SetItem(1, "size_nm", '전체')
		ElseIf LenA(ls_style_no) = 9 Then
			This.SetItem(1, "size", "")
			idw_size.Retrieve(LeftA(ls_style_no, 8), MidA(ls_style_no, 9, 1), data)
			idw_size.InsertRow(1)
			idw_size.SetItem(1, "size", '%')
			idw_size.SetItem(1, "size_nm", '전체')
		End If
...
type ln_1 from w_com010_d`ln_1 within w_55006_d_lee
integer beginy = 616
integer endy = 616
end type

type ln_2 from w_com010_d`ln_2 within w_55006_d_lee
integer beginy = 620
integer endy = 620
end type

type dw_body from w_com010_d`dw_body within w_55006_d_lee
integer x = 32
integer y = 740
integer width = 3552
integer height = 1284
...
type dw_print from w_com010_d`dw_print within w_55006_d_lee
integer x = 2153
integer y = 224
string dataobject = "d_55006_r01"
end type
