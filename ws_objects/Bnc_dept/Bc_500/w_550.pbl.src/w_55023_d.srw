...
if gs_brand = 'N' and (is_bf_brand = 'O' or is_bf_brand = 'D' or is_bf_brand = 'Y') then
   MessageBox(ls_title,"보끄레 직원은 올리브 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("bf_brand")
   return false
elseif gs_brand = 'O' and (is_bf_brand = 'N' or is_bf_brand = 'M' or is_bf_brand = 'E' or is_bf_brand = 'F' or is_bf_brand = 'G' or is_bf_brand = 'J') then
   MessageBox(ls_title,"올리브 직원은 보끄레 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("bf_brand")
   return false	
elseif gs_brand = 'Y' and (is_bf_brand = 'N' or is_bf_brand = 'M' or is_bf_brand = 'E' or is_bf_brand = 'F' or is_bf_brand = 'G' or is_bf_brand = 'J') then
   MessageBox(ls_title,"올리브 직원은 보끄레 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("bf_brand")
   return false		
elseif gs_brand = 'B' and (is_bf_brand = 'O' or is_bf_brand = 'D') then
   MessageBox(ls_title,"이터널 직원은 올리브 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("bf_brand")
   return false		
elseif gs_brand = 'G' and (is_bf_brand = 'O' or is_bf_brand = 'D') then
   MessageBox(ls_title,"이터널 직원은 올리브 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("bf_brand")
   return false			
