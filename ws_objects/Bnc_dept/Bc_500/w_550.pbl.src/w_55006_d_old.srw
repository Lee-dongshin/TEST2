$PBExportHeader$w_55006_d_old.srw
$PBExportComments$출고 대비 판매율 현황
forward
global type w_55006_d_old from w_com010_d
end type
type tab_1 from tab within w_55006_d_old
end type
...
type dw_shop_item from u_dw within w_55006_d_old
end type
type dw_shop_item_size from u_dw within w_55006_d_old
end type
type dw_shop_style from u_dw within w_55006_d_old
end type
type dw_style_shop from u_dw within w_55006_d_old
end type
type dw_shop_item_size_temp2 from u_dw within w_55006_d_old
end type
type dw_shop_item_size_temp from u_dw within w_55006_d_old
end type
end forward
...
global w_55006_d_old w_55006_d_old
...
Boolean ib_tab4_chk = False, ib_tab5_chk = False
Long il_size_cnt
...
this.Control[iCurrent+3]=this.dw_shop_item_size
...
this.Control[iCurrent+7]=this.dw_shop_item_size_temp
end on

on w_55006_d_old.destroy
call super::destroy
...
type cb_close from w_com010_d`cb_close within w_55006_d_old
end type

type cb_delete from w_com010_d`cb_delete within w_55006_d_old
end type

type cb_insert from w_com010_d`cb_insert within w_55006_d_old
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_55006_d_old
end type

type cb_update from w_com010_d`cb_update within w_55006_d_old
end type

type cb_print from w_com010_d`cb_print within w_55006_d_old
end type

type cb_preview from w_com010_d`cb_preview within w_55006_d_old
end type

type gb_button from w_com010_d`gb_button within w_55006_d_old
end type

type cb_excel from w_com010_d`cb_excel within w_55006_d_old
end type

type dw_head from w_com010_d`dw_head within w_55006_d_old
integer height = 412
...
type ln_1 from w_com010_d`ln_1 within w_55006_d_old
integer beginy = 616
integer endy = 616
end type

type ln_2 from w_com010_d`ln_2 within w_55006_d_old
integer beginy = 620
integer endy = 620
end type

type dw_body from w_com010_d`dw_body within w_55006_d_old
integer x = 32
integer y = 740
integer width = 3552
integer height = 1284
...
type dw_print from w_com010_d`dw_print within w_55006_d_old
