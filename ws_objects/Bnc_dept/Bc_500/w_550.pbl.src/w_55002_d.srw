$PBExportHeader$w_55002_d.srw
$PBExportComments$인기 STYLE 판매 현황
forward
global type w_55002_d from w_com010_d
end type
type rb_m from radiobutton within w_55002_d
end type
type rb_mc from radiobutton within w_55002_d
end type
type rb_mcs from radiobutton within w_55002_d
end type
type p_1 from picture within w_55002_d
end type
type st_1 from statictext within w_55002_d
end type
type st_2 from statictext within w_55002_d
end type
type rb_m2 from radiobutton within w_55002_d
end type
type rb_mc2 from radiobutton within w_55002_d
end type
type rb_mcs2 from radiobutton within w_55002_d
end type
type gb_1 from groupbox within w_55002_d
end type
end forward
...
global w_55002_d w_55002_d

type variables
DataWindowChild idw_brand, idw_season, idw_sojae, idw_item, idw_shop_div, idw_empno, idw_st_brand

String is_brand, is_year, is_season, is_fr_yymmdd, is_to_yymmdd, is_sojae, is_st_brand
...
il_rows = dw_body.retrieve(is_brand, is_fr_yymmdd, is_to_yymmdd,  is_year, is_season, is_sojae, &
									is_item, is_shop_div, is_shop_cd, is_empno, is_shop_type, is_sort_fg, idc_ranking, is_st_brand)
...
if IsNull(is_sort_fg) or Trim(is_sort_fg) = "" then
   MessageBox(ls_title,"매장 순위 구분을 입력하십시요!")
   dw_head.SetFocus()
...
If is_fr_shop_cd = is_brand + '00000' Then
	ls_fr_shop_nm = ' '
Else
	ls_fr_shop_nm = dw_head.GetItemString(1, "fr_shop_nm")
End If

If is_to_shop_cd = is_brand + 'ZZZZZ' Then
	ls_to_shop_nm = ' '
Else
...
ls_modify =	"t_pg_id.Text = '" + is_pgm_id + "'" + &
            ...
            "t_shop_cd.Text = '" + is_fr_shop_cd + " " + ls_fr_shop_nm + "   ~~   " + &
            							  is_to_shop_cd + " " + ls_to_shop_nm + "'" + &
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_55002_d","0")
end event

event pfc_preopen();call super::pfc_preopen;inv_resize.of_Register(dw_head, "ScaleToRight")
end event

type cb_close from w_com010_d`cb_close within w_55002_d
end type

type cb_delete from w_com010_d`cb_delete within w_55002_d
end type

type cb_insert from w_com010_d`cb_insert within w_55002_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_55002_d
end type

type cb_update from w_com010_d`cb_update within w_55002_d
end type

type cb_print from w_com010_d`cb_print within w_55002_d
end type

type cb_preview from w_com010_d`cb_preview within w_55002_d
end type

type gb_button from w_com010_d`gb_button within w_55002_d
end type

type cb_excel from w_com010_d`cb_excel within w_55002_d
end type

type dw_head from w_com010_d`dw_head within w_55002_d
integer x = 736
integer y = 184
integer width = 2821
integer height = 416
string dataobject = "d_55002_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_55002_d
integer beginy = 616
integer endy = 616
end type

type ln_2 from w_com010_d`ln_2 within w_55002_d
integer beginy = 620
integer endy = 620
end type

type dw_body from w_com010_d`dw_body within w_55002_d
integer y = 636
integer height = 1404
string dataobject = "d_55002_d01"
end type
...
type dw_print from w_com010_d`dw_print within w_55002_d
string dataobject = "d_55002_r01"
end type
...
dw_body.DataObject = 'd_55002_d01'
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = 'd_55002_r01'
...
dw_body.DataObject = 'd_55002_d02'
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = 'd_55002_r02'
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject = 'd_55002_d03'
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = 'd_55002_r03'
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject = 'd_55002_d04'
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = 'd_55002_r04'
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject = 'd_55002_d05'
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = 'd_55002_r05'
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject = 'd_55002_d06'
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = 'd_55002_r06'
dw_print.SetTransObject(SQLCA)
