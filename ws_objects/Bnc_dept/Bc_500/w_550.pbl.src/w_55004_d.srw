$PBExportHeader$w_55004_d.srw
$PBExportComments$복종별 인기 STYLE 순위
forward
global type w_55004_d from w_com010_d
end type
type dw_temp from u_dw within w_55004_d
end type
end forward
...
/* 수정일      : 2002.01.21                                                  */
/*===========================================================================*/
String     ls_shop_nm, ls_brand, ls_brand_grp
Boolean    lb_check 
...
type cb_close from w_com010_d`cb_close within w_55004_d
end type

type cb_delete from w_com010_d`cb_delete within w_55004_d
end type

type cb_insert from w_com010_d`cb_insert within w_55004_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_55004_d
end type

type cb_update from w_com010_d`cb_update within w_55004_d
end type

type cb_print from w_com010_d`cb_print within w_55004_d
end type

type cb_preview from w_com010_d`cb_preview within w_55004_d
end type

type gb_button from w_com010_d`gb_button within w_55004_d
end type

type cb_excel from w_com010_d`cb_excel within w_55004_d
end type

type dw_head from w_com010_d`dw_head within w_55004_d
integer height = 320
...
type ln_1 from w_com010_d`ln_1 within w_55004_d
integer beginy = 520
integer endy = 520
end type

type ln_2 from w_com010_d`ln_2 within w_55004_d
integer beginy = 524
integer endy = 524
end type

type dw_body from w_com010_d`dw_body within w_55004_d
integer y = 540
integer height = 1500
...
type dw_print from w_com010_d`dw_print within w_55004_d
