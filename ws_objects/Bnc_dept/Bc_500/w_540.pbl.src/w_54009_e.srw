...
string is_style, is_color, is_yymmdd, is_recall_no,  is_shop_div, is_sort
int	 ii_sale_rate 
end variables
...
public subroutine wf_retrieve_set ();
String ls_shop_cd,   ls_find , ls_error , ls_modify, ls_size ,ls_style, ls_chno, ls_shop_class
Long   ll_row, ll_row_cnt, ll_assort_cnt, ll_size_cnt , ll_max_k
Long   i, k, ll_out_qty , ll_sale_qty, ll_stock_qty, ll_recall_qty  ,j, ll_rot_qty
...
For i = 1 to ll_row_cnt 
      ...
      ls_shop_cd =  tab_1.tabpage_3.dw_4.object.shop_cd[i] 
		ls_shop_class = tab_1.tabpage_3.dw_4.object.shop_class[i] 
		ll_row     =  tab_1.tabpage_3.dw_3.insertRow(0)
      tab_1.tabpage_3.dw_3.Setitem(ll_row, "part_div",   ls_shop_cd)
      tab_1.tabpage_3.dw_3.Setitem(ll_row, "class",   ls_shop_class)
	...
	for j = 1 to 8 
		...
		tab_1.tabpage_3.dw_3.Setitem(ll_row, "rot_qty_" + String(j), 0)		
   ...
   k = tab_1.tabpage_3.dw_5.find(ls_find, 1, ll_assort_cnt)	
	...
	IF k > 0 THEN 
		...
		ll_rot_qty	=  tab_1.tabpage_3.dw_4.GetitemNumber(i, "rt_qty")			
		...
		tab_1.tabpage_3.dw_3.Setitem(ll_row, "rot_qty_"  + String(k),    ll_rot_qty)				
...
CHOOSE CASE dwo.name
	...
	CASE "t_part_div"
			...
			if is_sort = "A" then
				this.SetSort("part_div d")
				this.SetSort("C_SHOP_CD d")
				is_sort = "D"				
			else 	
				this.SetSort("C_SHOP_CD A")				
//				this.SetSort("part_div a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_sale1"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("sale_qty_1 d")
				is_sort = "D"				
			else 	
				this.SetSort("sale_qty_1 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_sale2"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("sale_qty_2 d")
				is_sort = "D"				
			else 	
				this.SetSort("sale_qty_2 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_sale3"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("sale_qty_3 d")
				is_sort = "D"				
			else 	
				this.SetSort("sale_qty_3 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_sale4"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("sale_qty_4 d")
				is_sort = "D"				
			else 	
				this.SetSort("sale_qty_4 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_sale5"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("sale_qty_5 d")
				is_sort = "D"				
			else 	
				this.SetSort("sale_qty_5 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_sale6"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("sale_qty_6 d")
				is_sort = "D"				
			else 	
				this.SetSort("sale_qty_6 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_sale7"
					this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("sale_qty_7 d")
				is_sort = "D"				
			else 	
				this.SetSort("sale_qty_7 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)		
	...
	CASE "t_sale8"
					this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("sale_qty_8 d")
				is_sort = "D"				
			else 	
				this.SetSort("sale_qty_8 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_stock1"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("stock_qty_1 d")
				is_sort = "D"				
			else 	
				this.SetSort("stock_qty_1 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_stock2"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("stock_qty_2 d")
				is_sort = "D"				
			else 	
				this.SetSort("stock_qty_2 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_stock3"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("stock_qty_3 d")
				is_sort = "D"				
			else 	
				this.SetSort("stock_qty_3 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_stock4"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("stock_qty_4 d")
				is_sort = "D"				
			else 	
				this.SetSort("stock_qty_4 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_stock5"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("stock_qty_5 d")
				is_sort = "D"				
			else 	
				this.SetSort("stock_qty_5 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_stock6"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("stock_qty_6 d")
				is_sort = "D"				
			else 	
				this.SetSort("stock_qty_6 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_stock7"
			this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("stock_qty_7 d")
				is_sort = "D"				
			else 	
				this.SetSort("stock_qty_7 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)
	...
	CASE "t_stock8"
					this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("stock_qty_8 d")
				is_sort = "D"				
			else 	
				this.SetSort("stock_qty_8 a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)				
	...
	CASE "t_class"
					this.SetRedraw(false)
			if is_sort = "A" then
				this.SetSort("C_SHOP_CD d, class d  ")
				is_sort = "D"				
			else 	
				this.SetSort(" C_SHOP_CD a, class a")				
				is_sort = "A"				
			end if	
			this.Sort()
			this.SetRedraw(true)				
