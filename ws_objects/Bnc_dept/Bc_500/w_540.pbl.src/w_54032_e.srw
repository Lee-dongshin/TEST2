...
type variables
String is_brand, is_yymmdd, is_fr_ymd, is_to_ymd, is_proc_yn , is_st_brand, is_out_ymd, is_style, is_shoP_cd
...
il_rows = dw_body.retrieve(is_brand, is_st_brand, is_fr_ymd, is_to_ymd, is_proc_yn, is_year, is_season, is_house_cd, is_style_gubn, is_shop_cd, is_style)
