$PBExportHeader$w_54017_e.srw
$PBExportComments$RT진행현황조회
forward
global type w_54017_e from w_com010_d
end type
end forward

global type w_54017_e from w_com010_d
end type
global w_54017_e w_54017_e

type variables
DataWindowChild idw_brand, idw_empno
String is_brand, is_frm_ymd, is_to_ymd, is_shop_cd, is_out_gubn, is_empno, is_shop_type
end variables
...
if IsNull(is_out_gubn) or Trim(is_out_gubn) = "" then
   MessageBox(ls_title,"RT구분을 입력하십시요!")
   dw_head.SetFocus()
...
//exec sp_54017_d01 'o','20030205','20030205','%','b'

il_rows = dw_body.retrieve(is_brand, is_frm_ymd, is_to_ymd, is_shop_cd, is_out_gubn, is_empno, is_shop_type)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
type cb_close from w_com010_d`cb_close within w_54017_e
end type

type cb_delete from w_com010_d`cb_delete within w_54017_e
end type

type cb_insert from w_com010_d`cb_insert within w_54017_e
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_54017_e
end type

type cb_update from w_com010_d`cb_update within w_54017_e
end type

type cb_print from w_com010_d`cb_print within w_54017_e
end type

type cb_preview from w_com010_d`cb_preview within w_54017_e
end type

type gb_button from w_com010_d`gb_button within w_54017_e
end type

type cb_excel from w_com010_d`cb_excel within w_54017_e
end type

type dw_head from w_com010_d`dw_head within w_54017_e
integer height = 216
string dataobject = "d_54017_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_54017_e
integer beginy = 400
integer endy = 400
end type

type ln_2 from w_com010_d`ln_2 within w_54017_e
integer beginy = 404
integer endy = 404
end type

type dw_body from w_com010_d`dw_body within w_54017_e
integer y = 420
integer height = 1620
string dataobject = "d_54017_d01"
end type

type dw_print from w_com010_d`dw_print within w_54017_e
string dataobject = "d_54017_r01"
end type
