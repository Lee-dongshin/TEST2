$PBExportHeader$w_54011_d.srw
$PBExportComments$완불 진행 현황
forward
global type w_54011_d from w_com010_d
end type
end forward

global type w_54011_d from w_com010_d
end type
global w_54011_d w_54011_d

type variables
DataWindowChild idw_brand, idw_color, idw_size

String is_brand, is_fr_ymd, is_to_ymd, is_shop_cd
STRING is_style, is_chno, is_color, is_size, is_check
end variables
...
il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_cd, is_style, is_chno, is_color, is_size, is_check)
...
if IsNull(is_STYLE) or is_STYLE = "" then is_STYLE = '%'

is_chno = Trim(dw_head.GetItemString(1, "chno"))
if IsNull(is_chno) or is_chno = "" then is_chno = '%'
...
is_check= Trim(dw_head.GetItemString(1, "check"))
if IsNull(is_check) or is_check = "" then
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_54011_d","0")
end event

type cb_close from w_com010_d`cb_close within w_54011_d
end type

type cb_delete from w_com010_d`cb_delete within w_54011_d
end type

type cb_insert from w_com010_d`cb_insert within w_54011_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_54011_d
end type

type cb_update from w_com010_d`cb_update within w_54011_d
end type

type cb_print from w_com010_d`cb_print within w_54011_d
end type

type cb_preview from w_com010_d`cb_preview within w_54011_d
end type

type gb_button from w_com010_d`gb_button within w_54011_d
end type

type cb_excel from w_com010_d`cb_excel within w_54011_d
end type

type dw_head from w_com010_d`dw_head within w_54011_d
integer y = 160
integer height = 232
string dataobject = "d_54011_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_54011_d
integer beginy = 400
integer endy = 400
end type

type ln_2 from w_com010_d`ln_2 within w_54011_d
integer beginy = 404
integer endy = 404
end type

type dw_body from w_com010_d`dw_body within w_54011_d
integer x = 9
integer y = 420
integer height = 1620
string dataobject = "d_54011_d01"
...
type dw_print from w_com010_d`dw_print within w_54011_d
integer x = 1641
integer y = 760
string dataobject = "d_54011_r01"
end type
