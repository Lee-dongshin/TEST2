$PBExportHeader$w_23008_d.srw
$PBExportComments$정산현황(마감집계)
forward
global type w_23008_d from w_com010_d
end type
end forward
...
global w_23008_d w_23008_d

type variables
string is_brand, is_yymm, is_mat_type, is_cust_cd
...
il_rows = dw_body.retrieve(is_brand, is_yymm, is_mat_type, is_cust_cd)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
il_rows = dw_print.retrieve(is_brand, is_yymm, is_mat_type, is_cust_cd)
...
type cb_close from w_com010_d`cb_close within w_23008_d
end type

type cb_delete from w_com010_d`cb_delete within w_23008_d
end type

type cb_insert from w_com010_d`cb_insert within w_23008_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_23008_d
end type

type cb_update from w_com010_d`cb_update within w_23008_d
end type

type cb_print from w_com010_d`cb_print within w_23008_d
end type

type cb_preview from w_com010_d`cb_preview within w_23008_d
end type

type gb_button from w_com010_d`gb_button within w_23008_d
end type

type cb_excel from w_com010_d`cb_excel within w_23008_d
end type

type dw_head from w_com010_d`dw_head within w_23008_d
string dataobject = "d_23008_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_23008_d
end type

type ln_2 from w_com010_d`ln_2 within w_23008_d
end type

type dw_body from w_com010_d`dw_body within w_23008_d
string dataobject = "d_23008_d01"
...
type dw_print from w_com010_d`dw_print within w_23008_d
integer x = 50
integer y = 544
integer width = 1129
integer height = 460
string dataobject = "d_23008_r09"
end type
