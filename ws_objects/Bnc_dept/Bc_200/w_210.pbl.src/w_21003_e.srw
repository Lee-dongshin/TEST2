...
string ls_claim_agree,ls_brand,ls_user_level
...
if gs_brand = 'N' and (MidA(is_mat_cd,1,1) = 'O' or MidA(is_mat_cd,1,1) = 'D') then
   ...
   dw_head.SetColumn("mat_cd")
   return false
elseif gs_brand = 'O' and (MidA(is_mat_cd,1,1) = 'N' or MidA(is_mat_cd,1,1) = 'B' or MidA(is_mat_cd,1,1) = 'L' or MidA(is_mat_cd,1,1) = 'F' or MidA(is_mat_cd,1,1) = 'G'  or MidA(is_mat_cd,1,1) = 'J' ) then
