...
//	gst_cd.default_where   = "Where brand     = '" + is_brand + "' " 
			if is_brand = "O" or is_brand = "D"  or is_brand = "A" then
			
							gst_cd.default_where   = "Where change_gubn = '00'  "      + &
												 " and left(custcode,1)  = '" + is_brand + "'  and cust_code between '5000' and '9999'"
			else 												 
							gst_cd.default_where   = "Where change_gubn = '00'"      + &
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_21004_e","0")
end event
...
into :ls_bigo
from dual where ( :ls_mat_cd like '%L09010' or  :ls_mat_cd like '%L00130' or :ls_mat_cd like '%B00010' or :ls_mat_cd like '%L03000'  or :ls_mat_cd like '%L06002') ;
