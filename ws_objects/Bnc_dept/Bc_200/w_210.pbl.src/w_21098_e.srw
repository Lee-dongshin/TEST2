...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_21098_e","0")
end event
...
string ls_mat_nm1, ls_remark1, ls_country_nm, ls_sect_nm, ls_flag, ls_cust_nm, ls_sojae,ls_mat_nm2
