...
if gs_brand = 'N' and (MidA(is_ord_origin,1,1) = 'O' or MidA(is_ord_origin,1,1) = 'D') then
   MessageBox(ls_title,"보끄레 직원은 올리브 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("ord_origin")
   return false
elseif (gs_brand = 'O' or  gs_brand = 'D' or  gs_brand = 'Y' or  gs_brand = 'U')  and (MidA(is_ord_origin,1,1) = 'N' or MidA(is_ord_origin,1,1) = 'B' or MidA(is_ord_origin,1,1) = 'L' or MidA(is_ord_origin,1,1) = 'F' or MidA(is_ord_origin,1,1) = 'G' or MidA(is_ord_origin,1,1) = 'J') then
   MessageBox(ls_title,"올리브 직원은 보끄레 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("ord_origin")
   return false	
elseif gs_brand = 'B' and (MidA(is_ord_origin,1,1) = 'O' or MidA(is_ord_origin,1,1) = 'D') then
   MessageBox(ls_title,"이터널 직원은 올리브 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("ord_origin")
   return false		
elseif gs_brand = 'G' and (MidA(is_ord_origin,1,1) = 'O' or MidA(is_ord_origin,1,1) = 'D') then
   MessageBox(ls_title,"이터널 직원은 올리브 데이터 조회에 제한이 있습니다.!")
   dw_head.SetFocus()
   dw_head.SetColumn("ord_origin")
   return false			
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_21011_d","0")
end event
