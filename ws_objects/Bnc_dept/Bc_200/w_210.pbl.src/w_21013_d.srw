$PBExportHeader$w_21013_d.srw
$PBExportComments$원자재 발주 현황
forward
global type w_21013_d from w_com010_d
end type
end forward
...
global w_21013_d w_21013_d

type variables
string  is_brand, is_mat_year, is_mat_season, is_mat_sojae, is_out_seq, is_in_gubn, is_mat_cd, is_cust_cd, is_miipgo, is_fr_ymd, is_to_ymd, is_sijang_gubn

datawindowchild  idw_brand, idw_season, idw_mat_sojae, idw_out_seq
end variables

forward prototypes
public subroutine gf_confirm_mat (string as_mat_cd)
end prototypes
...
il_rows = dw_body.retrieve(is_brand, is_mat_year, is_mat_season, is_mat_sojae, is_out_seq, is_in_gubn, is_mat_cd, is_cust_cd, is_miipgo, is_fr_ymd, is_to_ymd, is_sijang_gubn)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_21013_d","0")
end event

type cb_close from w_com010_d`cb_close within w_21013_d
end type

type cb_delete from w_com010_d`cb_delete within w_21013_d
end type

type cb_insert from w_com010_d`cb_insert within w_21013_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_21013_d
end type

type cb_update from w_com010_d`cb_update within w_21013_d
end type

type cb_print from w_com010_d`cb_print within w_21013_d
end type

type cb_preview from w_com010_d`cb_preview within w_21013_d
end type

type gb_button from w_com010_d`gb_button within w_21013_d
end type

type cb_excel from w_com010_d`cb_excel within w_21013_d
end type

type dw_head from w_com010_d`dw_head within w_21013_d
integer y = 160
integer width = 3557
integer height = 296
string dataobject = "d_21013_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_21013_d
integer beginy = 464
integer endy = 464
end type

type ln_2 from w_com010_d`ln_2 within w_21013_d
integer beginy = 468
integer endy = 468
end type

type dw_body from w_com010_d`dw_body within w_21013_d
integer y = 492
integer height = 1548
string dataobject = "d_21013_d01"
...
if row > 0 then 
	choose case dwo.name
		case 'mat_cd','mat_nm'
			...
			if LenA(ls_search) = 10 then gf_confirm_mat(ls_search)
	end choose	
end if
end event

type dw_print from w_com010_d`dw_print within w_21013_d
integer x = 59
integer y = 564
string dataobject = "d_21013_r01"
end type
