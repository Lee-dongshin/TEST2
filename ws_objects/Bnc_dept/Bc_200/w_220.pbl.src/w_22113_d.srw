$PBExportHeader$w_22113_d.srw
$PBExportComments$부자재출고/반품현황
forward
global type w_22113_d from w_com010_d
end type
end forward

global type w_22113_d from w_com010_d
end type
global w_22113_d w_22113_d
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_22113_d","0")
end event
...
type cb_close from w_com010_d`cb_close within w_22113_d
end type

type cb_delete from w_com010_d`cb_delete within w_22113_d
end type

type cb_insert from w_com010_d`cb_insert within w_22113_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_22113_d
end type

type cb_update from w_com010_d`cb_update within w_22113_d
end type

type cb_print from w_com010_d`cb_print within w_22113_d
end type

type cb_preview from w_com010_d`cb_preview within w_22113_d
end type

type gb_button from w_com010_d`gb_button within w_22113_d
end type

type cb_excel from w_com010_d`cb_excel within w_22113_d
end type

type dw_head from w_com010_d`dw_head within w_22113_d
string dataobject = "d_22113_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_22113_d
end type

type ln_2 from w_com010_d`ln_2 within w_22113_d
end type

type dw_body from w_com010_d`dw_body within w_22113_d
integer width = 3566
integer height = 1544
string dataobject = "d_22113_d01"
end type
...
type dw_print from w_com010_d`dw_print within w_22113_d
string dataobject = "d_22113_r01"
end type
