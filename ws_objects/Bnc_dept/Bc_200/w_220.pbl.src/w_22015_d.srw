$PBExportHeader$w_22015_d.srw
$PBExportComments$원자재 검단조회
forward
global type w_22015_d from w_com010_e
end type
type dw_1 from datawindow within w_22015_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_22015_d","0")
end event

type cb_close from w_com010_e`cb_close within w_22015_d
end type

type cb_delete from w_com010_e`cb_delete within w_22015_d
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_22015_d
boolean visible = false
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_22015_d
end type

type cb_update from w_com010_e`cb_update within w_22015_d
boolean visible = false
end type

type cb_print from w_com010_e`cb_print within w_22015_d
end type

type cb_preview from w_com010_e`cb_preview within w_22015_d
end type

type gb_button from w_com010_e`gb_button within w_22015_d
end type

type cb_excel from w_com010_e`cb_excel within w_22015_d
end type

type dw_head from w_com010_e`dw_head within w_22015_d
...
type ln_1 from w_com010_e`ln_1 within w_22015_d
end type

type ln_2 from w_com010_e`ln_2 within w_22015_d
end type

type dw_body from w_com010_e`dw_body within w_22015_d
integer y = 832
integer height = 1208
...
type dw_print from w_com010_e`dw_print within w_22015_d
integer x = 699
integer y = 324
