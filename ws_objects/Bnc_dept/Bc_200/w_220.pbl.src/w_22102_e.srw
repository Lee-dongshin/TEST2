$PBExportHeader$w_22102_e.srw
$PBExportComments$부자재 출고 등록
forward
global type w_22102_e from w_com020_e
end type
end forward

global type w_22102_e from w_com020_e
end type
global w_22102_e w_22102_e
		...
		is_brand = dw_head.GetItemString(1, "brand")
		   ...
		   gst_cd.ai_div          = ai_div
			...
			if is_brand = 'O' or is_brand = 'Y' then
				gst_cd.default_where   = " WHERE BRAND = 'O' AND  CUST_CODE  > '3000' and cust_code < '8999'  "
			else
				gst_cd.default_where   = " WHERE BRAND = 'N' AND  CUST_CODE  > '3000' and cust_code < '8999'  "
			end if
...
dw_list.dataobject = "d_22102_l02"
...
dw_list.dataobject = "d_22102_l01"
dw_list.SetTransObject(SQLCA)
...
FOR i=1 TO dw_body.rowcount()
	ll_qty = dec(dw_body.getitemnumber(i,"qty"))
	ll_amt = dec(dw_body.getitemnumber(i,"t_amt"))
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_22102_e","0")
end event

type cb_close from w_com020_e`cb_close within w_22102_e
end type

type cb_delete from w_com020_e`cb_delete within w_22102_e
boolean enabled = true
end type

type cb_insert from w_com020_e`cb_insert within w_22102_e
boolean enabled = true
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_22102_e
end type

type cb_update from w_com020_e`cb_update within w_22102_e
end type

type cb_print from w_com020_e`cb_print within w_22102_e
end type

type cb_preview from w_com020_e`cb_preview within w_22102_e
end type

type gb_button from w_com020_e`gb_button within w_22102_e
end type

type cb_excel from w_com020_e`cb_excel within w_22102_e
end type

type dw_head from w_com020_e`dw_head within w_22102_e
string dataobject = "d_22102_h01"
end type
...
type ln_1 from w_com020_e`ln_1 within w_22102_e
end type

type ln_2 from w_com020_e`ln_2 within w_22102_e
end type

type dw_list from w_com020_e`dw_list within w_22102_e
event body_reset ( )
integer y = 452
integer height = 1548
string dataobject = "d_22102_l02"
end type

event dw_list::body_reset();
choose case is_out_gubn 
	case "01"	
			dw_body.dataobject = "d_22102_d01"
	case "02"   
			dw_body.dataobject = "d_22102_d02"
	case "03"	
			dw_body.dataobject = "d_22102_d03"
	case "04"	
			dw_body.dataobject = "d_22102_d04"
	case "05"	
			dw_body.dataobject = "d_22102_d05"
	case "06"	
			dw_body.dataobject = "d_22102_d06"
end choose 
...
type dw_body from w_com020_e`dw_body within w_22102_e
integer y = 452
integer width = 2766
integer height = 1548
string dataobject = "d_22102_d01"
end type
...
type st_1 from w_com020_e`st_1 within w_22102_e
integer y = 456
integer height = 1584
end type

type dw_print from w_com020_e`dw_print within w_22102_e
integer x = 18
integer y = 184
string dataobject = "d_22102_r01"
end type
