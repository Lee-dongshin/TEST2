$PBExportHeader$beaucre.sra
$PBExportComments$보끄레 MIS 시스템
forward
global type beaucre from application
end type
global u_n_tr sqlca
...
string    gs_home_dir   = "C:\BNC_DEPT"     /* HOME DIR        */
...
global type beaucre from application
string appname = "beaucre"
integer highdpimode = 0
string appruntimeversion = "25.0.0.3726"
end type
global beaucre beaucre
...
ls_file_nm = gs_home_dir + '\bnc.exe'
