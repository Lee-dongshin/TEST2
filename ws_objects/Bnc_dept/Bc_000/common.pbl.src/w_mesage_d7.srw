$PBExportHeader$w_mesage_d7.srw
$PBExportComments$디자인 진행등록
forward
global type w_mesage_d7 from w_com010_d
end type
type dw_rpt from u_dw within w_mesage_d7
end type
end forward
...
global w_mesage_d7 w_mesage_d7
...
type cb_close from w_com010_d`cb_close within w_mesage_d7
boolean visible = false
end type

type cb_delete from w_com010_d`cb_delete within w_mesage_d7
integer x = 3337
integer y = 484
end type

type cb_insert from w_com010_d`cb_insert within w_mesage_d7
integer x = 3072
integer y = 484
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_mesage_d7
boolean visible = false
integer x = 3483
end type

type cb_update from w_com010_d`cb_update within w_mesage_d7
integer x = 3113
integer y = 480
end type

type cb_print from w_com010_d`cb_print within w_mesage_d7
boolean visible = false
integer x = 3072
integer y = 484
end type

type cb_preview from w_com010_d`cb_preview within w_mesage_d7
boolean visible = false
integer x = 3415
integer y = 484
end type

type gb_button from w_com010_d`gb_button within w_mesage_d7
boolean visible = false
integer x = 3611
integer y = 264
integer width = 713
...
type cb_excel from w_com010_d`cb_excel within w_mesage_d7
boolean visible = false
integer x = 3758
integer y = 484
end type

type dw_head from w_com010_d`dw_head within w_mesage_d7
boolean visible = false
integer x = 2981
integer y = 196
integer width = 2811
...
type ln_1 from w_com010_d`ln_1 within w_mesage_d7
boolean visible = false
integer beginx = 2912
integer beginy = 916
integer endx = 6533
...
type ln_2 from w_com010_d`ln_2 within w_mesage_d7
boolean visible = false
integer beginx = 2907
integer beginy = 920
integer endx = 6528
...
type dw_body from w_com010_d`dw_body within w_mesage_d7
...
string dataobject = "d_message_007"
boolean minbox = true
...
type dw_print from w_com010_d`dw_print within w_mesage_d7
integer x = 2958
integer y = 596
end type
