$PBExportHeader$w_com600.srw
$PBExportComments$스타일/색상/size정보창
forward
global type w_com600 from window
end type
type dw_7 from datawindow within w_com600
end type
type rb_size from radiobutton within w_com600
end type
type rb_color from radiobutton within w_com600
end type
type dw_6 from datawindow within w_com600
end type
type dw_5 from datawindow within w_com600
end type
type st_3 from statictext within w_com600
end type
type dw_4 from datawindow within w_com600
end type
type dw_3 from datawindow within w_com600
end type
type st_1 from statictext within w_com600
end type
type st_2 from statictext within w_com600
end type
type dw_2 from datawindow within w_com600
end type
type dw_1 from datawindow within w_com600
end type
end forward
...
global w_com600 w_com600

type variables
string is_style, is_chno = '%', is_size_gbn = '0', is_gubn = 'A'
...
is_style = dw_1.getitemstring(1,"style")
ll_rows = dw_1.retrieve(is_style, is_chno,'%', is_size_gbn, is_gubn)
...
integer taborder = 20
string title = "none"
string dataobject = "d_gubn_ddw"
boolean border = false
boolean livescroll = true
end type

event itemchanged;is_gubn = data
...
integer taborder = 10
string title = "none"
string dataobject = "d_style_color_size_pic"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
//			messagebox('dir = ' , ls_pic_dir)
			dw_1.retrieve(is_style,is_chno,ls_search, is_size_gbn, is_gubn)
	dw_1.setitem(1,"pic_dir", ls_pic_dir)			
	end choose	
end if
