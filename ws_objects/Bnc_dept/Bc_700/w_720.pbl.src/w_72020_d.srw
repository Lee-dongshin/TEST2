$PBExportHeader$w_72020_d.srw
$PBExportComments$회원구매이력조회
forward
global type w_72020_d from w_com000
end type
type dw_head from u_dw within w_72020_d
end type
type ln_1 from line within w_72020_d
end type
type ln_2 from line within w_72020_d
end type
type dw_body from u_dw within w_72020_d
end type
type dw_print from u_dw within w_72020_d
end type
end forward
...
type variables
string is_brand, is_fr_ymd, is_to_ymd, is_shop_cd, is_emp_no, is_flag
...
il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_cd, is_emp_no)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
if is_flag = '1' then 
	dw_body.dataobject = 'd_72020_d01'
	dw_print.dataobject = 'd_72020_r01'
else 
	dw_body.dataobject = 'd_72020_d02'
	dw_print.dataobject = 'd_72020_r02'	
end if
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
string ls_modify, ls_datetime, ls_shop_nm, ls_emp_nm
...
dw_print.object.t_ymd.text = '구매일자: ' + is_fr_ymd + ' - '+is_to_ymd
ls_shop_nm = dw_head.getitemstring(1,"shop_nm")
dw_print.object.t_shop_cd.text = '매장: ' + is_shop_cd + ' ' + ls_shop_nm
dw_print.object.t_emp_no.Text = '담당자: ' + is_emp_no + " " + ls_emp_nm



end event

type cb_close from w_com000`cb_close within w_72020_d
integer taborder = 100
end type

type cb_delete from w_com000`cb_delete within w_72020_d
boolean visible = false
integer x = 1083
integer taborder = 50
end type

type cb_insert from w_com000`cb_insert within w_72020_d
boolean visible = false
integer x = 741
integer taborder = 40
end type

type cb_retrieve from w_com000`cb_retrieve within w_72020_d
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_72020_d
boolean visible = false
integer taborder = 90
end type

type cb_print from w_com000`cb_print within w_72020_d
integer x = 1426
integer taborder = 60
end type

type cb_preview from w_com000`cb_preview within w_72020_d
integer x = 1769
integer taborder = 70
end type

type gb_button from w_com000`gb_button within w_72020_d
integer taborder = 0
end type

type cb_excel from w_com000`cb_excel within w_72020_d
integer x = 2112
end type
...
event doubleclicked;string ls_jumin

if row > 0 then
	ls_jumin = this.getitemstring(row,"jumin")
	
   gsv_cd.gs_cd5 = ls_jumin
	open(w_72020_e)
end if
