$PBExportHeader$w_71018_d.srw
$PBExportComments$마일리지카드용품출고조회
forward
global type w_71018_d from w_com010_d
end type
end forward

global type w_71018_d from w_com010_d
end type
global w_71018_d w_71018_d
...
if is_print_gubn = "N" then 
	dw_body.DataObject = "d_71018_d01"
	dw_body.SetTransObject(SQLCA)
else
   dw_body.DataObject = "d_71018_d03"	
	dw_body.SetTransObject(SQLCA)
end if	
...
if is_print_gubn = "N" then 
	dw_print.DataObject = "d_71018_r01"
	dw_print.SetTransObject(SQLCA)
	dw_body.ShareData(dw_print)
	This.Trigger Event ue_title()
else
   dw_print.DataObject = "d_71018_r03"	
	dw_print.SetTransObject(SQLCA)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_71018_d","0")
end event

type cb_close from w_com010_d`cb_close within w_71018_d
end type

type cb_delete from w_com010_d`cb_delete within w_71018_d
end type

type cb_insert from w_com010_d`cb_insert within w_71018_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_71018_d
end type

type cb_update from w_com010_d`cb_update within w_71018_d
end type

type cb_print from w_com010_d`cb_print within w_71018_d
end type

type cb_preview from w_com010_d`cb_preview within w_71018_d
end type

type gb_button from w_com010_d`gb_button within w_71018_d
end type

type cb_excel from w_com010_d`cb_excel within w_71018_d
end type

type dw_head from w_com010_d`dw_head within w_71018_d
string dataobject = "d_71018_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_71018_d
end type

type ln_2 from w_com010_d`ln_2 within w_71018_d
end type

type dw_body from w_com010_d`dw_body within w_71018_d
integer y = 452
integer height = 1568
string dataobject = "d_71018_d03"
boolean hscrollbar = true
end type

type dw_print from w_com010_d`dw_print within w_71018_d
string dataobject = "d_71018_r01"
end type
