$PBExportHeader$w_74012_d.srw
$PBExportComments$스타일별 구매자 조회
forward
global type w_74012_d from w_com010_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_74012_d","0")
end event

type cb_close from w_com010_d`cb_close within w_74012_d
end type

type cb_delete from w_com010_d`cb_delete within w_74012_d
end type

type cb_insert from w_com010_d`cb_insert within w_74012_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_74012_d
end type

type cb_update from w_com010_d`cb_update within w_74012_d
end type

type cb_print from w_com010_d`cb_print within w_74012_d
boolean visible = false
end type

type cb_preview from w_com010_d`cb_preview within w_74012_d
string text = "Print(&V)"
end type

type gb_button from w_com010_d`gb_button within w_74012_d
end type

type cb_excel from w_com010_d`cb_excel within w_74012_d
end type

type dw_head from w_com010_d`dw_head within w_74012_d
integer height = 312
string dataobject = "d_74012_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_74012_d
integer beginy = 492
integer endy = 492
end type

type ln_2 from w_com010_d`ln_2 within w_74012_d
integer beginx = 5
integer beginy = 488
integer endx = 3625
integer endy = 488
...
type dw_body from w_com010_d`dw_body within w_74012_d
integer y = 524
integer height = 1612
string dataobject = "d_74012_d01"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

type dw_print from w_com010_d`dw_print within w_74012_d
integer x = 169
integer y = 560
integer height = 588
string dataobject = "d_74012_r01"
end type
