$PBExportHeader$w_74003_d.srw
$PBExportComments$일별/매장별 구매조회
forward
global type w_74003_d from w_com010_d
end type
type rb_1 from radiobutton within w_74003_d
end type
type rb_2 from radiobutton within w_74003_d
end type
type gb_1 from groupbox within w_74003_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_74003_d","0")
end event

type cb_close from w_com010_d`cb_close within w_74003_d
end type

type cb_delete from w_com010_d`cb_delete within w_74003_d
end type

type cb_insert from w_com010_d`cb_insert within w_74003_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_74003_d
end type

type cb_update from w_com010_d`cb_update within w_74003_d
end type

type cb_print from w_com010_d`cb_print within w_74003_d
end type

type cb_preview from w_com010_d`cb_preview within w_74003_d
end type

type gb_button from w_com010_d`gb_button within w_74003_d
end type

type cb_excel from w_com010_d`cb_excel within w_74003_d
end type

type dw_head from w_com010_d`dw_head within w_74003_d
integer x = 526
integer y = 180
integer width = 3072
string dataobject = "d_74003_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_74003_d
end type

type ln_2 from w_com010_d`ln_2 within w_74003_d
end type

type dw_body from w_com010_d`dw_body within w_74003_d
string dataobject = "d_74003_d01"
...
type dw_print from w_com010_d`dw_print within w_74003_d
integer x = 1001
integer y = 756
integer width = 1435
integer height = 724
string dataobject = "d_74003_r02"
end type
...
dw_body.dataobject = "d_74003_d01"
dw_body.Settransobject(sqlca)

dw_print.dataobject = "d_74003_r01"
...
dw_body.dataobject = "d_74003_d02"
dw_body.Settransobject(sqlca)

dw_print.dataobject = "d_74003_r02"
dw_print.Settransobject(sqlca)
