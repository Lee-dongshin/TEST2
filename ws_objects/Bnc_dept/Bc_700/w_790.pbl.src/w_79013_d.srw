$PBExportHeader$w_79013_d.srw
$PBExportComments$고객발송일지
forward
global type w_79013_d from w_com010_d
end type
end forward

global type w_79013_d from w_com010_d
end type
global w_79013_d w_79013_d

type variables
DataWindowChild	idw_brand, idw_year, idw_season, idw_sojae, idw_item
String is_brand, is_frm_ymd, is_to_ymd, is_year, is_season 
String is_sojae, is_item, is_judg_fg, is_judg_fg2, is_opt_view
end variables
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_79013_d","0")
end event
...
if is_opt_view = "A" then
	dw_body.dataobject = "d_79013_d01"
	dw_print.dataobject = "d_79013_r01"	
	dw_body.SetTransObject(SQLCA)
   dw_print.SetTransObject(SQLCA)
elseif is_opt_view = "B" then	
	dw_body.dataobject = "d_79013_d02"	
	dw_print.dataobject = "d_79013_r02"		
	dw_body.SetTransObject(SQLCA)
	dw_print.SetTransObject(SQLCA)	
else	
	dw_body.dataobject = "d_79013_d03"	
	dw_print.dataobject = "d_79013_r03"		
 	dw_body.SetTransObject(SQLCA)
	dw_print.SetTransObject(SQLCA)	
end if

il_rows = dw_body.retrieve(is_brand, is_frm_ymd, is_to_ymd, is_year, is_season, is_sojae, is_item, is_judg_fg)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
type cb_close from w_com010_d`cb_close within w_79013_d
end type

type cb_delete from w_com010_d`cb_delete within w_79013_d
end type

type cb_insert from w_com010_d`cb_insert within w_79013_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_79013_d
end type

type cb_update from w_com010_d`cb_update within w_79013_d
end type

type cb_print from w_com010_d`cb_print within w_79013_d
end type

type cb_preview from w_com010_d`cb_preview within w_79013_d
end type

type gb_button from w_com010_d`gb_button within w_79013_d
end type

type cb_excel from w_com010_d`cb_excel within w_79013_d
end type

type dw_head from w_com010_d`dw_head within w_79013_d
integer x = 5
integer y = 176
integer width = 3593
integer height = 216
string dataobject = "d_79013_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_79013_d
integer beginy = 396
integer endy = 396
end type

type ln_2 from w_com010_d`ln_2 within w_79013_d
integer beginy = 400
integer endy = 400
end type

type dw_body from w_com010_d`dw_body within w_79013_d
integer x = 9
integer y = 408
integer height = 1624
string dataobject = "d_79013_d01"
end type

type dw_print from w_com010_d`dw_print within w_79013_d
string dataobject = "d_79013_r01"
end type
