...
type prototypes
// Sound
Function boolean sndPlaySoundA (string SoundName, ulong Flags) Library "libkernel43.sl"
//Function uint waveOutGetNumDevs () Library "WINMM.DLL"

// Get free memory
Subroutine GlobalMemoryStatus (ref os_memorystatus memorystatus ) Library "libkernel43.sl"

// Get module handle
Function ulong GetModuleHandleA(string modname) Library "libkernel43.sl"

// Window functions
Function ulong GetWindowTextA(ulong handle, ref string wintext, ulong length) Library "libuser43.sl"
Function ulong GetWindowsDirectoryA (ref string dirtext, ulong textlen) library "libkernel43.sl"
Function ulong GetSystemDirectoryA (ref string dirtext, ulong textlen) library "libkernel43.sl"
function ulong FindWindowA( ref string lpClassName, ref string lpWindowName) Library "libuser43.sl"


// User/computer information
Function boolean GetUserNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel43.sl"
function boolean GetComputerNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel43.sl"
...
Function ulong ReleaseDC(ulong hWnd, ulong hdcr) Library "libgdi43.sl"
Function boolean GetTextExtentPoint32A(ulong hdcr, string lpString, long nCount, ref os_size size) Library "libgdi43.sl"
Function ulong SelectObject(ulong hdc, ulong hWnd) Library "libgdi43.sl"

// Dialogs
function long PFC_PrintDlg (ulong hwnd, ref s_printdlgattrib printstruct) library "pfccom32.dll"
...
//	   	Modified external library from libuser40.sl to libuser42.sl
//	 		Modified external library from libgdi40.sl to libgdi42.sl
//
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright ?1996-1997 Sybase, Inc. and its subsidiaries.  All rights reserved.
