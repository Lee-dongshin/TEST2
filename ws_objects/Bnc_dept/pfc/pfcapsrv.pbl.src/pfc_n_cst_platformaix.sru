...
type prototypes
// Sound
Function boolean sndPlaySoundA (string SoundName, ulong Flags) Library "libkernel43.so"
...
// Get module handle
Function ulong GetModuleHandleA(string modname) Library "libkernel43.so"

// Window functions
Function ulong GetWindowTextA(ulong handle, ref string wintext, ulong length) Library "libuser43.so"
Function ulong GetWindowsDirectoryA (ref string dirtext, ulong textlen) library "libkernel43.so"
Function ulong GetSystemDirectoryA (ref string dirtext, ulong textlen) library "libkernel43.so"
function ulong FindWindowA( ref string lpClassName, ref string lpWindowName) Library "libuser43.so"


// User/computer information
Function boolean GetUserNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel43.so"
...
Function boolean GetTextExtentPoint32A(ulong hdcr, string lpString, long nCount, ref os_size size) Library "libgdi43.so"
...
//	   	Modified external library from libuser40.a to libuser42.so
//	 		Modified external library from libgdi40.a to libgdi42.so
//
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright ?1996-1997 Sybase, Inc. and its subsidiaries.  All rights reserved.
