$PBExportHeader$w_12024_d.srw
$PBExportComments$출고차순조회
forward
global type w_12024_d from w_com010_d
end type
end forward

global type w_12024_d from w_com010_d
end type
global w_12024_d w_12024_d

type variables
DataWindowChild idw_brand, idw_season, idw_item, idw_out_seq
String is_brand, is_year, is_season, is_item, is_out_seq
...
public function long wf_body_set (long al_rows);return 0
...
il_rows = dw_body.retrieve(is_brand, is_year, is_season, is_item, is_out_seq)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_12024_d","0")
end event
...
event open;call super::open;dw_body.Object.DataWindow.Print.Orientation	 = 1
dw_print.Object.DataWindow.Print.Orientation	 = 1
end event

type cb_close from w_com010_d`cb_close within w_12024_d
end type

type cb_delete from w_com010_d`cb_delete within w_12024_d
end type

type cb_insert from w_com010_d`cb_insert within w_12024_d
boolean enabled = false
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_12024_d
end type

type cb_update from w_com010_d`cb_update within w_12024_d
end type

type cb_print from w_com010_d`cb_print within w_12024_d
end type

type cb_preview from w_com010_d`cb_preview within w_12024_d
end type

type gb_button from w_com010_d`gb_button within w_12024_d
end type

type cb_excel from w_com010_d`cb_excel within w_12024_d
end type

type dw_head from w_com010_d`dw_head within w_12024_d
integer x = 5
integer y = 156
integer width = 3602
integer height = 164
string dataobject = "d_12024_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_12024_d
integer beginy = 320
integer endy = 320
end type

type ln_2 from w_com010_d`ln_2 within w_12024_d
integer beginy = 324
integer endy = 324
end type

type dw_body from w_com010_d`dw_body within w_12024_d
integer x = 14
integer y = 340
integer height = 1676
string dataobject = "d_12024_d01"
...
type dw_print from w_com010_d`dw_print within w_12024_d
integer x = 658
integer y = 596
string dataobject = "d_12024_r01"
end type
