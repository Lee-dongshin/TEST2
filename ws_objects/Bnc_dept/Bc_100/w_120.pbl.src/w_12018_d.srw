...
type dw_2 from datawindow within w_12018_d
end type
end forward
...
string ls_modify, ls_datetime, ls_style, ls_color, ls_file_name
integer jj, ii
long ll_row
...
il_rows = dw_1.retrieve(is_brand,is_year,is_season,is_sojae,is_item,is_chn)
			...
			IF il_rows > 0 THEN
				...
				//	ls_file_name = dw_body.getitemstring(jj,"style_pic")
					ls_style     = dw_1.getitemstring(jj,"style")
				...
				//	if FileExists(ls_file_name) = false then 
						...
						NextStep:
						dw_1.setitem(jj,"style_pic", ls_file_name)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_12018_d","0")
end event
...
string title = "none"
string dataobject = "d_12018_color"
