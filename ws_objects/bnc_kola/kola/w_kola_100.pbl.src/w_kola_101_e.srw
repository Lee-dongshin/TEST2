...
type dw_2 from datawindow within w_kola_101_e
end type
type dw_3 from datawindow within w_kola_101_e
end type
end forward
...
type variables
string is_brand, is_mat_cd, is_color, is_gubn
long ii_seq
...
il_rows = dw_print.retrieve(is_mat_cd,ii_seq )
	...
	CASE "gubn"      // dddw로 작성된 항목
		if data = '1' then 
			if dw_1.dataobject <> 'd_kola_d01' then 
				...
				dw_print.dataobject = 'd_kola_r02'
		...
		elseif data = '2' then 
			if dw_1.dataobject <> 'd_fiti_d01' then 
				...
				dw_print.dataobject = 'd_fiti_r02'
...
//		elseif data = '3' then 
//			if dw_1.dataobject <> 'd_kola_d01c' then 
//				dw_1.dataobject    = 'd_kola_d01c'
//				dw_list.dataobject = 'd_kola_l01c'
//				dw_body.dataobject = 'd_kola_d02c'
//				dw_print.dataobject = 'd_kola_r02c'
//				
//				dw_1.SetTransObject(SQLCA)
//				dw_list.SetTransObject(SQLCA)
//				dw_body.SetTransObject(SQLCA)
...
//			end if
//		elseif data = '4' then 
//			if dw_1.dataobject <> 'd_fiti_d01c' then 
//				dw_1.dataobject    = 'd_fiti_d01c'
//				dw_list.dataobject = 'd_fiti_l01c'
//				dw_body.dataobject = 'd_fiti_d02c'
//				dw_print.dataobject = 'd_fiti_r02c'
//				
//				dw_1.SetTransObject(SQLCA)
//				dw_list.SetTransObject(SQLCA)
//				dw_body.SetTransObject(SQLCA)
...
//elseif is_gubn = '3' then //원자재
//		select max(seq) into :ii_seq 
//		from coiin_china.dbo.tb_kola_m (nolock) where mat_cd = :is_mat_cd;
//		
//		IF IsNull(is_mat_cd) THEN return
//		
//		il_rows = dw_1.retrieve(is_mat_cd, ii_seq)
...
//				select top 1 price 
//					into :li_price
//				from coiin_china.dbo.tb_kola_d (nolock) where price <> 0 order by yymmdd desc;
//		
//				dw_1.setitem(1,"price", li_price)
//			end if
//			
...
//elseif is_gubn = '4' then
//		select max(seq) into :ii_seq 
//		from coiin_china.dbo.tb_fiti_m (nolock) where mat_cd = :is_mat_cd;
//		
//		IF IsNull(is_mat_cd) THEN return
//		
//		il_rows = dw_1.retrieve(is_mat_cd, ii_seq)
...
//				select top 1 price 
//					into :li_price
//				from coiin_china.dbo.tb_fiti_d (nolock) where price <> 0 order by yymmdd desc;
//		
//				dw_1.setitem(1,"price", li_price)
//			end if
//			
...
choose case dwo.name
	case "cb_cust_cd"		
		il_rows = dw_2.retrieve(ls_cust_cd)
		dw_2.visible = true
end choose
