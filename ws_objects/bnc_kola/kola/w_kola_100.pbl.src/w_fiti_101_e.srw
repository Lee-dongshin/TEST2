$PBExportHeader$w_fiti_101_e.srw
$PBExportComments$시험분석등록
forward
global type w_fiti_101_e from w_com020_e
end type
type dw_1 from datawindow within w_fiti_101_e
end type
type dw_2 from datawindow within w_fiti_101_e
end type
end forward
...
integer width = 3694
integer height = 2328
string title = "시험분석등록-FITI"
windowstate windowstate = maximized!
dw_1 dw_1
dw_2 dw_2
end type
global w_fiti_101_e w_fiti_101_e
...
FOR i=1 TO ll_row_count
   ...
   ELSEIF idw_status = DataModified! THEN		/* Modify Record */
      ...
      dw_body.Setitem(i, "mod_dt", ld_datetime)
		dw_body.Setitem(i, "yymmdd", string(ld_datetime,"yyyymmdd"))
	END IF
...
type cb_close from w_com020_e`cb_close within w_fiti_101_e
end type

type cb_delete from w_com020_e`cb_delete within w_fiti_101_e
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_fiti_101_e
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_fiti_101_e
end type

type cb_update from w_com020_e`cb_update within w_fiti_101_e
end type

type cb_print from w_com020_e`cb_print within w_fiti_101_e
boolean visible = false
end type

type cb_preview from w_com020_e`cb_preview within w_fiti_101_e
end type

type gb_button from w_com020_e`gb_button within w_fiti_101_e
end type

type cb_excel from w_com020_e`cb_excel within w_fiti_101_e
boolean visible = false
end type

type dw_head from w_com020_e`dw_head within w_fiti_101_e
integer x = 5
integer y = 148
integer width = 3593
integer height = 188
...
type ln_1 from w_com020_e`ln_1 within w_fiti_101_e
integer beginy = 336
integer endy = 336
end type

type ln_2 from w_com020_e`ln_2 within w_fiti_101_e
integer beginy = 340
integer endy = 340
end type

type dw_list from w_com020_e`dw_list within w_fiti_101_e
integer x = 18
integer y = 668
integer width = 352
integer height = 1416
string dataobject = "d_fiti_l01"
end type
...
il_rows = dw_2.retrieve(is_mat_cd)
if il_rows > 0 then 
	dw_2.visible = true
end if
...
type dw_body from w_com020_e`dw_body within w_fiti_101_e
integer x = 393
integer y = 668
integer width = 3214
integer height = 1420
string dataobject = "d_fiti_d02"
...
idw_make_item.setitem(1,'inter_nm',ls_null)
...
type st_1 from w_com020_e`st_1 within w_fiti_101_e
integer x = 375
integer y = 672
integer width = 32
integer height = 1412
...
type dw_print from w_com020_e`dw_print within w_fiti_101_e
integer x = 82
integer y = 424
string dataobject = "d_fiti_r00"
end type
