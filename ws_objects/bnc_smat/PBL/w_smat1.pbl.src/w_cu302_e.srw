$PBExportHeader$w_cu302_e.srw
$PBExportComments$메시지관리[발신메시지관리]
forward
global type w_cu302_e from w_com020_e
end type
type pb_insert from picturebutton within w_cu302_e
end type
type pb_send from picturebutton within w_cu302_e
end type
type pb_delete from picturebutton within w_cu302_e
end type
type cb_1 from commandbutton within w_cu302_e
end type
type gb_1 from groupbox within w_cu302_e
end type
type dw_recv_list from datawindow within w_cu302_e
end type
end forward
...
type cb_close from w_com020_e`cb_close within w_cu302_e
integer taborder = 160
end type

type cb_delete from w_com020_e`cb_delete within w_cu302_e
...
type cb_insert from w_com020_e`cb_insert within w_cu302_e
boolean visible = false
integer x = 1792
integer y = 48
...
type cb_retrieve from w_com020_e`cb_retrieve within w_cu302_e
integer taborder = 60
end type

type cb_update from w_com020_e`cb_update within w_cu302_e
boolean visible = false
integer taborder = 150
end type

type cb_print from w_com020_e`cb_print within w_cu302_e
boolean visible = false
integer taborder = 120
end type

type cb_preview from w_com020_e`cb_preview within w_cu302_e
boolean visible = false
integer taborder = 130
end type

type gb_button from w_com020_e`gb_button within w_cu302_e
end type

type dw_head from w_com020_e`dw_head within w_cu302_e
integer height = 160
integer taborder = 50
string dataobject = "d_cu302_h01"
end type

event dw_head::constructor;This.GetChild("dept_code", idw_dept_code )
idw_dept_code.SetTransObject(SQLCA)
idw_dept_code.Retrieve(gs_brand)

end event

type ln_1 from w_com020_e`ln_1 within w_cu302_e
integer beginy = 332
integer endx = 2907
integer endy = 332
end type

type ln_2 from w_com020_e`ln_2 within w_cu302_e
integer beginy = 336
integer endx = 2907
integer endy = 336
end type

type dw_list from w_com020_e`dw_list within w_cu302_e
integer y = 344
integer width = 1193
integer height = 1484
integer taborder = 70
string title = "업체"
string dataobject = "d_cu302_d01"
...
type dw_body from w_com020_e`dw_body within w_cu302_e
integer x = 1193
integer y = 348
integer width = 1719
integer height = 1224
...
type st_1 from w_com020_e`st_1 within w_cu302_e
boolean visible = false
integer x = 1157
integer y = 344
integer height = 1500
...
type dw_print from w_com020_e`dw_print within w_cu302_e
end type
