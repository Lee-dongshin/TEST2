...
ELSE
   ...
   This.Title = '보끄레 부자재업체 시스템' + " [ " + gs_brand_nm + " ] " + gs_shop_nm + " [ " + gs_country_nm + " ] "
	dw_menu.of_SetTrans()
   dw_menu.of_outlookbar(1)
   dw_menu.Retrieve("W_SMAT100")
...
lw_window = This
gf_open_sheet(lw_window, 'W_SM100_E', '부자재 발주확인')
