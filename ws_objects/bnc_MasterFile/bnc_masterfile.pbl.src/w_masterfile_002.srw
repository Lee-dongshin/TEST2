$PBExportHeader$w_masterfile_002.srw
$PBExportComments$중국용
forward
global type w_masterfile_002 from window
end type
type dw_print5 from datawindow within w_masterfile_002
end type
type cb_excel from commandbutton within w_masterfile_002
end type
type cbx_chn from checkbox within w_masterfile_002
end type
type cb_3 from commandbutton within w_masterfile_002
end type
type dw_print4 from datawindow within w_masterfile_002
end type
type cbx_1 from checkbox within w_masterfile_002
end type
type dw_print3 from datawindow within w_masterfile_002
end type
type dw_print2 from datawindow within w_masterfile_002
end type
type dw_print1 from datawindow within w_masterfile_002
end type
type cb_update from commandbutton within w_masterfile_002
end type
type st_tag from statictext within w_masterfile_002
end type
type st_care from statictext within w_masterfile_002
end type
type cb_2 from commandbutton within w_masterfile_002
end type
type cb_1 from commandbutton within w_masterfile_002
end type
type tab_1 from tab within w_masterfile_002
end type
...
type dw_head from datawindow within w_masterfile_002
end type
type dw_3 from datawindow within w_masterfile_002
end type
type dw_care from datawindow within w_masterfile_002
end type
type dw_tag from datawindow within w_masterfile_002
end type
type dw_1 from datawindow within w_masterfile_002
end type
type dw_2 from datawindow within w_masterfile_002
end type
type dw_4 from datawindow within w_masterfile_002
end type
end forward
...
global w_masterfile_002 w_masterfile_002
...
if gs_user_id = 'N07876' then // 대화라벨, 중영
...
elseif as_gubn = 'china' then    //////////////////중국어	
	...
	dw_care.dataobject = "d_care_chn_d02"
	dw_care.SetTransObject(SQLCA)		
	...
	dw_tag.dataobject = "d_tag_chn_d02"
	dw_tag.SetTransObject(SQLCA)	
end if
...
if cbx_chn.checked then
	trigger event ue_dataobj_set('china')
else
	trigger event ue_dataobj_set('korea')
end if
...
//	il_rows = dw_care.retrieve(is_brand, is_year, 'Y', is_season)
//	il_rows = dw_tag.retrieve (is_brand, is_year, 'Y')	
//else
//	il_rows = dw_care.retrieve(is_brand, is_year, 'N', is_season)
