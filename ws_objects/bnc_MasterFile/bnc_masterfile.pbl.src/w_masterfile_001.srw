$PBExportHeader$w_masterfile_001.srw
forward
global type w_masterfile_001 from window
end type
type cb_print from commandbutton within w_masterfile_001
end type
type rb_3 from radiobutton within w_masterfile_001
end type
type rb_2 from radiobutton within w_masterfile_001
end type
type rb_1 from radiobutton within w_masterfile_001
end type
type dw_print5 from datawindow within w_masterfile_001
end type
type cb_excel from commandbutton within w_masterfile_001
end type
type cb_3 from commandbutton within w_masterfile_001
end type
type dw_print4 from datawindow within w_masterfile_001
end type
type cbx_1 from checkbox within w_masterfile_001
end type
type dw_print3 from datawindow within w_masterfile_001
end type
type dw_print2 from datawindow within w_masterfile_001
end type
type dw_print1 from datawindow within w_masterfile_001
end type
type cb_update from commandbutton within w_masterfile_001
end type
type st_tag from statictext within w_masterfile_001
end type
type st_care from statictext within w_masterfile_001
end type
type cb_2 from commandbutton within w_masterfile_001
end type
type cb_1 from commandbutton within w_masterfile_001
end type
type tab_1 from tab within w_masterfile_001
end type
...
type dw_head from datawindow within w_masterfile_001
end type
type dw_3 from datawindow within w_masterfile_001
end type
type dw_care from datawindow within w_masterfile_001
end type
type dw_tag from datawindow within w_masterfile_001
end type
type dw_4 from datawindow within w_masterfile_001
end type
type dw_2 from datawindow within w_masterfile_001
end type
type dw_1 from datawindow within w_masterfile_001
end type
end forward
...
global w_masterfile_001 w_masterfile_001
...
if gs_saup_gubn = "E" then
	dw_head.DataObject = "d_masterfile_eternal_h01"	
else 	
	dw_head.DataObject = "d_masterfile_h01"		
end if
...
if RightA(gs_user_id,4)='7876' then // 대화라벨, 중영
	cb_update.visible = true
	dw_1.enabled = true
	dw_2.enabled = true
	dw_4.enabled = true
	cb_3.visible = true
elseif RightA(gs_user_id,4)='603A' then // 대화라벨, 중영
	cb_update.visible = true
	dw_1.enabled = true
	dw_2.enabled = true
	dw_4.enabled = true
...
if RightA(gs_user_id,4)='603A' then
...
event resize;dw_head.width = this.width - 100
dw_care.width = this.width - 100
dw_tag.width  = this.width - 100
dw_3.width  = this.width - 100
dw_4.width  = this.width - 100
tab_1.width  = this.width - 100

dw_care.height = this.height - 450
dw_tag.height  = this.height - 450
dw_1.height  = this.height - 450
dw_2.height  = this.height - 450
dw_3.height  = this.height - 450
dw_4.height  = this.height - 450
...
boolean titlebar = true
string title = "none"
string dataobject = "d_masterfile_r04"
boolean controlmenu = true
boolean minbox = true
boolean maxbox = true
...
string title = "none"
string dataobject = "d_masterfile_d04"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
integer taborder = 90
string title = "none"
string dataobject = "d_masterfile_r03"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
integer taborder = 80
string title = "none"
string dataobject = "d_masterfile_r02"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
integer taborder = 70
string title = "none"
string dataobject = "d_masterfile_r01"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
string ls_yymmdd, ls_gubn, ls_style, ls_chno, ls_color, ls_size, label_agree, ls_gubn2,ls_care_tag6
string ls_care_tag1, ls_care_tag2, ls_care_tag3 ,  ls_care_tag4, ls_care_tag5 ,ls_care_tag_t,ls_cust_cd
...
FOR i=1 TO dw_1.rowcount()
   idw_status = dw_1.GetItemStatus(i, 0, Primary!)
	ls_gubn   = dw_1.getitemstring(i,"label_agree")
	
	if ls_gubn = '' or ls_gubn = "N" then 
...
FOR i=1 TO dw_2.rowcount()
   idw_status = dw_2.GetItemStatus(i, 0, Primary!)
		...
		ls_gubn   = dw_2.getitemstring(i,"tag_agree")
	
	if ls_gubn = '' or ls_gubn = "N" then 
		dw_2.SetItemStatus(i, 0, Primary!, NotModified!)
	end if	
...
if il_rows = 1 then				
	...
	for i=1 to dw_2.rowcount()
	   ...
	   ls_style      = dw_2.getitemstring(i,"style")
		...
		ls_care_tag1  = dw_2.getitemstring(i,"care_tag1")			
		ls_care_tag2  = dw_2.getitemstring(i,"care_tag2")		
		ls_care_tag3  = dw_2.getitemstring(i,"care_tag3")		
		ls_care_tag4  = dw_2.getitemstring(i,"care_tag4")		
		ls_care_tag5  = dw_2.getitemstring(i,"care_tag5")				
		ls_care_tag6  = dw_2.getitemstring(i,"care_tag6")						
		ls_care_tag_t = ls_care_tag1 + ls_care_tag2 + ls_care_tag3 + ls_care_tag4 + ls_care_tag5 + ls_care_tag6
		
		
		if (ls_gubn = '1' or ls_gubn = '2' or ls_gubn = '7' or ls_gubn = 'M' or ls_gubn = 'N' or ls_gubn = 'O' or ls_gubn = 'P' or ls_gubn = 'Q' ) and label_agree = 'Y' then	
			...
			update tb_12029_c set 
				...
				mod_dt = getdate()
			where yymmdd = :ls_yymmdd
			and   gubn  in ('1','2','7','D','E','F','N','O','M','P','Q')
			and   style = :ls_style
			and   chno  = :ls_chno
			and   color = :ls_color
			and   size  = :ls_size;		
...
//messagebox("ls_care_tag_t", ls_care_tag_t)
//messagebox("label_agree", label_agree)
	
		if ls_care_tag_t <> "000000" and label_agree = 'Y' then	
							
				 DECLARE sp_make_12029_tl PROCEDURE FOR sp_make_12029_tl  
						@style       = :ls_style,   
						@chno        = :ls_chno,   
						@color       = :ls_color,   
						@tag_agree   = :label_agree,   
						@tl_gbn      = '6',   
						@mod_id   	 = :ls_cust_cd,   
						@mod_dt 		 = :ls_yymmdd,   
						@gubn		    = '1',
...
/* 수정일      : 2002.06.18                                                  */
/*===========================================================================*/
		datawindowchild ldw_color, ldw_bigo, ldw_tl_gbn
long i
...
choose case tab_1.SelectedTab
	case 1	
		if cbx_1.checked then 
			il_rows = dw_care.retrieve(is_brand, is_year, 'N', is_season, is_style)
		else
			il_rows = dw_care.retrieve(is_brand, is_year, 'N', is_season, is_style)
		end if
	...
	case 2
		if cbx_1.checked then 
			il_rows = dw_tag.retrieve (is_brand, is_year, 'N', is_season, is_style)	
		else
			il_rows = dw_tag.retrieve (is_brand, is_year, 'N', is_season, is_style)
		end if	
	case 3
	...
	case 5
		...
		is_brand  = dw_head.getitemstring(1,"brand")
		dw_4.GetChild("tl_gbn", ldw_tl_gbn )
		ldw_tl_gbn.SetTransObject(SQLCA)
		ldw_tl_gbn.Retrieve(is_brand)
...
event itemchanged;datawindowchild ldw_tl_gbn
...
integer taborder = 60
string title = "none"
string dataobject = "d_masterfile_d03"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
...
event constructor;datawindowchild ldw_color, ldw_bigo, ldw_tl_gbn
string ls_brand
...
This.GetChild("tl_gbn", ldw_tl_gbn )
ldw_tl_gbn.SetTransObject(SQLCA)
ldw_tl_gbn.Retrieve(is_brand)
...
boolean titlebar = true
string title = "미발행 택"
string dataobject = "d_masterfile_d02"
boolean maxbox = true
boolean hscrollbar = true
boolean vscrollbar = true
boolean resizable = true
...
string dataobject = "d_masterfile_d01"
boolean maxbox = true
boolean hscrollbar = true
boolean vscrollbar = true
boolean resizable = true
