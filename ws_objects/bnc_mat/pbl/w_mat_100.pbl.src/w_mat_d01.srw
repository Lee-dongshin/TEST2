$PBExportHeader$w_mat_d01.srw
$PBExportComments$시험분석조회
forward
global type w_mat_d01 from w_com020_e
end type
type dw_1 from datawindow within w_mat_d01
end type
end forward
...
is_brand = '%'
il_rows = dw_list.retrieve(gs_user_id, is_brand, is_mat_cd)
dw_body.Reset()
IF il_rows > 0 THEN
   dw_list.SetFocus()
END IF
...
type cb_close from w_com020_e`cb_close within w_mat_d01
boolean visible = false
end type

type cb_delete from w_com020_e`cb_delete within w_mat_d01
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_mat_d01
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_mat_d01
end type

type cb_update from w_com020_e`cb_update within w_mat_d01
boolean visible = false
end type

type cb_print from w_com020_e`cb_print within w_mat_d01
boolean visible = false
end type

type cb_preview from w_com020_e`cb_preview within w_mat_d01
end type

type gb_button from w_com020_e`gb_button within w_mat_d01
end type

type cb_excel from w_com020_e`cb_excel within w_mat_d01
boolean visible = false
end type

type dw_head from w_com020_e`dw_head within w_mat_d01
integer x = 5
integer y = 156
integer width = 3593
integer height = 104
string dataobject = "d_mat_h01"
end type
...
type ln_1 from w_com020_e`ln_1 within w_mat_d01
integer beginy = 260
integer endy = 260
end type

type ln_2 from w_com020_e`ln_2 within w_mat_d01
integer beginy = 264
integer endy = 264
end type

type dw_list from w_com020_e`dw_list within w_mat_d01
integer x = 18
integer y = 576
integer width = 352
integer height = 1508
string dataobject = "d_mat_l01"
end type
...
type dw_body from w_com020_e`dw_body within w_mat_d01
integer x = 393
integer y = 576
integer width = 3214
integer height = 1508
string dataobject = "d_kola_r02"
...
type st_1 from w_com020_e`st_1 within w_mat_d01
integer x = 375
integer y = 576
integer width = 32
integer height = 1508
...
type dw_print from w_com020_e`dw_print within w_mat_d01
integer x = 82
integer y = 424
string dataobject = "d_mat_r00"
end type
