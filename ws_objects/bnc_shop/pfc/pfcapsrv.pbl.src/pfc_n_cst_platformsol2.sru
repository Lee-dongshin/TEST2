...
type prototypes
// Sound
Function boolean sndPlaySoundA (string SoundName, uint Flags) Library "libkernel43.so"
//Function uint waveOutGetNumDevs () Library "WINMM.DLL"

// Get free memory
Subroutine GlobalMemoryStatus (ref os_memorystatus memorystatus ) Library "libkernel43.so"

// Get module handle
Function long GetModuleHandleA(string modname) Library "libkernel43.so"

// Window functions
Function int GetWindowTextA(long handle, ref string wintext, int length) Library "libuser43.so"
Function uint GetWindowsDirectoryA (ref string dirtext, uint textlen) library "libkernel43.so"
Function uint GetSystemDirectoryA (ref string dirtext, uint textlen) library "libkernel43.so"
function uint FindWindowA( ref string lpClassName, ref string lpWindowName) Library "libuser43.so"


// User/computer information
Function boolean GetUserNameA(ref string  lpBuffer, ref int nSize) library "libkernel43.so"
function boolean GetComputerNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel43.so"

// Get text size
Function boolean SystemParametersInfoA(uint wActon, uint wParam, REF int pvParam, uint fUpdateProfile) Library "libuser43.so"
Function uint GetDC(uint hWnd) Library "libgdi43.so"
Function uint ReleaseDC(uint hWnd, uint hdcr) Library "libgdi43.so"
Function boolean GetTextExtentPoint32A(uint hdcr, string lpString, integer nCount, ref os_size size) Library "libgdi43.so"
Function uint SelectObject(uint hdc, uint hWnd) Library "libgdi43.so"
...
//	   	Modified external library from libuser40.so to libuser42.so
//	 		Modified external library from libgdi40.so to libgdi42.so
//
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright ?1996-1997 Sybase, Inc. and its subsidiaries.  All rights reserved.
