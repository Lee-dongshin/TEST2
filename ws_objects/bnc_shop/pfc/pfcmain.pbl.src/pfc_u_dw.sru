...
if (sqltype = PreviewSelect!) or &
	(sqltype = PreviewInsert! And PosA(is_UpdatesAllowed,"I")>0) or &
	(sqltype = PreviewUpdate! And PosA(is_UpdatesAllowed,"U")>0) or &
	(sqltype = PreviewDelete! And PosA(is_UpdatesAllowed,"D")>0) then
