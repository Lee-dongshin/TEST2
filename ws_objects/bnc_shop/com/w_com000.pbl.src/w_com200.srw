...
String  ls_column_nm, ls_item_where, ls_data,ls_column_nm1 
Long    ll_rows
...
ls_column_nm1 = dw_body.Describe('#' + String(3) + '.Name')
...
if ls_column_nm1 = "jumin" then
   ls_item_where = "where jumin = 'XXXXXXXXXXX' "
end if	
...
String ls_datawindow, ls_column_nm 
...
ls_column_nm = dw_body.Describe('#' + String(3) + '.Name')
