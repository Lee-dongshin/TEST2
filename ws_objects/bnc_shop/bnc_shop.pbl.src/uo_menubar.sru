...
CHOOSE CASE dwo.name 
	CASE "pgm_nm" 
  	   ...
  	   ls_win_id = This.GetitemString(row, "pgm_id")
					...
					if ls_yymmdd >= "20211122" and (MidA(gs_shop_cd,1,1) = "N" or  MidA(gs_shop_cd,1,1) = "J")  and ls_win_id <> "W_SH112_D" then
		...
		IF gl_user_level = 999 OR ls_pgm_stat = 'B' THEN
		   ls_win_id = This.GetitemString(row, "pgm_id")
				...
				//						ls_win_id = "W_SH141_E" // 본사 1층 매장만 적용
									ELSEif MidA(gs_shop_cd_1,1,1) = 'J' then
				...
				//						ls_win_id = "W_SH142_E" // 본사 1층 매장만 적용
							...
							elseif ls_win_id = "W_SH101_E" AND MidA(gs_shop_cd,1,2) = 'NI' then
									ls_win_id = "W_SH133_E" 
							elseif ls_win_id = "W_SH101_E" AND MidA(gs_shop_cd,1,1) = 'J' then
									ls_win_id = "W_SH145_E" 
									ls_win_nm = "상설판매일보등록"					
							elseif ls_win_id = "W_SH133_E" AND MidA(gs_shop_cd,1,1) = 'J' then
									ls_win_id = "W_SH145_E" 
									ls_win_nm = "상설판매일보등록"																		
