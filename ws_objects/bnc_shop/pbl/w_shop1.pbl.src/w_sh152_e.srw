$PBExportHeader$w_sh152_e.srw
$PBExportComments$매장(주문) 미등록 판매내역
forward
global type w_sh152_e from w_com010_e
end type
type st_1 from statictext within w_sh152_e
end type
type st_2 from statictext within w_sh152_e
end type
type dw_1 from datawindow within w_sh152_e
end type
type st_3 from statictext within w_sh152_e
end type
end forward
...
inv_resize.of_Register(dw_1, "ScaleToBottom&FixedToRight")
...
dw_1.retrieve(LeftA(is_yymmdd,6), gs_shop_cd)

il_rows = dw_body.retrieve(is_yymmdd, gs_shop_cd)

IF il_rows >= 0 then //and ls_yymmdd = is_yymmdd THEN
	dw_body.insertRow(0)
	dw_body.SetRow(il_rows + 1)
   dw_body.SetFocus()
//ELSEIF il_rows = 0 then //and ls_yymmdd = is_yymmdd THEN
//	dw_body.insertRow(0)
//	dw_body.SetRow(1)
 //  dw_body.SetFocus()
else
...
type cb_close from w_com010_e`cb_close within w_sh152_e
end type

type cb_delete from w_com010_e`cb_delete within w_sh152_e
end type

type cb_insert from w_com010_e`cb_insert within w_sh152_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_sh152_e
end type

type cb_update from w_com010_e`cb_update within w_sh152_e
end type

type cb_print from w_com010_e`cb_print within w_sh152_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_sh152_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_sh152_e
end type

type dw_head from w_com010_e`dw_head within w_sh152_e
integer width = 2802
integer height = 160
string dataobject = "d_sh152_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_sh152_e
integer beginy = 344
integer endy = 344
end type

type ln_2 from w_com010_e`ln_2 within w_sh152_e
integer beginy = 348
integer endy = 348
end type

type dw_body from w_com010_e`dw_body within w_sh152_e
event ue_set_column ( long al_row )
integer y = 364
integer width = 2848
integer height = 1420
string dataobject = "d_sh152_d01"
end type
...
type dw_print from w_com010_e`dw_print within w_sh152_e
end type
...
string text = "본사에서 매장별 미판등된 내역을 참조하기 위한 등록 화면입니다."
...
long textcolor = 128
long backcolor = 67108864
string text = "※ 특정거래로 선주문 내역 및 온라인 미판등 내역만 등록 바랍니다."
boolean focusrectangle = false
end type
...
string title = "월간 등록 내역"
string dataobject = "d_sh152_d02"
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type

event doubleclicked;String ls_yymmdd
