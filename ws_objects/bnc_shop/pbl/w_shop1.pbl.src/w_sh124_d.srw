...
il_rows = dw_body.retrieve(gs_brand, is_frm_ymd, is_to_ymd, gs_shop_cd, is_shop_type, is_year, is_season , is_style, is_chno, is_color, is_size)
IF il_rows > 0 THEN
   dw_body.SetFocus()
END IF
...
event type integer ue_popup(string as_column, long al_row, string as_data, integer ai_div);call super::ue_popup;String     ls_style_no
Boolean    lb_check 
