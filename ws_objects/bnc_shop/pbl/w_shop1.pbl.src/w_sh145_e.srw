$PBExportHeader$w_sh145_e.srw
$PBExportComments$상설판매일보등록
forward
global type w_sh145_e from w_com010_e
end type
type cb_1 from commandbutton within w_sh145_e
end type
type dw_2 from datawindow within w_sh145_e
end type
type st_2 from statictext within w_sh145_e
end type
type tab_1 from tab within w_sh145_e
end type
...
type st_3 from statictext within w_sh145_e
end type
type dw_3 from datawindow within w_sh145_e
end type
type dw_5 from datawindow within w_sh145_e
end type
type dw_4 from datawindow within w_sh145_e
end type
type st_4 from statictext within w_sh145_e
end type
type st_5 from statictext within w_sh145_e
end type
type dw_6 from datawindow within w_sh145_e
end type
type dw_7 from datawindow within w_sh145_e
end type
type dw_8 from datawindow within w_sh145_e
end type
type dw_9 from datawindow within w_sh145_e
end type
type dw_10 from datawindow within w_sh145_e
end type
type dw_11 from datawindow within w_sh145_e
end type
type dw_12 from datawindow within w_sh145_e
end type
type dw_13 from datawindow within w_sh145_e
end type
type cb_2 from commandbutton within w_sh145_e
end type
type dw_back_sale from datawindow within w_sh145_e
end type
type dw_member_sale from datawindow within w_sh145_e
end type
type st_6 from statictext within w_sh145_e
end type
type dw_14 from datawindow within w_sh145_e
end type
type dw_15 from datawindow within w_sh145_e
end type
type st_ok_coupon1 from statictext within w_sh145_e
end type
type st_ok_coupon2 from statictext within w_sh145_e
end type
type dw_16 from datawindow within w_sh145_e
end type
type dw_17 from datawindow within w_sh145_e
end type
type dw_18 from datawindow within w_sh145_e
end type
type dw_19 from datawindow within w_sh145_e
end type
type dw_cosmetic from datawindow within w_sh145_e
end type
type em_1 from editmask within w_sh145_e
end type
type st_7 from statictext within w_sh145_e
end type
type dw_20 from datawindow within w_sh145_e
end type
type dw_21 from datawindow within w_sh145_e
end type
type cb_3 from commandbutton within w_sh145_e
end type
type st_online_gubn from statictext within w_sh145_e
end type
type rb_1 from radiobutton within w_sh145_e
end type
type rb_2 from radiobutton within w_sh145_e
end type
type st_online_id from statictext within w_sh145_e
end type
type sle_id from singlelineedit within w_sh145_e
end type
type cb_online_coupon from commandbutton within w_sh145_e
end type
type shl_member from statichyperlink within w_sh145_e
end type
type st_1 from statictext within w_sh145_e
end type
type dw_1 from datawindow within w_sh145_e
end type
type dw_list from datawindow within w_sh145_e
end type
type st_8 from statictext within w_sh145_e
end type
type dw_22 from datawindow within w_sh145_e
end type
end forward
...
string is_set_style_chk ,is_coupon
end variables
...
IF LeftA(GS_SHOP_CD,1) <> "J" THEN
	...
	if (MidA(ls_style_no,1,1) <> 'L') and is_coupon_gubn <> '03'  then
		if (ld_tag_price = ld_sale_price and MidA(ls_sale_type,1,1) = '1') or (MidA(ls_sale_type,1,1) = '1' and  ld_dc_rate <= 20 )   then
			...
			if ld_dc_rate < 20 and is_coupon_gubn <> '03' and MidA(ls_style_no,1,1) <> 'N' then
				ld_dc_rate = ld_dc_rate + 5	
			elseif ld_dc_rate < 10 and is_coupon_gubn <> '03' and MidA(ls_style_no,1,1) = 'N' then
				ld_dc_rate = ld_dc_rate + 5					
			else
...
public subroutine wf_goods_chk3 ();
decimal ll_tot_real_amt, ll_sale_amt, ll_chk_sale_amt, ll_T_sale_amt
long i, ll_row_count
...
ll_row_count = dw_body.RowCount()
	...
	//	ll_T_sale_amt = ll_T_sale_amt + ll_sale_amt
		
		
		IF ll_sale_amt = 0 OR IsNull(ll_sale_amt) THEN
			ll_T_sale_amt = ll_T_sale_amt
		ELSE 	
			ll_T_sale_amt = ll_T_sale_amt + ll_sale_amt
		END IF	
	...
	for i=1 to ll_row_count
		...
		if gs_brand = 'J' then
			...
			if ll_T_sale_amt >= 300000 AND ll_T_sale_amt <= 599999 then
				
				IF ll_sale_amt > 10000 THEN
					dw_body.Setitem(i, "coupon_no", "J20011")  
					dw_body.Setitem(i, "goods_amt", 10000)			
					return
				END IF
										
			elseif ll_T_sale_amt >= 600000 AND ll_T_sale_amt <= 899999 then
				IF ll_sale_amt > 20000 THEN
					dw_body.Setitem(i, "coupon_no", "J20011")  
					dw_body.Setitem(i, "goods_amt", 20000)			
					return
				END IF
				
										
			elseif ll_T_sale_amt >= 900000 AND ll_T_sale_amt <= 1199999 then
				IF ll_sale_amt > 30000 THEN
					dw_body.Setitem(i, "coupon_no", "J20011")  
					dw_body.Setitem(i, "goods_amt", 30000)			
					return
				END IF
				
			elseif ll_T_sale_amt >= 1200000 then
				IF ll_sale_amt > 40000 THEN
					dw_body.Setitem(i, "coupon_no", "J20011")  
					dw_body.Setitem(i, "goods_amt", 40000)			
					return
				END IF
...
if LeftA(gs_shop_cd,1) <> "J" THEN
	...
	if (MidA(ls_style_no,1,1) <> 'L') and is_coupon_gubn <> '03'  then
		...
		if (gs_shop_cd<>'ND1900' and gs_shop_cd<>'OD1900' and gs_shop_cd<>'ID1900')   then
			if (MidA(ls_sale_type,1,1) = '1' and  ld_dc_rate <= 10 )  and LeftA(gs_shop_cd,1)  <> "N"  then
			...
			elseif  (MidA(ls_sale_type,1,1) = '1' and  ld_dc_rate < 10 ) and LeftA(gs_shop_cd,1) = "N"  then
	...
	elseif gs_shop_cd = 'OD0002' then
		...
		where exists (	select * 
				...
				where b.shoP_div in ('B','G','o')
				  and b.brand = a.brand	
 			     and (b.cust_cd = a.cust_cd OR B.SHOP_SEQ = A.SHOP_SEQ)
				  and b.shop_cd = :gs_shop_cd
				)
		and shop_div = 'H'
		and shop_stat = '00'	;
...
if gs_shop_cd <> "JX3300" then
	if MidA(gs_shop_cd,2,1) = "D" then 
		IF ll_chk_qty < 0 and MidA(ls_style,5,1) <> "I" THEN 
...
if LeftA(as_style_no,1) = "N"  and (LeftA(gs_shop_cd, 2) <> "NO" or LeftA(gs_shop_cd, 2) <> "JO" )  then
...
IF ls_date >= '20240710' and ls_date <= '20250116' THEN 
	...
	if ls_year + ls_season = '2023S' or ls_year + ls_season = '2023M'  then
			messagebox("확인","시즌마감되어 등록이 불가능합니다! 관리팀에 연락 바랍니다!")
			Return False 
		end if


		if ls_brand + ls_year + ls_season = 'J2024S' or  ls_brand + ls_year + ls_season = 'J2024M'  then
			messagebox("확인","시즌마감되어 등록이 불가능합니다! 관리팀에 연락 바랍니다!")
			Return False 
		end if
...
//JO0013	롯데아울렛청주
		...
		if ls_year = '2023'  and ls_brand = 'E' then
			if gs_shop_cd = "JO0005" or 	gs_shop_cd = "JO0013" then
				ls_style = ls_style
			else
				messagebox("확인","시즌마감되어 등록이 불가능합니다! 관리팀에 연락 바랍니다!")
				Return False 
...
IF SQLCA.SQLCODE <> 0 THEN 
	messagebox("확인","시즌마감 또는 없는 품번이어 반품등록이 불가능합니다! 관리팀에 연락 바랍니다!")
	Return False 
END IF
...
if LeftA(as_style_no,1) = "N"  and LeftA(gs_shop_cd, 1) <> "J"  then
...
Long   ll_tag_price, ll_ord_qty, ll_ord_qty_chn , ll_cnt,ll_OUT_qty
...
elseif gs_brand = "B" or gs_brand = 'G' or gs_brand = 'V' or gs_brand = 'U' or gs_brand = 'D' then 
	Select brand,     year,     season,     
			 sojae,     item,     tag_price,     plan_yn   
	  into :ls_brand, :ls_year, :ls_season, 
			 :ls_sojae, :ls_item, :ll_tag_price, :ls_plan_yn    
...
elseif gs_brand = "J" or gs_brand = "Y"  then
	if ls_date <= is_close_ymd_t then
		//마감일자 전의 판매
		//정상+행사
...
select SUM(ISNULL(OUT_QTY,0))
into :ll_OUT_qty
FROM TB_44012_S (NOLOCK)
WHERE style = :ls_style 
and 	chno  = :ls_chno
and 	color = :ls_color 
and 	size  = :ls_size
...
IF (IsNull(ll_OUT_qty) or ll_OUT_qty <= 0) and gs_shop_cd <> 'JX3300'  THEN 
	MessageBox("알림!", AS_STYLE_NO +  "는 출고 이력이 없어 판매가 불가 한 품번 입니다!") 
//	RETURN FALSE 
END IF
...
if MidA(gs_shop_cd,1,2) = "NG" and is_yymmdd >= "20180901"  and ls_dotcom = '0' then 
	Select shop_type
	into :ls_shop_type
...
elseif MidA(gs_shop_cd,1,2) = "NG" and ls_dotcom = '1' then 
...
if IsNull(ls_shop_type) or Trim(ls_shop_type) = "" then		//최종 가격 미확인분 정상으로 처리
	...
	IF ls_plan_yn = 'Y' THEN 
		...
		if gs_brand = 'J' or gs_brand = 'Y' then
			ls_shop_type = '1'
		else	
			ls_shop_type = '4'
		end if 	
...
this.Control[iCurrent+16]=this.dw_11
this.Control[iCurrent+17]=this.dw_12
this.Control[iCurrent+18]=this.dw_13
this.Control[iCurrent+19]=this.cb_2
this.Control[iCurrent+20]=this.dw_back_sale
this.Control[iCurrent+21]=this.dw_member_sale
this.Control[iCurrent+22]=this.st_6
this.Control[iCurrent+23]=this.dw_14
this.Control[iCurrent+24]=this.dw_15
this.Control[iCurrent+25]=this.st_ok_coupon1
this.Control[iCurrent+26]=this.st_ok_coupon2
this.Control[iCurrent+27]=this.dw_16
this.Control[iCurrent+28]=this.dw_17
this.Control[iCurrent+29]=this.dw_18
this.Control[iCurrent+30]=this.dw_19
this.Control[iCurrent+31]=this.dw_cosmetic
this.Control[iCurrent+32]=this.em_1
this.Control[iCurrent+33]=this.st_7
this.Control[iCurrent+34]=this.dw_20
this.Control[iCurrent+35]=this.dw_21
this.Control[iCurrent+36]=this.cb_3
this.Control[iCurrent+37]=this.st_online_gubn
this.Control[iCurrent+38]=this.rb_1
this.Control[iCurrent+39]=this.rb_2
this.Control[iCurrent+40]=this.st_online_id
this.Control[iCurrent+41]=this.sle_id
this.Control[iCurrent+42]=this.cb_online_coupon
this.Control[iCurrent+43]=this.shl_member
this.Control[iCurrent+44]=this.st_1
this.Control[iCurrent+45]=this.dw_1
this.Control[iCurrent+46]=this.dw_list
this.Control[iCurrent+47]=this.st_8
this.Control[iCurrent+48]=this.dw_22
end on

on w_sh145_e.destroy
call super::destroy
...
if gs_shop_cd = 'GB1807' or gs_shop_cd = 'TB1004' or MidA(gs_shop_cd,2,5) = 'X2710' then
...
Long       ll_row_cnt , ll_ord_qty, ll_ord_qty_chn, li_shop_cnt, ll_OUT_qty
Boolean    lb_check 
string ls_shop_snm, ls_ok, ls_date, ls_dotcom, ls_shop_cd, ls_shop_div, ls_year, ls_season,ls_brand, LS_PLAN_YN, ls_close_chk
DataStore  lds_Source 
...
//					gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and  year + convert(char(01),dbo.sf_inter_sort_seq('003',season))  >=  '20091'  " 				 			
					...
					if gs_brand = "J"  or gs_brand = "Y"  then
						if ls_date <= is_close_ymd_t then
							//마감일자 전의 판매 // WHERE  '" + gs_brand_grp + "' like '%' + brand + '%' 
							//정상+행사
							if is_s_gubn_f = 'Y' and is_e_gubn_f = 'Y' and is_p_gubn_f = 'Y' then
								gst_cd.default_where   =  "WHERE  '" + gs_brand_grp + "' like '%' + brand + '%'  and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '"+is_year_f+is_season_s_f+"' ) )" + &
												" or style in (select a.style from tb_56012_d a (nolock)	where a.sale_type >= '33' " + &
							...
							//정상+행사
							if is_s_gubn_t = 'Y' and is_e_gubn_t = 'Y' and is_p_gubn_t = 'Y' then
								gst_cd.default_where   =  "WHERE  '" + gs_brand_grp + "' like '%' + brand + '%'  and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '"+is_year_t+is_season_s_t+"' ))" + & 
												" or style in (select a.style from tb_56012_d a (nolock)	where  a.sale_type >= '33' " + &
												" and a.shop_cd = '" + gs_shop_cd + "' and '" + is_yymmdd + "' between a.start_ymd and a.end_ymd " + &
												" and  a.year + a.season in (select year + season from tb_51036_d a (nolock), tb_51035_h b (nolock) where '" + is_yymmdd + "' between a.frm_ymd and a.to_ymd " + &
												" and a.shop_cd = '" + gs_shop_cd + "' and a.shop_cd = b.shop_cd and a.frm_ymd = b.frm_ymd and b.cancel <> 'Y') )) and sojae <> 'C' and isnull(for_lotte,'N') <> 'Y' "
						...
						gst_cd.default_where   = "WHERE  '" + gs_brand_grp + "' like '%' + brand + '%'  and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20241' ) )" + &
			...
			IF Isvalid(Message.PowerObjectParm) THEN
				...
				LS_PLAN_YN = lds_Source.GetItemString(1,"plan_yn")
...
//					if ls_year = '2023'  and mid(ls_style,1,1) = 'E' then
//							messagebox("확인","시즌마감되어 등록이 불가능합니다! 관리팀에 연락 바랍니다!")
//							dw_body.SetItem(al_row, "style_no", "")						
//							ib_itemchanged = FALSE
//							return 1 	
...
//JO0013	롯데아울렛청주
			...
			if ls_close_chk = "C" then
				...
				IF (IsNull(ll_OUT_qty) or  ll_OUT_qty <= 0) and gs_shop_cd <> 'JX3300' THEN 
					MessageBox("알림!",  "출고이력이 없어 판매가 불가한 품번 입니다!") 
//					dw_body.SetItem(al_row, "style_no", "")
//						ib_itemchanged = FALSE
//						return 1 	
				END IF
...
long ll_rowcnt,ll_edi_chk
string ls_deposit_chk, ls_date, ls_edi_yn
/*
...
if gs_brand = 'N' or gs_brand = 'O' or gs_brand = 'J' then
	if ls_date >= is_close_ymd_t then
...
if gs_brand = "J" and ls_edi_yn = "Y" then
	dw_22.visible = true
else 	
	dw_22.visible = false	
end if	
...
if ll_edi_chk > 3 and ls_edi_yn = "Y"  then
...
if  IS_YYMMDD >= "20200206" AND IS_YYMMDD <= "20200214"  AND GS_SHOP_CD = "JO0006"  then //OR (IS_YYMMDD >= "20200120" AND GS_SHOP_CD = 'JO0006') then
	li_chk_cnt = 0
	ll_chk_sale_price = 0 
	ll_chk_sale_amt = 0
	FOR i=1 TO ll_row_count

			ll_chk_sale_price = dw_body.GetitemDecimal(i, "sale_amt")
			IF ll_chk_sale_price = 0 OR IsNull(ll_chk_sale_price) THEN
				ll_chk_sale_amt = ll_chk_sale_amt
			ELSE 	
				ll_chk_sale_amt = ll_chk_sale_amt + ll_chk_sale_price
			END IF	
	NEXT
	...
	if ll_chk_sale_amt >= 300000  then
		MESSAGEBOX("알림!", "20200207일 부터 20200214일 까지 금액별 할인 프로모션이 자동 적용 됩니다! 하단의 실매출액을 꼭 확인하세요!")
		WF_GOODS_CHK3()
	end if
end if
...
//			end if
	...
	// 구매할인권 정상+ 30%세일까지만  쿠폰금액이상의 제품에만 사용가능 
		IF LenA(ls_coupon_no) =  6 AND ls_coupon_no <> "J20011" then	
...
//		ls_card_no_origin = dw_body.getitemnumber(i, "card_no")	
	   ...
	   if ii > 1 then 
		...
		if dw_body.Getitemnumber(i, "sale_qty") > 0 and idw_status = NewModified! THEN  // 반품일때는 처리하지말고 RETURN    
		  if IS_YYMMDD >= "20220704" AND wf_stock_chk(i, ls_style_no1) = false then 
			 IF ls_ok_coupon = "1" THEN 
				MESSAGEBOX("알림!" , "예약(완불)의 경우 예약(완불)판매 별도 화면에서 등록 해주세요!")
			   return 0
		  	 ELSE 	
				MESSAGEBOX("알림!" , "재고가 없는 품번의 판매가 불가 합니다! 관리팀에 문의 하세요!")
			   return 0
    		 END IF 
		  end	if
		end if				
...
type cb_close from w_com010_e`cb_close within w_sh145_e
boolean visible = false
integer x = 389
end type

type cb_delete from w_com010_e`cb_delete within w_sh145_e
integer x = 1769
integer width = 315
integer taborder = 70
end type

type cb_insert from w_com010_e`cb_insert within w_sh145_e
boolean visible = false
integer taborder = 60
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_sh145_e
integer x = 2469
integer width = 384
...
type cb_update from w_com010_e`cb_update within w_sh145_e
integer taborder = 50
end type

type cb_print from w_com010_e`cb_print within w_sh145_e
integer x = 1376
integer width = 393
integer taborder = 80
...
type cb_preview from w_com010_e`cb_preview within w_sh145_e
boolean visible = false
integer x = 1193
integer y = 48
integer taborder = 90
...
type gb_button from w_com010_e`gb_button within w_sh145_e
end type

type dw_head from w_com010_e`dw_head within w_sh145_e
integer y = 152
integer width = 2309
integer height = 96
string dataobject = "d_sh145_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_sh145_e
integer beginy = 368
integer endy = 368
end type

type ln_2 from w_com010_e`ln_2 within w_sh145_e
integer beginy = 372
integer endy = 372
end type

type dw_body from w_com010_e`dw_body within w_sh145_e
event ue_set_column ( long al_row )
integer x = 5
integer y = 308
integer width = 2885
integer height = 380
string dataobject = "d_sh145_d01_new"
...
integer li_ret
decimal ld_goods_amt
string ls_card_no, ls_set_style, ls_shop_cd_chk, ls_set_style_chk, ls_style_chk, ls_style,ls_dot_com
integer Net
long ll_cnt, ll_rows, ll_sale_qty
CHOOSE CASE dwo.name
...
//					dw_body.insertrow(0)
			...
			if gs_brand = 'N' and (gs_shop_cd = 'NG0008' or gs_shop_cd = 'NG0009' or gs_shop_cd = 'NG0037' or gs_shop_cd = 'NG1141' or gs_shop_cd = 'NG0006' or gs_shop_cd = 'NG0014')  and MidA(ls_set_style,5,4) = 'I099' then
...
//		this.Setitem(row,"coupon_no","")
	...
	CASE "dotcom"	  
			...
			ls_style = LeftA(dw_body.getitemstring(row,"style_no"),8)
...
//		
		if IsNull(ls_style) = false and Trim(ls_style) <> "" then				
				wf_style_set2(row, MidA(ls_style,1,8), is_yymmdd, ll_sale_qty, data)
			end if	
...
if gs_brand = 'G' then
	dw_body.dataobject = 'd_sh145_d11_new'
else
	dw_body.dataobject = 'd_sh145_d01_new'
end if
...
type dw_print from w_com010_e`dw_print within w_sh145_e
integer x = 1385
integer y = 224
integer width = 1349
integer height = 948
boolean enabled = false
string dataobject = "d_sh145_p01"
...
CHOOSE CASE dwo.name
	...
	case "return_yn"
		if data = 'N' or isnull(data) then 
			...
			this.setitem(row,"VISITER","")			
		ELSEIF	data = 'Y' THEN
			this.setitem(row,"VISITER","반품")						
		end if
END CHOOSE
...
string     ls_phone_no, ls_visiter, ls_yymmdd,ls_rtrn_info,ls_shop_cd, ls_sale_no
int        li_sale_qty
IF row < 1 THEN RETURN
