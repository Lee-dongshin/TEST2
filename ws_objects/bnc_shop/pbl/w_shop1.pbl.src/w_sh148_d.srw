$PBExportHeader$w_sh148_d.srw
$PBExportComments$매장출고요청확인
forward
global type w_sh148_d from w_com010_d
end type
end forward
...
il_rows = dw_body.retrieve(is_frm_ymd, is_to_ymd, gs_shop_cd)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
type cb_close from w_com010_d`cb_close within w_sh148_d
end type

type cb_delete from w_com010_d`cb_delete within w_sh148_d
end type

type cb_insert from w_com010_d`cb_insert within w_sh148_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_sh148_d
end type

type cb_update from w_com010_d`cb_update within w_sh148_d
end type

type cb_print from w_com010_d`cb_print within w_sh148_d
boolean visible = false
end type

type cb_preview from w_com010_d`cb_preview within w_sh148_d
boolean visible = false
end type

type gb_button from w_com010_d`gb_button within w_sh148_d
end type

type dw_head from w_com010_d`dw_head within w_sh148_d
integer y = 156
integer width = 2862
integer height = 176
string dataobject = "d_sh148_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_sh148_d
integer beginy = 332
integer endy = 332
end type

type ln_2 from w_com010_d`ln_2 within w_sh148_d
integer beginy = 336
integer endy = 336
end type

type dw_body from w_com010_d`dw_body within w_sh148_d
integer y = 352
integer height = 1432
string dataobject = "d_sh148_d01"
boolean hscrollbar = true
end type

type dw_print from w_com010_d`dw_print within w_sh148_d
end type
