$PBExportHeader$w_sh116_e.srw
$PBExportComments$완불요청등록
forward
global type w_sh116_e from w_com010_e
end type
type st_1 from statictext within w_sh116_e
end type
end forward
...
from (		
	...
	where a.self_yn = 'N'
	and   a.yymmdd  >= convert(char(08), dateadd(day, -30, :is_yymmdd), 112)
...
//	IF WF_STOCK_CHK(I, LS_STYLE_NO) = FALSE THEN 
//		MESSAGEBOX("경고!", LS_STYLE_NO + " 품번은 요청가능량을 초과 하였습니다!")
//		RETURN -1 
//	END IF
...
type cb_close from w_com010_e`cb_close within w_sh116_e
end type

type cb_delete from w_com010_e`cb_delete within w_sh116_e
end type

type cb_insert from w_com010_e`cb_insert within w_sh116_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_sh116_e
end type

type cb_update from w_com010_e`cb_update within w_sh116_e
end type

type cb_print from w_com010_e`cb_print within w_sh116_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_sh116_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_sh116_e
end type

type dw_head from w_com010_e`dw_head within w_sh116_e
integer x = 5
integer y = 164
integer height = 172
...
type ln_1 from w_com010_e`ln_1 within w_sh116_e
integer beginy = 340
integer endy = 340
end type

type ln_2 from w_com010_e`ln_2 within w_sh116_e
integer beginy = 344
integer endy = 344
end type

type dw_body from w_com010_e`dw_body within w_sh116_e
event ue_set_column ( long al_row )
integer y = 360
integer width = 2857
integer height = 1424
string dataobject = "d_sh116_d01"
end type
...
type dw_print from w_com010_e`dw_print within w_sh116_e
end type
