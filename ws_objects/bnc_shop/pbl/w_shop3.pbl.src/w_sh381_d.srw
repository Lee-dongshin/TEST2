$PBExportHeader$w_sh381_d.srw
$PBExportComments$이벤트 조회
forward
global type w_sh381_d from w_com010_e
end type
end forward
...
global w_sh381_d w_sh381_d

type variables
string is_fr_ymd, is_to_ymd, is_shop_cd
end variables
...
il_rows = dw_body.retrieve(is_fr_ymd, is_to_ymd, is_shop_cd)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
type cb_close from w_com010_e`cb_close within w_sh381_d
end type

type cb_delete from w_com010_e`cb_delete within w_sh381_d
boolean visible = false
integer x = 1097
end type

type cb_insert from w_com010_e`cb_insert within w_sh381_d
boolean visible = false
integer x = 750
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_sh381_d
integer x = 2139
end type

type cb_update from w_com010_e`cb_update within w_sh381_d
boolean visible = false
end type

type cb_print from w_com010_e`cb_print within w_sh381_d
boolean visible = false
integer x = 1445
end type

type cb_preview from w_com010_e`cb_preview within w_sh381_d
boolean visible = false
integer x = 1787
end type

type gb_button from w_com010_e`gb_button within w_sh381_d
end type

type dw_head from w_com010_e`dw_head within w_sh381_d
event type long ue_item_changed ( long row,  dwobject dwo,  string data )
integer x = 5
integer y = 152
integer width = 2866
integer height = 136
string dataobject = "d_sh381_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_sh381_d
integer beginy = 296
integer endy = 296
end type

type ln_2 from w_com010_e`ln_2 within w_sh381_d
integer beginy = 300
integer endy = 300
end type

type dw_body from w_com010_e`dw_body within w_sh381_d
integer y = 308
integer height = 1488
string dataobject = "d_sh381_d01"
boolean vscrollbar = false
boolean livescroll = false
end type

type dw_print from w_com010_e`dw_print within w_sh381_d
integer x = 1605
integer y = 352
end type
