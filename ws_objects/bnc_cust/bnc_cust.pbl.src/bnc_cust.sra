$PBExportHeader$bnc_cust.sra
$PBExportComments$보끄레 협력업체 시스템
forward
global type bnc_cust from application
end type
global u_n_tr sqlca
