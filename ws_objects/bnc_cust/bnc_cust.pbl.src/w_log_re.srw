$PBExportHeader$w_log_re.srw
$PBExportComments$Log in Window
forward
global type w_log_re from w_logon
end type
type gb_1 from groupbox within w_log_re
end type
type st_1 from statictext within w_log_re
end type
type st_4 from statictext within w_log_re
end type
type st_nm from statictext within w_log_re
end type
type gb_2 from groupbox within w_log_re
end type
type sle_new from u_sle within w_log_re
end type
type sle_new2 from u_sle within w_log_re
end type
type st_5 from statictext within w_log_re
end type
type rb_beaucre from radiobutton within w_log_re
end type
type rb_reolive from radiobutton within w_log_re
end type
type st_ee from statictext within w_log_re
end type
type gb_22 from groupbox within w_log_re
end type
end forward
...
this.Control[iCurrent+11]=this.st_ee
...
type p_logo from w_logon`p_logo within w_log_re
integer x = 18
integer y = 20
integer width = 1170
integer height = 840
...
type st_help from w_logon`st_help within w_log_re
integer x = 32
integer y = 888
integer width = 2231
integer height = 72
...
type cb_ok from w_logon`cb_ok within w_log_re
integer x = 1307
integer y = 724
integer width = 384
integer textsize = -9
...
type cb_cancel from w_logon`cb_cancel within w_log_re
integer x = 1783
integer y = 724
integer width = 389
integer textsize = -9
...
type sle_userid from w_logon`sle_userid within w_log_re
integer x = 1586
integer y = 228
integer width = 238
integer textsize = -9
...
type sle_password from w_logon`sle_password within w_log_re
integer x = 1586
integer y = 428
integer width = 585
end type
...
type st_2 from w_logon`st_2 within w_log_re
integer x = 1307
integer y = 228
integer width = 274
integer height = 76
...
type st_3 from w_logon`st_3 within w_log_re
integer x = 1307
integer y = 428
integer width = 274
integer height = 76
