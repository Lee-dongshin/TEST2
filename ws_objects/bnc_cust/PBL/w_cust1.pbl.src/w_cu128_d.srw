$PBExportHeader$w_cu128_d.srw
$PBExportComments$검사의뢰현황
forward
global type w_cu128_d from w_com010_d
end type
end forward
...
type cb_close from w_com010_d`cb_close within w_cu128_d
end type

type cb_delete from w_com010_d`cb_delete within w_cu128_d
end type

type cb_insert from w_com010_d`cb_insert within w_cu128_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_cu128_d
end type

type cb_update from w_com010_d`cb_update within w_cu128_d
end type

type cb_print from w_com010_d`cb_print within w_cu128_d
end type

type cb_preview from w_com010_d`cb_preview within w_cu128_d
end type

type gb_button from w_com010_d`gb_button within w_cu128_d
integer width = 3602
end type

type dw_head from w_com010_d`dw_head within w_cu128_d
integer width = 3607
integer height = 220
string dataobject = "d_cu128_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_cu128_d
integer endx = 3607
end type

type ln_2 from w_com010_d`ln_2 within w_cu128_d
integer endx = 3607
end type

type dw_body from w_com010_d`dw_body within w_cu128_d
integer width = 3607
integer height = 1576
string dataobject = "d_cu128_d01"
end type
...
type dw_print from w_com010_d`dw_print within w_cu128_d
integer x = 41
integer y = 556
integer width = 1024
integer height = 416
string dataobject = "d_cu128_r01"
end type
