$PBExportHeader$w_cu129_d.srw
$PBExportComments$납품예정현황
forward
global type w_cu129_d from w_com010_d
end type
end forward
...
il_rows = dw_body.retrieve(is_brand, is_fr_yymmdd,is_to_yymmdd, gs_shop_cd, gs_country_cd)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
type cb_close from w_com010_d`cb_close within w_cu129_d
end type

type cb_delete from w_com010_d`cb_delete within w_cu129_d
end type

type cb_insert from w_com010_d`cb_insert within w_cu129_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_cu129_d
end type

type cb_update from w_com010_d`cb_update within w_cu129_d
end type

type cb_print from w_com010_d`cb_print within w_cu129_d
end type

type cb_preview from w_com010_d`cb_preview within w_cu129_d
end type

type gb_button from w_com010_d`gb_button within w_cu129_d
integer width = 3602
end type

type dw_head from w_com010_d`dw_head within w_cu129_d
integer width = 3602
integer height = 220
string dataobject = "d_cu129_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_cu129_d
integer endx = 3602
end type

type ln_2 from w_com010_d`ln_2 within w_cu129_d
integer endx = 3602
end type

type dw_body from w_com010_d`dw_body within w_cu129_d
integer width = 3602
integer height = 1580
string dataobject = "d_cu129_d01"
end type
...
type dw_print from w_com010_d`dw_print within w_cu129_d
integer x = 41
integer y = 556
integer width = 1024
integer height = 416
string dataobject = "d_cu129_r01"
end type
