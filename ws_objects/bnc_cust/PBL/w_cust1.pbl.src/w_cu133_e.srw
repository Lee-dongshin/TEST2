$PBExportHeader$w_cu133_e.srw
$PBExportComments$중간검사결과보고서
forward
global type w_cu133_e from w_com010_e
end type
type dw_1 from datawindow within w_cu133_e
end type
type dw_2 from datawindow within w_cu133_e
end type
end forward
...
il_rows = dw_body.retrieve(is_yymmdd, is_style, is_chno, gs_shop_cd)
dw_1.reset()
dw_2.reset()
IF il_rows > 0 THEN
	for i = 1 to il_rows 
...
type cb_close from w_com010_e`cb_close within w_cu133_e
end type

type cb_delete from w_com010_e`cb_delete within w_cu133_e
end type

type cb_insert from w_com010_e`cb_insert within w_cu133_e
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_cu133_e
end type

type cb_update from w_com010_e`cb_update within w_cu133_e
end type

type cb_print from w_com010_e`cb_print within w_cu133_e
end type

type cb_preview from w_com010_e`cb_preview within w_cu133_e
end type

type gb_button from w_com010_e`gb_button within w_cu133_e
integer width = 3607
end type

type dw_head from w_com010_e`dw_head within w_cu133_e
integer y = 156
integer width = 3607
integer height = 148
...
type ln_1 from w_com010_e`ln_1 within w_cu133_e
integer beginy = 320
integer endx = 3607
integer endy = 320
end type

type ln_2 from w_com010_e`ln_2 within w_cu133_e
integer beginy = 324
integer endx = 3607
integer endy = 324
end type

type dw_body from w_com010_e`dw_body within w_cu133_e
integer y = 344
integer width = 3607
integer height = 1260
...
type dw_print from w_com010_e`dw_print within w_cu133_e
