$PBExportHeader$w_com020_d.srw
$PBExportComments$[head][list][body]조회용
forward
global type w_com020_d from w_com000
end type
type dw_head from u_dw within w_com020_d
end type
type ln_1 from line within w_com020_d
end type
type ln_2 from line within w_com020_d
end type
type dw_list from u_dw within w_com020_d
end type
type dw_body from u_dw within w_com020_d
end type
type st_1 from u_st within w_com020_d
end type
type dw_print from u_dw within w_com020_d
end type
end forward
...
type cb_close from w_com000`cb_close within w_com020_d
integer taborder = 110
end type

type cb_delete from w_com000`cb_delete within w_com020_d
boolean visible = false
integer x = 1079
integer taborder = 60
end type

type cb_insert from w_com000`cb_insert within w_com020_d
boolean visible = false
integer x = 736
integer taborder = 50
...
type cb_retrieve from w_com000`cb_retrieve within w_com020_d
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_com020_d
boolean visible = false
integer taborder = 100
end type

type cb_print from w_com000`cb_print within w_com020_d
integer x = 1422
integer taborder = 70
end type

type cb_preview from w_com000`cb_preview within w_com020_d
integer x = 1765
integer taborder = 80
end type

type gb_button from w_com000`gb_button within w_com020_d
integer taborder = 0
end type
