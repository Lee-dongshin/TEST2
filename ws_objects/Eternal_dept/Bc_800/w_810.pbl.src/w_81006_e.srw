$PBExportHeader$w_81006_e.srw
$PBExportComments$역량평가(상사)
forward
global type w_81006_e from w_com020_e
end type
end forward

global type w_81006_e from w_com020_e
end type
global w_81006_e w_81006_e
...
type cb_close from w_com020_e`cb_close within w_81006_e
end type

type cb_delete from w_com020_e`cb_delete within w_81006_e
end type

type cb_insert from w_com020_e`cb_insert within w_81006_e
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_81006_e
end type

type cb_update from w_com020_e`cb_update within w_81006_e
end type

type cb_print from w_com020_e`cb_print within w_81006_e
end type

type cb_preview from w_com020_e`cb_preview within w_81006_e
end type

type gb_button from w_com020_e`gb_button within w_81006_e
end type

type cb_excel from w_com020_e`cb_excel within w_81006_e
end type

type dw_head from w_com020_e`dw_head within w_81006_e
integer y = 164
integer height = 164
string dataobject = "d_81006_H01"
end type

type ln_1 from w_com020_e`ln_1 within w_81006_e
integer beginy = 352
integer endy = 352
end type

type ln_2 from w_com020_e`ln_2 within w_81006_e
integer beginy = 356
integer endy = 356
end type

type dw_list from w_com020_e`dw_list within w_81006_e
integer y = 380
integer width = 933
integer height = 1660
string dataobject = "d_81006_L01"
end type
...
type dw_body from w_com020_e`dw_body within w_81006_e
integer x = 987
integer y = 380
integer width = 2624
integer height = 1660
string dataobject = "d_81006_d01"
end type
...
type st_1 from w_com020_e`st_1 within w_81006_e
integer x = 969
integer y = 380
integer height = 1660
end type

type dw_print from w_com020_e`dw_print within w_81006_e
integer x = 110
integer y = 896
end type
