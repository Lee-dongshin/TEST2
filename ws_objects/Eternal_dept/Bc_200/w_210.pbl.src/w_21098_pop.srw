$PBExportHeader$w_21098_pop.srw
$PBExportComments$케어라벨입력
forward
global type w_21098_pop from w_com030_e
end type
type dw_2 from datawindow within w_21098_pop
end type
type dw_copy_ord from datawindow within w_21098_pop
end type
type dw_1 from datawindow within w_21098_pop
end type
type dw_3 from datawindow within w_21098_pop
end type
type dw_4 from datawindow within w_21098_pop
end type
type dw_5 from datawindow within w_21098_pop
end type
type dw_9 from datawindow within w_21098_pop
end type
type dw_6 from datawindow within w_21098_pop
end type
type dw_7 from datawindow within w_21098_pop
end type
type dw_8 from datawindow within w_21098_pop
end type
end forward
...
global w_21098_pop w_21098_pop
...
event pfc_preopen();call super::pfc_preopen;string ls_style, ls_chno, ls_year, ls_season
...
ls_style = LeftA(gsv_cd.gs_cd10,8)
...
dw_head.setitem(1,"style_no", ls_style)
...
event pfc_postopen();call super::pfc_postopen;string ls_style, ls_chno, ls_year, ls_season, ls_brand


ls_style = LeftA(gsv_cd.gs_cd10,8)

select year, season, brand
into :ls_year, :ls_season, :ls_brand
from tb_12020_m
where style = :ls_style;
...
type cb_close from w_com030_e`cb_close within w_21098_pop
end type

type cb_delete from w_com030_e`cb_delete within w_21098_pop
boolean visible = false
end type

type cb_insert from w_com030_e`cb_insert within w_21098_pop
string text = "복사"
end type
...
type cb_retrieve from w_com030_e`cb_retrieve within w_21098_pop
end type

type cb_update from w_com030_e`cb_update within w_21098_pop
end type

type cb_print from w_com030_e`cb_print within w_21098_pop
boolean visible = false
end type

type cb_preview from w_com030_e`cb_preview within w_21098_pop
boolean visible = false
end type

type gb_button from w_com030_e`gb_button within w_21098_pop
integer x = 5
end type

type cb_excel from w_com030_e`cb_excel within w_21098_pop
integer width = 439
string text = "케어라벨 복사!"
end type
...
type dw_head from w_com030_e`dw_head within w_21098_pop
integer y = 184
integer height = 228
...
type ln_1 from w_com030_e`ln_1 within w_21098_pop
end type

type ln_2 from w_com030_e`ln_2 within w_21098_pop
end type

type dw_list from w_com030_e`dw_list within w_21098_pop
integer x = 0
integer width = 1381
...
type dw_body from w_com030_e`dw_body within w_21098_pop
integer x = 1403
integer width = 2194
...
type st_1 from w_com030_e`st_1 within w_21098_pop
integer x = 1381
end type

type dw_print from w_com030_e`dw_print within w_21098_pop
integer x = 1317
integer y = 616
end type
...
string ls_remark1, ls_remark2, ls_remark3, ls_remark4, ls_remark5, ls_remark6
string ls_mat_gubn1,	ls_mat_gubn2,	ls_mat_gubn3,	ls_mat_gubn4,	ls_mat_gubn5,	ls_mat_gubn6,	ls_mat_gubn7,	ls_mat_gubn8
STRING ls_mat_gubn9,	ls_mat_gubn10,	ls_mat_gubn11,	ls_mat_gubn12
string ls_mat_nm1,	ls_mat_nm2,		ls_mat_nm3,		ls_mat_nm4,		ls_mat_nm5,		ls_mat_nm6,		ls_mat_nm7,		ls_mat_nm8
string ls_mat_nm9, ls_mat_nm10, ls_mat_nm11, ls_mat_nm12
