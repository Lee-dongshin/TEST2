$PBExportHeader$w_22104_e.srw
$PBExportComments$자재 기타출고 등록 (자가소모)
forward
global type w_22104_e from w_com010_e
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_22104_e","0")
end event

type cb_close from w_com010_e`cb_close within w_22104_e
end type

type cb_delete from w_com010_e`cb_delete within w_22104_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_22104_e
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_22104_e
end type

type cb_update from w_com010_e`cb_update within w_22104_e
end type

type cb_print from w_com010_e`cb_print within w_22104_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_22104_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_22104_e
end type

type cb_excel from w_com010_e`cb_excel within w_22104_e
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_22104_e
integer height = 220
string dataobject = "d_22104_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_22104_e
integer beginy = 424
integer endy = 424
end type

type ln_2 from w_com010_e`ln_2 within w_22104_e
integer beginy = 428
integer endy = 428
end type

type dw_body from w_com010_e`dw_body within w_22104_e
integer y = 444
integer height = 1596
string dataobject = "d_22104_d01"
...
type dw_print from w_com010_e`dw_print within w_22104_e
end type
