$PBExportHeader$w_22101_e_old.srw
$PBExportComments$원자재 출고 등록
forward
global type w_22101_e_old from w_com010_e
end type
end forward
...
global w_22101_e_old w_22101_e_old
...
on w_22101_e_old.create
call super::create
end on

on w_22101_e_old.destroy
call super::destroy
		...
		is_brand = dw_head.GetItemString(1, "brand")
			IF ai_div = 1 THEN
				IF IsNull(as_data) or Trim(as_data) = "" THEN
					dw_head.SetItem(1, "cust_cd", "")
					dw_head.SetItem(1, "cust_nm", "")
					RETURN 0
				END IF
				
				IF is_brand = LeftA(as_data, 1) and wf_style_info(as_data, al_row, '1') = 0 THEN
					RETURN 0
				END IF
			END IF
...
is_brand   = dw_head.getitemstring(1,"brand")
is_out_ymd = Trim(String(dw_head.GetItemDateTime(1, "yymmdd"), 'yyyymmdd'))
is_style  = dw_head.getitemstring(1,"style_no")

This.Trigger Event ue_title()

dw_print.Retrieve(is_brand, is_out_ymd, is_style, "01")
...
dw_print.Retrieve(is_brand, is_out_ymd, is_out_no, "01")
dw_print.inv_printpreview.of_SetZoom()

end event

type cb_close from w_com010_e`cb_close within w_22101_e_old
end type

type cb_delete from w_com010_e`cb_delete within w_22101_e_old
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_22101_e_old
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_22101_e_old
end type

type cb_update from w_com010_e`cb_update within w_22101_e_old
end type

type cb_print from w_com010_e`cb_print within w_22101_e_old
boolean enabled = true
end type

type cb_preview from w_com010_e`cb_preview within w_22101_e_old
boolean enabled = true
end type

type gb_button from w_com010_e`gb_button within w_22101_e_old
end type

type cb_excel from w_com010_e`cb_excel within w_22101_e_old
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_22101_e_old
integer height = 220
...
type ln_1 from w_com010_e`ln_1 within w_22101_e_old
integer beginy = 424
integer endy = 424
end type

type ln_2 from w_com010_e`ln_2 within w_22101_e_old
integer beginy = 428
integer endy = 428
end type

type dw_body from w_com010_e`dw_body within w_22101_e_old
integer y = 444
integer height = 1596
...
type dw_print from w_com010_e`dw_print within w_22101_e_old
