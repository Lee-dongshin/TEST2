$PBExportHeader$w_22107_e.srw
$PBExportComments$자재 SAMPLE출고 등록
forward
global type w_22107_e from w_com010_e
end type
end forward
...
global w_22107_e w_22107_e

type variables
DataWindowChild idw_brand, idw_house, idw_smp_item, idw_color1, idw_color2
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_22107_e","0")
end event

type cb_close from w_com010_e`cb_close within w_22107_e
end type

type cb_delete from w_com010_e`cb_delete within w_22107_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_22107_e
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_22107_e
end type

type cb_update from w_com010_e`cb_update within w_22107_e
end type

type cb_print from w_com010_e`cb_print within w_22107_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_22107_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_22107_e
end type

type cb_excel from w_com010_e`cb_excel within w_22107_e
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_22107_e
integer height = 220
string dataobject = "d_22107_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_22107_e
integer beginy = 424
integer endy = 424
end type

type ln_2 from w_com010_e`ln_2 within w_22107_e
integer beginy = 428
integer endy = 428
end type

type dw_body from w_com010_e`dw_body within w_22107_e
integer y = 444
integer height = 1596
string dataobject = "d_22107_d01"
...
This.GetChild("smp_item", idw_smp_item)
idw_smp_item.SetTransObject(SQLCA)
idw_smp_item.Retrieve()
...
CHOOSE CASE dwo.name
	...
	CASE "color1", "color2"
		...
		If wf_set_data('I', row, This.GetItemString(row, "mat_cd"), data) <> 0 Then Return 1
	CASE "qty"
...
type dw_print from w_com010_e`dw_print within w_22107_e
end type
