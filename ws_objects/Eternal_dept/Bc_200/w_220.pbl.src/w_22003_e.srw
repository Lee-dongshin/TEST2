$PBExportHeader$w_22003_e.srw
$PBExportComments$원자재 입고반품 등록
forward
global type w_22003_e from w_com020_e
end type
type st_remark from statictext within w_22003_e
end type
type st_remark2 from statictext within w_22003_e
end type
end forward
...
global w_22003_e w_22003_e

type variables
DataWindowChild idw_brand, idw_house

String is_brand, is_yymmdd, is_mmat_cd, is_house
Long il_list_row
...
il_rows = dw_list.retrieve(is_brand, is_mmat_cd, is_house)
			 dw_body.retrieve(is_brand, is_mmat_cd, is_house)

IF il_rows > 0 THEN
   dw_list.SetFocus()
ELSEIF il_rows = 0 THEN
   MessageBox("조회", "실입고 자료가 없습니다.")
ELSE
...
dw_body.SetItem(il_rows, "in_ymd", is_yymmdd)
dw_body.SetItem(il_rows, "tmp_qty", 0)
dw_body.SetItem(il_rows, "sil_qty", 0)
...
String   ls_color
Decimal  ldc_tmp_qty, ldc_sil_qty
...
//			  UPDATE TB_21011_D
//				  SET IN_QTY = ISNULL(IN_QTY, 0) + ISNULL(:ldc_tmp_qty, 0),
//						MOD_ID = :gs_user_id,
//						MOD_DT = :ld_datetime
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_22003_e","0")
end event

type cb_close from w_com020_e`cb_close within w_22003_e
end type

type cb_delete from w_com020_e`cb_delete within w_22003_e
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_22003_e
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_22003_e
end type

type cb_update from w_com020_e`cb_update within w_22003_e
end type

type cb_print from w_com020_e`cb_print within w_22003_e
end type

type cb_preview from w_com020_e`cb_preview within w_22003_e
end type

type gb_button from w_com020_e`gb_button within w_22003_e
end type

type cb_excel from w_com020_e`cb_excel within w_22003_e
end type

type dw_head from w_com020_e`dw_head within w_22003_e
integer height = 220
string dataobject = "d_22003_h01"
end type
...
type ln_1 from w_com020_e`ln_1 within w_22003_e
integer beginy = 424
integer endy = 424
end type

type ln_2 from w_com020_e`ln_2 within w_22003_e
integer beginy = 428
integer endy = 428
end type

type dw_list from w_com020_e`dw_list within w_22003_e
integer y = 508
integer width = 1769
integer height = 1532
string dataobject = "d_22003_d01"
...
type dw_body from w_com020_e`dw_body within w_22003_e
integer x = 1824
integer y = 508
integer width = 1769
integer height = 1532
string dataobject = "d_22003_d02"
boolean hscrollbar = true
boolean hsplitscroll = true
end type
...
type st_1 from w_com020_e`st_1 within w_22003_e
integer x = 1801
integer y = 508
integer height = 1532
end type

type dw_print from w_com020_e`dw_print within w_22003_e
string dataobject = "d_22003_r01"
end type
...
string text = "( 추가 시 : 적용 입고 내역을 더블클릭 )"
