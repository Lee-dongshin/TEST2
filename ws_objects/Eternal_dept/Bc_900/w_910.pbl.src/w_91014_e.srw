$PBExportHeader$w_91014_e.srw
$PBExportComments$협력업체 추가정보
forward
global type w_91014_e from w_com000
end type
type dw_head from u_dw within w_91014_e
end type
type ln_1 from line within w_91014_e
end type
type ln_2 from line within w_91014_e
end type
type dw_body from u_dw within w_91014_e
end type
type dw_print from u_dw within w_91014_e
end type
end forward
...
global w_91014_e w_91014_e

type variables
string is_brand, is_cust_cd
datawindowchild idw_brand, idw_s_sojae, idw_sect_nm
...
type cb_close from w_com000`cb_close within w_91014_e
integer taborder = 100
end type

type cb_delete from w_com000`cb_delete within w_91014_e
integer x = 1083
integer taborder = 50
end type

type cb_insert from w_com000`cb_insert within w_91014_e
boolean visible = false
integer x = 741
integer taborder = 40
end type

type cb_retrieve from w_com000`cb_retrieve within w_91014_e
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_91014_e
integer taborder = 90
end type

type cb_print from w_com000`cb_print within w_91014_e
integer x = 1426
integer taborder = 60
end type

type cb_preview from w_com000`cb_preview within w_91014_e
integer x = 1769
integer taborder = 70
end type

type gb_button from w_com000`gb_button within w_91014_e
integer taborder = 0
end type

type cb_excel from w_com000`cb_excel within w_91014_e
integer x = 2112
end type
...
idw_brand.SetItem(1, "inter_cd", 'N')
idw_brand.SetItem(1, "inter_nm", 'ON＆ON')
...
This.GetChild("s_sojae", idw_s_sojae)
idw_s_sojae.SetTRansObject(SQLCA)
idw_s_sojae.Retrieve('111')
idw_s_sojae.insertrow(1)
