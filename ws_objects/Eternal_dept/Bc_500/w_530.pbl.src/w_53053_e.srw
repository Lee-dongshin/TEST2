...
//	End If
	...
	dw_1.SetItem(ll_row1, "brand",         is_brand       )
...
if MidA(is_fr_shop_cd,2,1) = "X" then 
	...
	MessageBox("확인", ls_style +ls_chno + ls_color + ls_size + " 재고수량: " + string(ll_stock_qty) + ", 재고가 없는 제품입니다!") 
	//RETURN FALSE 
	END IF
end if
...
/* 수정일      : 2002.03.14                                                  */
/*===========================================================================*/
String     ls_shop_nm, ls_style, ls_chno, ls_given_fg, ls_given_ymd, ls_shop_type,ls_work_gubn, ls_color
Boolean    lb_check 
		...
		For i = 1 To This.RowCount()
			...
			if ls_proc_chk = "N" then
				...
				IF wf_style_set(i, ls_style, 'OUT') THEN 
					...
					IF wf_style_set(i, ls_style, 'RTN') = False THEN 
						Return 1
					END IF					
