...
type gb_2 from groupbox within w_53005_d
end type
...
type rb_mnc from radiobutton within w_53005_d
end type
...
type rb_mc_div from radiobutton within w_53005_d
end type
end forward
...
this.rb_mc_div=create rb_mc_div
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.gb_2
this.Control[iCurrent+2]=this.rb_date
this.Control[iCurrent+3]=this.rb_shop
this.Control[iCurrent+4]=this.rb_sojae
this.Control[iCurrent+5]=this.rb_item
this.Control[iCurrent+6]=this.rb_style
this.Control[iCurrent+7]=this.rb_mcs
this.Control[iCurrent+8]=this.rb_style_no
this.Control[iCurrent+9]=this.rb_mncs
this.Control[iCurrent+10]=this.rb_mc
this.Control[iCurrent+11]=this.rb_shop_tag
...
this.Control[iCurrent+25]=this.rb_year
this.Control[iCurrent+26]=this.rb_week
this.Control[iCurrent+27]=this.rb_detail_style
this.Control[iCurrent+28]=this.rb_mnc
...
this.Control[iCurrent+33]=this.cbx_6
this.Control[iCurrent+34]=this.cbx_5
this.Control[iCurrent+35]=this.cbx_4
this.Control[iCurrent+36]=this.cbx_7
this.Control[iCurrent+37]=this.cbx_8
this.Control[iCurrent+38]=this.cbx_9
this.Control[iCurrent+39]=this.cbx_10
this.Control[iCurrent+40]=this.rb_mc_div
end on
...
CHOOSE CASE dwo.name
	CASE "brand"
		...
		If data = 'B' or data = 'L' or data = 'F' or data = 'S' or data = 'K' or data = 'V' or data = 'U' or data = 'P' or data = 'Q' or data = 'R' or data = 'H'then
			st_2.visible = True
			cbx_1.visible = True
			cbx_2.visible = True
			cbx_3.visible = True
...
dw_body.DataObject  = 'd_53005_d19'
dw_print.DataObject = 'd_53005_r19'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject  = 'd_53005_d09_DIV'
dw_print.DataObject = 'd_53005_r09_DIV'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
end event
