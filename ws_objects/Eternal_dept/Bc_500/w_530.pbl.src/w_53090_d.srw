...
String is_brand , is_yymm, is_yymm_vs, is_shop_type, is_empno, is_gubn, is_shop_div, is_nt_code
end variables
...
il_rows = dw_1.retrieve(is_yymm, is_yymm_vs, is_brand, is_empno, is_shop_type, is_shop_div, is_nt_code)

il_rows = dw_body.retrieve(is_yymm, is_yymm_vs, is_brand, is_empno, is_shop_type, is_shop_div, is_nt_code)
