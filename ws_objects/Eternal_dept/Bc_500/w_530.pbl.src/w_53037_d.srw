$PBExportHeader$w_53037_d.srw
$PBExportComments$판매 취소현황
forward
global type w_53037_d from w_com010_d
end type
type rb_date from radiobutton within w_53037_d
end type
type rb_shop from radiobutton within w_53037_d
end type
type rb_sojae from radiobutton within w_53037_d
end type
type rb_item from radiobutton within w_53037_d
end type
type rb_style from radiobutton within w_53037_d
end type
type rb_mcs from radiobutton within w_53037_d
end type
type rb_style_no from radiobutton within w_53037_d
end type
type rb_mncs from radiobutton within w_53037_d
end type
type rb_mc from radiobutton within w_53037_d
end type
type gb_1 from groupbox within w_53037_d
end type
type dw_detail from datawindow within w_53037_d
end type
type rb_yymm from radiobutton within w_53037_d
end type
type dw_1 from u_dw within w_53037_d
end type
type dw_2 from datawindow within w_53037_d
end type
type cbx_except from checkbox within w_53037_d
end type
end forward
...
string is_except_eshop, is_dotcom, is_gubn
...
if cbx_except.visible then
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_ps_except, is_plan_dc, is_except_eshop, IS_DOTCOM, is_gubn)
else									
	il_rows = dw_body.retrieve(is_brand, is_fr_ymd, is_to_ymd, is_shop_div, is_area_cd, &
										is_shop_cd, is_shop_type, is_year, is_season, is_sojae, is_item, is_seq_no, is_color, is_plan_dc,is_except_eshop, IS_DOTCOM, is_gubn)									
end if										
...
this.Control[iCurrent+12]=this.rb_yymm
this.Control[iCurrent+13]=this.dw_1
this.Control[iCurrent+14]=this.dw_2
this.Control[iCurrent+15]=this.cbx_except
end on

on w_53037_d.destroy
call super::destroy
...
type cb_close from w_com010_d`cb_close within w_53037_d
end type

type cb_delete from w_com010_d`cb_delete within w_53037_d
end type

type cb_insert from w_com010_d`cb_insert within w_53037_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_53037_d
end type

type cb_update from w_com010_d`cb_update within w_53037_d
end type

type cb_print from w_com010_d`cb_print within w_53037_d
end type

type cb_preview from w_com010_d`cb_preview within w_53037_d
end type

type gb_button from w_com010_d`gb_button within w_53037_d
end type

type cb_excel from w_com010_d`cb_excel within w_53037_d
end type

type dw_head from w_com010_d`dw_head within w_53037_d
integer y = 304
integer height = 292
string dataobject = "d_53037_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_53037_d
integer beginy = 596
integer endy = 596
end type

type ln_2 from w_com010_d`ln_2 within w_53037_d
integer beginy = 600
integer endy = 600
end type

type dw_body from w_com010_d`dw_body within w_53037_d
integer x = 14
integer y = 608
integer width = 3584
integer height = 1432
string dataobject = "d_53037_d01"
...
type dw_print from w_com010_d`dw_print within w_53037_d
string dataobject = "d_53037_r01"
end type
