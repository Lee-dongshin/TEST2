$PBExportHeader$w_53018_d.srw
$PBExportComments$타사일매출조회
forward
global type w_53018_d from w_com010_d
end type
end forward
...
event ue_popup;call super::ue_popup;String     ls_shop_nm, ls_flag, ls_age_grp, ls_jumin 
...
type cb_close from w_com010_d`cb_close within w_53018_d
end type

type cb_delete from w_com010_d`cb_delete within w_53018_d
end type

type cb_insert from w_com010_d`cb_insert within w_53018_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_53018_d
end type

type cb_update from w_com010_d`cb_update within w_53018_d
end type

type cb_print from w_com010_d`cb_print within w_53018_d
boolean visible = false
end type

type cb_preview from w_com010_d`cb_preview within w_53018_d
boolean visible = false
end type

type gb_button from w_com010_d`gb_button within w_53018_d
end type

type cb_excel from w_com010_d`cb_excel within w_53018_d
end type

type dw_head from w_com010_d`dw_head within w_53018_d
integer y = 160
integer height = 208
...
type ln_1 from w_com010_d`ln_1 within w_53018_d
integer beginy = 380
integer endy = 380
end type

type ln_2 from w_com010_d`ln_2 within w_53018_d
integer beginy = 384
integer endy = 384
end type

type dw_body from w_com010_d`dw_body within w_53018_d
integer x = 9
integer y = 400
integer height = 1644
string dataobject = "d_53018_d01"
...
type dw_print from w_com010_d`dw_print within w_53018_d
