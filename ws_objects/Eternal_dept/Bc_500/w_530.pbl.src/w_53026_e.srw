$PBExportHeader$w_53026_e.srw
$PBExportComments$기타미수금관리
forward
global type w_53026_e from w_com010_e
end type
end forward
...
type cb_close from w_com010_e`cb_close within w_53026_e
end type

type cb_delete from w_com010_e`cb_delete within w_53026_e
end type

type cb_insert from w_com010_e`cb_insert within w_53026_e
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_53026_e
end type

type cb_update from w_com010_e`cb_update within w_53026_e
end type

type cb_print from w_com010_e`cb_print within w_53026_e
end type

type cb_preview from w_com010_e`cb_preview within w_53026_e
end type

type gb_button from w_com010_e`gb_button within w_53026_e
end type

type cb_excel from w_com010_e`cb_excel within w_53026_e
end type

type dw_head from w_com010_e`dw_head within w_53026_e
integer x = 41
integer y = 216
integer height = 144
string dataobject = "d_53026_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_53026_e
end type

type ln_2 from w_com010_e`ln_2 within w_53026_e
end type

type dw_body from w_com010_e`dw_body within w_53026_e
string dataobject = "d_53026_d01"
...
type dw_print from w_com010_e`dw_print within w_53026_e
end type
