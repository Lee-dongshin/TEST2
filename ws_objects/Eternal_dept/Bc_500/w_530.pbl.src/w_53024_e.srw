$PBExportHeader$w_53024_e.srw
$PBExportComments$수출Invoice등록
forward
global type w_53024_e from w_com010_e
end type
type dw_1 from datawindow within w_53024_e
end type
type dw_detail from datawindow within w_53024_e
end type
end forward
...
type cb_close from w_com010_e`cb_close within w_53024_e
end type

type cb_delete from w_com010_e`cb_delete within w_53024_e
end type

type cb_insert from w_com010_e`cb_insert within w_53024_e
boolean visible = false
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_53024_e
end type

type cb_update from w_com010_e`cb_update within w_53024_e
end type

type cb_print from w_com010_e`cb_print within w_53024_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_53024_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_53024_e
end type

type cb_excel from w_com010_e`cb_excel within w_53024_e
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_53024_e
integer height = 120
string dataobject = "d_53024_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_53024_e
integer beginy = 292
integer endy = 292
end type

type ln_2 from w_com010_e`ln_2 within w_53024_e
integer beginy = 296
integer endy = 296
end type

type dw_body from w_com010_e`dw_body within w_53024_e
integer y = 308
integer height = 1280
string dataobject = "d_53024_d01"
...
type dw_print from w_com010_e`dw_print within w_53024_e
end type
