...
type variables
DataWindowChild idw_season, idw_color

String is_shop_cd, is_year, is_season, is_style, is_color, is_size, is_fr_yymmdd, is_to_yymmdd, is_chk_yn
end variables
...
il_rows = dw_body.retrieve(is_shop_cd, is_year, is_season,is_fr_yymmdd, is_to_yymmdd, is_chk_yn)
