...
type variables
DataWindowChild idw_color , idw_house_cd
String  is_style, is_chno, is_color, is_deal_type, is_yymmdd, is_house_cd
Long    il_deal_seq 
Boolean ib_NewDeal
end variables
...
il_rows = dw_temp.Retrieve(is_style, is_chno, is_color, is_deal_type)
