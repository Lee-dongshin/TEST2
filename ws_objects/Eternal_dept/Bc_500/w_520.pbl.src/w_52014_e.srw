...
String  is_yymmdd, is_style, is_chno,   is_color, is_color_nm , is_house_cd, is_disc_opt
Long    il_deal_seq 
Boolean ib_NewDeal
DataStore  ids_copy
...
FOR i = 1 TO ll_row_cnt 
   ...
   k = dw_assort.find(ls_find, 1, ll_assort_cnt)	
	IF k > 0 THEN 
		...
		dw_body.Setitem(ll_row, "today_qty_"  + String(k), dw_temp.GetitemNumber(i, "today_qty"))		
		dw_body.Setitem(ll_row, "move_qty_"  + String(k), dw_temp.GetitemNumber(i, "move_qty"))				
      lb_Chk = True
	END IF
NEXT
...
FOR i = 1 TO 10 
	IF i > il_rows THEN
      ls_modify = ' t_size_'      + String(i) + '.Visible=0' + &
                  ...
                  ' today_qty_'   + String(i) + '.Visible=0' + &						
                  ' move_qty_'    + String(i) + '.Visible=0' + &												
                  ...
                  ' cs_move_'     + String(i) + '.Visible=0' + &						
                  ' cs_today_'    + String(i) + '.Visible=0' 
   ELSE
      ...
      ls_modify = ' t_size_'      + String(i) + '.Text="' + ls_size + '"' + &
                  ...
                  ' today_qty_'   + String(i) + '.Visible=1' + &						
                  ' move_qty_'    + String(i) + '.Visible=1' + &												
                  ...
                  ' cs_move_'     + String(i) + '.Visible=1' + &						
                  ' cs_today_'    + String(i) + '.Visible=1' 						
	END IF
	ls_Error = dw_body.Modify(ls_modify)
	ls_Error = dw_print.Modify(ls_modify)
	IF (ls_Error <> "") THEN 
...
il_rows = dw_temp.retrieve(is_style, ls_chno, is_color, il_deal_seq)
IF il_rows > 0 THEN 
	wf_temp_set() 
