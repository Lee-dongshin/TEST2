...
type variables
DataWindowChild idw_fr_color, idw_to_color, idw_house_cd

String  is_flag, is_house_cd
String  is_fr_style, is_fr_chno, is_fr_color, is_fr_ymd 
...
il_rows = dw_temp.retrieve(is_fr_style, is_fr_chno, is_fr_color, is_fr_ymd, is_flag)
IF il_rows > 0 THEN 
	IF wf_temp_set() THEN 
		IF is_flag = '1' THEN 
