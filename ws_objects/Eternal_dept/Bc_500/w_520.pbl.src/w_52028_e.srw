...
String  is_to_style, is_to_chno, is_to_color, is_yymmdd , is_s_ymd, is_e_ymd, is_house_cd
Long    il_deal_seq
Boolean ib_NewDeal
...
/* 기준 품번 판매내역 처리 */
il_rows = dw_temp.retrieve(is_fr_style,"%", is_fr_color, il_deal_seq, is_s_ymd, is_e_ymd)
