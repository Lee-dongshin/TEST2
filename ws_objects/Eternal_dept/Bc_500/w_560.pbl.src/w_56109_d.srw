$PBExportHeader$w_56109_d.srw
$PBExportComments$판매수수료 지급내역서
forward
global type w_56109_d from w_com010_d
end type
end forward
...
dw_print.Retrieve(is_brand, is_yymm, is_shop_div, is_comm_fg)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_56109_d","0")
end event

type cb_close from w_com010_d`cb_close within w_56109_d
end type

type cb_delete from w_com010_d`cb_delete within w_56109_d
end type

type cb_insert from w_com010_d`cb_insert within w_56109_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_56109_d
end type

type cb_update from w_com010_d`cb_update within w_56109_d
end type

type cb_print from w_com010_d`cb_print within w_56109_d
end type

type cb_preview from w_com010_d`cb_preview within w_56109_d
end type

type gb_button from w_com010_d`gb_button within w_56109_d
end type

type cb_excel from w_com010_d`cb_excel within w_56109_d
end type

type dw_head from w_com010_d`dw_head within w_56109_d
integer y = 168
integer height = 220
string dataobject = "d_56109_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_56109_d
integer beginy = 424
integer endy = 424
end type

type ln_2 from w_com010_d`ln_2 within w_56109_d
integer beginy = 428
integer endy = 428
end type

type dw_body from w_com010_d`dw_body within w_56109_d
integer x = 9
integer y = 444
integer width = 3593
integer height = 1600
string dataobject = "d_56109_d01"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

type dw_print from w_com010_d`dw_print within w_56109_d
integer x = 425
integer y = 140
string dataobject = "d_56109_r01"
end type
