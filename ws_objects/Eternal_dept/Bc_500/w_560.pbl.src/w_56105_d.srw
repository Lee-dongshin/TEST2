$PBExportHeader$w_56105_d.srw
$PBExportComments$입금 및 미수현황
forward
global type w_56105_d from w_com010_d
end type
end forward
...
IF IsNull(is_comm_fg) OR is_comm_fg = "" THEN
   MessageBox(ls_title,"수수료 구분을 선택력하십시요!")
   dw_head.SetFocus()
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_56105_d","0")
end event

type cb_close from w_com010_d`cb_close within w_56105_d
end type

type cb_delete from w_com010_d`cb_delete within w_56105_d
end type

type cb_insert from w_com010_d`cb_insert within w_56105_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_56105_d
end type

type cb_update from w_com010_d`cb_update within w_56105_d
end type

type cb_print from w_com010_d`cb_print within w_56105_d
end type

type cb_preview from w_com010_d`cb_preview within w_56105_d
end type

type gb_button from w_com010_d`gb_button within w_56105_d
end type

type cb_excel from w_com010_d`cb_excel within w_56105_d
end type

type dw_head from w_com010_d`dw_head within w_56105_d
integer height = 220
string dataobject = "d_56105_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_56105_d
integer beginy = 424
integer endy = 424
end type

type ln_2 from w_com010_d`ln_2 within w_56105_d
integer beginy = 428
integer endy = 428
end type

type dw_body from w_com010_d`dw_body within w_56105_d
integer y = 444
integer height = 1596
string dataobject = "d_56105_d01"
boolean hsplitscroll = true
end type

type dw_print from w_com010_d`dw_print within w_56105_d
string dataobject = "d_56105_r01"
end type
