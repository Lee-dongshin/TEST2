$PBExportHeader$w_56023_e.srw
$PBExportComments$닷컴해재부진재매입선정
forward
global type w_56023_e from w_com010_e
end type
end forward
...
global w_56023_e w_56023_e

type variables
DataWindowChild idw_brand, idw_year, idw_season, idw_dep_seq
String is_brand, is_year, is_season, is_dep_seq, is_yymmdd
end variables
...
il_rows = dw_body.retrieve(is_yymmdd, is_brand, is_year, is_season, is_dep_seq)
IF il_rows > 0 THEN
   dw_body.SetFocus()
END IF
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_56023_e","0")
end event
...
type cb_close from w_com010_e`cb_close within w_56023_e
end type

type cb_delete from w_com010_e`cb_delete within w_56023_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_56023_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_56023_e
end type

type cb_update from w_com010_e`cb_update within w_56023_e
end type

type cb_print from w_com010_e`cb_print within w_56023_e
end type

type cb_preview from w_com010_e`cb_preview within w_56023_e
end type

type gb_button from w_com010_e`gb_button within w_56023_e
end type

type cb_excel from w_com010_e`cb_excel within w_56023_e
end type

type dw_head from w_com010_e`dw_head within w_56023_e
integer y = 156
integer height = 184
string dataobject = "d_56023_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_56023_e
integer beginy = 340
integer endy = 340
end type

type ln_2 from w_com010_e`ln_2 within w_56023_e
integer beginy = 344
integer endy = 344
end type

type dw_body from w_com010_e`dw_body within w_56023_e
integer y = 356
integer height = 1684
string dataobject = "d_56023_d01"
end type
...
type dw_print from w_com010_e`dw_print within w_56023_e
end type
