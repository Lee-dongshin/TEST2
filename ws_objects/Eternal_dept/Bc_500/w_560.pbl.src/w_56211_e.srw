...
/* 수정일      : 2002.06.11                                                  */
/*===========================================================================*/
String   ls_seq, ls_slip_bonji, ls_issue_date, ls_bill_no, ls_rep_bungi, ls_ErrMsg,ls_etc_shop_div
long     i, ll_row_count
...
select isnull(etc_shop_div,'$') 
into :ls_etc_shop_div
from  tb_91100_m 
...
elseif ls_etc_shop_div = 'Z' then //보끄레 매출로 처리 
		if is_brand = 'G' then 
				ls_slip_bonji = 'E1'
		elseif is_brand = 'B' then 
				ls_slip_bonji = '41'				
		elseif is_brand = 'L' then 
				ls_slip_bonji = 'H1'				
		elseif is_brand = 'V' then 
				ls_slip_bonji = 'K1'								
		else		
				gf_get_inter_sub('001', is_brand, '1', ls_slip_bonji)
		end if
