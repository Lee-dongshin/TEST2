$PBExportHeader$w_56072_e.srw
$PBExportComments$코스메틱세트상품 등록
forward
global type w_56072_e from w_com010_e
end type
type dw_list from datawindow within w_56072_e
end type
end forward
...
il_rows = dw_list.retrieve(is_brand, is_set_style)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
type cb_close from w_com010_e`cb_close within w_56072_e
end type

type cb_delete from w_com010_e`cb_delete within w_56072_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_56072_e
boolean visible = false
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_56072_e
end type

type cb_update from w_com010_e`cb_update within w_56072_e
end type

type cb_print from w_com010_e`cb_print within w_56072_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_56072_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_56072_e
end type

type cb_excel from w_com010_e`cb_excel within w_56072_e
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_56072_e
integer x = 5
integer y = 168
integer width = 3561
integer height = 160
string dataobject = "d_56072_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_56072_e
integer beginy = 348
integer endy = 348
end type

type ln_2 from w_com010_e`ln_2 within w_56072_e
integer beginy = 352
integer endy = 352
end type

type dw_body from w_com010_e`dw_body within w_56072_e
integer x = 686
integer y = 360
integer width = 2912
integer height = 1640
string dataobject = "d_56072_d01"
end type
...
type dw_print from w_com010_e`dw_print within w_56072_e
integer x = 2066
integer y = 124
end type
...
ll_rows = dw_body.retrieve(is_brand, ls_set_style)
