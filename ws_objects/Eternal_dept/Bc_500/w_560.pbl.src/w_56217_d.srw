$PBExportHeader$w_56217_d.srw
$PBExportComments$판매형태별 매출현황
forward
global type w_56217_d from w_com010_d
end type
type dw_1 from datawindow within w_56217_d
end type
end forward
...
global w_56217_d w_56217_d

type variables
String is_brand, is_FRM_DATE, IS_TO_DATE, is_shop_div, is_shop_cd 
...
il_rows = dw_body.retrieve(is_brand, is_FRM_DATE, IS_TO_DATE, is_shop_div, is_shop_cd)
...
type cb_close from w_com010_d`cb_close within w_56217_d
end type

type cb_delete from w_com010_d`cb_delete within w_56217_d
end type

type cb_insert from w_com010_d`cb_insert within w_56217_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_56217_d
end type

type cb_update from w_com010_d`cb_update within w_56217_d
end type

type cb_print from w_com010_d`cb_print within w_56217_d
end type

type cb_preview from w_com010_d`cb_preview within w_56217_d
end type

type gb_button from w_com010_d`gb_button within w_56217_d
end type

type cb_excel from w_com010_d`cb_excel within w_56217_d
end type

type dw_head from w_com010_d`dw_head within w_56217_d
integer y = 148
integer height = 200
...
type ln_1 from w_com010_d`ln_1 within w_56217_d
integer beginy = 352
integer endy = 352
end type

type ln_2 from w_com010_d`ln_2 within w_56217_d
integer beginy = 356
integer endy = 356
end type

type dw_body from w_com010_d`dw_body within w_56217_d
integer x = 9
integer y = 376
integer width = 3593
integer height = 1668
string dataobject = "d_56217_d01"
...
dw_1.Retrieve(is_brand, is_FRM_DATE, IS_TO_DATE, ls_shop_cd, ls_shop_type, ls_sale_type, ldc_dc_rate, ldc_sale_rate, "N", "Y","%")
...
type dw_print from w_com010_d`dw_print within w_56217_d
integer height = 240
string dataobject = "d_56217_r01"
end type
