$PBExportHeader$w_56113_e.srw
$PBExportComments$입금차액관리
forward
global type w_56113_e from w_com010_e
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_56113_e","0")
end event
...
if is_rpt_chk = "Y" then
	...
	dw_body.DataObject = "d_56113_d01"
	dw_body.SetTransObject(SQLCA)
	dw_print.DataObject = "d_56113_r01"
	dw_print.SetTransObject(SQLCA)	
end if	
...
type cb_close from w_com010_e`cb_close within w_56113_e
end type

type cb_delete from w_com010_e`cb_delete within w_56113_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_56113_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_56113_e
end type

type cb_update from w_com010_e`cb_update within w_56113_e
end type

type cb_print from w_com010_e`cb_print within w_56113_e
end type

type cb_preview from w_com010_e`cb_preview within w_56113_e
end type

type gb_button from w_com010_e`gb_button within w_56113_e
end type

type cb_excel from w_com010_e`cb_excel within w_56113_e
end type

type dw_head from w_com010_e`dw_head within w_56113_e
string dataobject = "d_56113_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_56113_e
end type

type ln_2 from w_com010_e`ln_2 within w_56113_e
end type

type dw_body from w_com010_e`dw_body within w_56113_e
string dataobject = "d_56113_d01"
...
type dw_print from w_com010_e`dw_print within w_56113_e
string dataobject = "d_56113_r01"
end type
