$PBExportHeader$w_56104_d.srw
$PBExportComments$입금예정현황
forward
global type w_56104_d from w_com010_d
end type
end forward
...
if is_rpt_chk = "Y" then
	dw_body.DataObject = "d_56104_d02"
	dw_body.SetTransObject(SQLCA)
	dw_print.DataObject = "d_56104_r02"
	dw_print.SetTransObject(SQLCA)
else	
	dw_body.DataObject = "d_56104_d01"
	dw_body.SetTransObject(SQLCA)
	dw_print.DataObject = "d_56104_r01"
	dw_print.SetTransObject(SQLCA)	
end if	

il_rows = dw_body.retrieve(is_brand,    is_fr_ymd,  is_to_ymd, &
                           is_shop_div, is_shop_cd, is_comm_fg)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_56104_d","0")
end event

type cb_close from w_com010_d`cb_close within w_56104_d
end type

type cb_delete from w_com010_d`cb_delete within w_56104_d
end type

type cb_insert from w_com010_d`cb_insert within w_56104_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_56104_d
end type

type cb_update from w_com010_d`cb_update within w_56104_d
end type

type cb_print from w_com010_d`cb_print within w_56104_d
end type

type cb_preview from w_com010_d`cb_preview within w_56104_d
end type

type gb_button from w_com010_d`gb_button within w_56104_d
end type

type cb_excel from w_com010_d`cb_excel within w_56104_d
end type

type dw_head from w_com010_d`dw_head within w_56104_d
integer y = 160
string dataobject = "d_56104_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_56104_d
integer beginy = 416
integer endy = 416
end type

type ln_2 from w_com010_d`ln_2 within w_56104_d
integer beginy = 420
integer endy = 420
end type

type dw_body from w_com010_d`dw_body within w_56104_d
integer y = 440
integer width = 3607
integer height = 1608
string dataobject = "d_56104_d01"
...
gsv_cd.gs_cd6 = This.GetitemString(row, "REMARK")
...
type dw_print from w_com010_d`dw_print within w_56104_d
string dataobject = "d_56104_r01"
end type
