$PBExportHeader$w_54015_e.srw
$PBExportComments$완불등록(출고팀용)
forward
global type w_54015_e from w_com010_e
end type
type dw_color from datawindow within w_54015_e
end type
type dw_size from datawindow within w_54015_e
end type
end forward
...
il_rows = dw_body.retrieve(is_brand, is_yymmdd, is_shop_cd, is_shop_type, is_add)
IF il_rows > 0 THEN
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_54015_e","0")
end event

type cb_close from w_com010_e`cb_close within w_54015_e
end type

type cb_delete from w_com010_e`cb_delete within w_54015_e
end type

type cb_insert from w_com010_e`cb_insert within w_54015_e
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_54015_e
end type

type cb_update from w_com010_e`cb_update within w_54015_e
end type

type cb_print from w_com010_e`cb_print within w_54015_e
end type

type cb_preview from w_com010_e`cb_preview within w_54015_e
end type

type gb_button from w_com010_e`gb_button within w_54015_e
end type

type cb_excel from w_com010_e`cb_excel within w_54015_e
end type

type dw_head from w_com010_e`dw_head within w_54015_e
string dataobject = "d_54015_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_54015_e
end type

type ln_2 from w_com010_e`ln_2 within w_54015_e
end type

type dw_body from w_com010_e`dw_body within w_54015_e
string dataobject = "d_54015_d01"
end type
...
type dw_print from w_com010_e`dw_print within w_54015_e
integer x = 517
integer y = 188
end type
