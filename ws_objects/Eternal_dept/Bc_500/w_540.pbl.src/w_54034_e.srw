$PBExportHeader$w_54034_e.srw
$PBExportComments$RT/출고요청 업로드
forward
global type w_54034_e from w_com010_e
end type
type cb_copy from commandbutton within w_54034_e
end type
type dw_1 from datawindow within w_54034_e
end type
type cb_1 from commandbutton within w_54034_e
end type
type st_1 from statictext within w_54034_e
end type
type p_1 from picture within w_54034_e
end type
type cb_form from commandbutton within w_54034_e
end type
type hpb_1 from hprogressbar within w_54034_e
end type
end forward
...
String ls_filename, ls_name, ls_path, ls_msg, ls_file_name1, ls_shop_type,ls_chk_style , ls_dc_chk, ls_STYLE, LS_COLOR, LS_SIZE, ls_shop_cd
...
if LL_STYLE_CHK <> 0 then
	messagebox("알림!", STRING(LL_STYLE_CHK, "0000") + "건의 품번이 오류가 포함되어 있습니다! 확인바랍니다!"		)
else 
	hpb_1.Position = 100
	dw_body.SetFocus()		
...
long     ll_sale_price, ll_dc_rate, ll_qty
...
FOR i=1 TO ll_row_count
  	dw_body.selectrow(i,true)	 
		...
		ls_color   	 = dw_body.Getitemstring(i, "color")		
		ls_size   	 = dw_body.Getitemstring(i, "size")				
		ll_qty   	 = dw_body.GetitemNumber(i, "rqst_qty")						
		

	if ll_qty <> 0 then

		
		if is_job_opt = 'R' then
	
				 DECLARE SP_54034_INSERT_R PROCEDURE FOR SP_54034_INSERT_R  
						@yymmdd    = :is_yymmdd,   
						@shop_cd   = :ls_shop_cd,   
						@style     = :ls_style,   
						@color     = :ls_color,   
					 ...
					 EXECUTE SP_54034_INSERT_R;
		else 				 
					 
 				 DECLARE SP_54034_INSERT_O PROCEDURE FOR SP_54034_INSERT_O  
						@yymmdd    = :is_yymmdd,   
						@shop_cd   = :ls_shop_cd,   
						@style     = :ls_style,   
						@color     = :ls_color,   
...
type cb_close from w_com010_e`cb_close within w_54034_e
end type

type cb_delete from w_com010_e`cb_delete within w_54034_e
...
type cb_insert from w_com010_e`cb_insert within w_54034_e
boolean visible = false
string text = "복사"
end type
...
type cb_retrieve from w_com010_e`cb_retrieve within w_54034_e
end type

type cb_update from w_com010_e`cb_update within w_54034_e
end type

type cb_print from w_com010_e`cb_print within w_54034_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_54034_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_54034_e
end type

type cb_excel from w_com010_e`cb_excel within w_54034_e
boolean visible = false
end type

type dw_head from w_com010_e`dw_head within w_54034_e
integer x = 18
integer y = 160
integer width = 3584
integer height = 148
string dataobject = "d_54034_h01"
...
type ln_1 from w_com010_e`ln_1 within w_54034_e
integer beginy = 308
integer endy = 308
end type

type ln_2 from w_com010_e`ln_2 within w_54034_e
integer beginy = 312
integer endy = 312
end type

type dw_body from w_com010_e`dw_body within w_54034_e
integer x = 0
integer y = 464
integer width = 3616
integer height = 1540
string dataobject = "d_54034_d01"
end type
...
type dw_print from w_com010_e`dw_print within w_54034_e
end type
...
xlApp.application.workbooks(1).SaveAs(ls_file_name1 , -4158) //===== 텍스트로 저장된 경로
xlApp.application.workbooks(1).Saved = True
xlApp.Application.Quit
xlApp.DisConnectObject()
Destroy xlApp
...
string text = "<< 확장자 : XLS , 항목 : 매장코드, 매장명, 품번, 칼라, 사이즈, 수량"
...
integer height = 1088
boolean bringtotop = true
string picturename = "C:\eternal_dept\bmp\rt엑셀양식.jpg"
boolean border = true
