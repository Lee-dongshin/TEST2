$PBExportHeader$w_54028_e.srw
$PBExportComments$쇼핑몰완불요청 지시
forward
global type w_54028_e from w_com020_e
end type
type st_info from statictext within w_54028_e
end type
type cb_1 from commandbutton within w_54028_e
end type
type st_qty from statictext within w_54028_e
end type
end forward
...
lw_window = This
gf_open_sheet(lw_window, 'W_54028_s1', '당일 완불작업분 확정')
...
is_terminate = dw_head.GetItemString(1, "terminate")
if IsNull(is_terminate) or Trim(is_terminate) = "" then
   MessageBox(ls_title,"조회기준을 입력하십시요!")
   dw_head.SetFocus()
   dw_head.SetColumn("terminate")
   return false
end if
...
il_rows = dw_list.retrieve(is_brand, is_fr_ymd, is_to_ymd,  is_check, is_self_yn, is_terminate)
dw_body.Reset()
IF il_rows > 0 THEN
   dw_list.SetFocus()
END IF
...
type cb_close from w_com020_e`cb_close within w_54028_e
end type

type cb_delete from w_com020_e`cb_delete within w_54028_e
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_54028_e
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_54028_e
end type

type cb_update from w_com020_e`cb_update within w_54028_e
end type

type cb_print from w_com020_e`cb_print within w_54028_e
boolean visible = false
end type

type cb_preview from w_com020_e`cb_preview within w_54028_e
boolean visible = false
end type

type gb_button from w_com020_e`gb_button within w_54028_e
end type

type cb_excel from w_com020_e`cb_excel within w_54028_e
boolean visible = false
end type

type dw_head from w_com020_e`dw_head within w_54028_e
integer y = 164
integer width = 3566
integer height = 228
string dataobject = "d_54028_h01"
end type
...
type ln_1 from w_com020_e`ln_1 within w_54028_e
integer beginy = 424
integer endy = 424
end type

type ln_2 from w_com020_e`ln_2 within w_54028_e
integer beginy = 428
integer endy = 428
end type

type dw_list from w_com020_e`dw_list within w_54028_e
integer x = 5
integer y = 444
integer width = 2327
integer height = 1576
string dataobject = "d_54028_d01"
...
type dw_body from w_com020_e`dw_body within w_54028_e
integer x = 2354
integer y = 444
integer width = 1253
integer height = 1576
string dataobject = "d_54028_d02"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

type st_1 from w_com020_e`st_1 within w_54028_e
integer x = 2336
integer y = 444
integer height = 1576
end type

type dw_print from w_com020_e`dw_print within w_54028_e
end type
