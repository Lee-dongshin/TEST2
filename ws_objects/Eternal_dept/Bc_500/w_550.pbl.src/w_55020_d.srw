...
type variables
DataWindowChild idw_brand, idw_year, idw_season, idw_shop_div
String is_brand, is_frm_yymm, is_to_yymm, is_year, is_season, is_gubn, is_shop_div, is_shop_type,is_opt_shop_type
...
il_rows = dw_1.retrieve(is_frm_yymm, is_to_yymm, is_shop_div, is_brand, is_year, is_season, is_gubn, is_opt_shop_type)

il_rows = dw_body.retrieve(is_frm_yymm, is_to_yymm, is_shop_div, is_brand, is_year, is_season, is_gubn, is_opt_shop_type)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
dw_print.retrieve(is_frm_yymm, is_to_yymm, "%", is_brand, is_year, is_season, is_gubn, is_opt_shop_type)
...
dw_print.retrieve(is_frm_yymm, is_to_yymm, "%", is_brand, is_year, is_season,is_opt_shop_type)
