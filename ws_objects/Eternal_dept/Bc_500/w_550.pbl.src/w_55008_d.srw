...
String is_brand, is_yyyy, is_year, is_season, is_shop_type, is_opt_view
end variables
...
il_rows = dw_body.retrieve(is_yyyy, is_brand, is_year, is_season, gs_lang, is_shop_type)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
dw_print.retrieve(is_yyyy, is_brand, is_year, is_season, gs_lang, is_shop_type)
