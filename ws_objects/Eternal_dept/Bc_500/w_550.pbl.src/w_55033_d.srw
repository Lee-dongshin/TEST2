$PBExportHeader$w_55033_d.srw
$PBExportComments$입출고 대비 판매율 현황(기간조회용)
forward
global type w_55033_d from w_com010_d
end type
type rb_size from radiobutton within w_55033_d
end type
type rb_style from radiobutton within w_55033_d
end type
type rb_item from radiobutton within w_55033_d
end type
type rb_color from radiobutton within w_55033_d
end type
type st_1 from statictext within w_55033_d
end type
type st_2 from statictext within w_55033_d
end type
type st_3 from statictext within w_55033_d
end type
type st_4 from statictext within w_55033_d
end type
type gb_1 from groupbox within w_55033_d
end type
type mle_1 from multilineedit within w_55033_d
end type
end forward
...
global w_55033_d w_55033_d

type variables
String is_fr_ymd, is_yymmdd, is_brand, is_year, is_season, is_sojae, is_item, is_dep_fg, is_gubun, is_chno_gubun
string is_style_no, is_print_gubun, is_ps_chn, is_ps_except, is_plan_dc, is_ps_reord,is_plan_except, is_saip_yn
...
//	end if	
	...
	if rb_item.checked = true then
		if is_gubun <> "0" then
			dw_body.DataObject = "d_55033_d11"
		else
//			if is_saip_yn = "Y" and is_ps_chn = "K" then
//				dw_body.DataObject = "d_55033_d15a"
//			else
				dw_body.DataObject = "d_55033_d15"
//			end if	
		end if
		dw_body.Object.DataWindow.HorizontalScrollSplit  = 490
   elseif rb_style.checked = true then
		if is_gubun <> "0" then
			dw_body.DataObject = "d_55033_d12"
		else
//			if is_saip_yn = "Y" and is_ps_chn = "K" then
//				dw_body.DataObject = "d_55033_d16a"
//			else
				dw_body.DataObject = "d_55033_d16"
//			end if	
			
		end if
		dw_body.Object.DataWindow.HorizontalScrollSplit  = 1680
   elseif rb_color.checked = true then
		if is_gubun <> "0" then
			dw_body.DataObject = "d_55033_d13"
			dw_body.Object.DataWindow.HorizontalScrollSplit  = 1260
		else
				
//			if is_saip_yn = "Y" and is_ps_chn = "K" then
//				dw_body.DataObject = "d_55033_d17a"
//				dw_body.Object.DataWindow.HorizontalScrollSplit  = 1880
//			else
				dw_body.DataObject = "d_55033_d17"
				dw_body.Object.DataWindow.HorizontalScrollSplit  = 1880
//			end if	
   ...
   elseif rb_size.checked = true	 then
		if is_gubun <> "0" then
			dw_body.DataObject = "d_55033_d14"
		else

			
//			if is_saip_yn = "Y" and is_ps_chn = "K" then
//				dw_body.DataObject = "d_55033_d18a"
//			else
				dw_body.DataObject = "d_55033_d18"
//			end if				
...
//
			...
			if is_saip_yn = "Y" and is_ps_chn = "K" then
				il_rows = dw_body.retrieve(is_fr_ymd, is_yymmdd, is_brand, is_sojae, is_year, is_season, &
									is_item, is_dep_fg, is_gubun, is_chno_gubun, is_style_no, is_ps_except, is_plan_dc, is_ps_reord, is_plan_except,is_saip_yn)
			else
				il_rows = dw_body.retrieve(is_fr_ymd, is_yymmdd, is_brand, is_sojae, is_year, is_season, &
									is_item, is_dep_fg, is_gubun, is_chno_gubun, is_style_no, is_ps_chn, is_ps_except, is_plan_dc, is_ps_reord, is_plan_except)
			end if	
...
is_fr_ymd = Trim(dw_head.GetItemString(1, "fr_ymd")) //Trim(String(dw_head.GetItemDatetime(1, "fr_ymd"), 'yyyymmdd'))
...
is_yymmdd = Trim(dw_head.GetItemString(1, "yymmdd")) //Trim(String(dw_head.GetItemDatetime(1, "yymmdd"), 'yyyymmdd'))
...
event ue_print();if is_print_gubun = "Y"  then 
   ...
   elseif rb_color.checked = true then		 
		//dw_print.DataObject = "d_55033_r17" 		
   elseif rb_size.checked = true	 then	 
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_55033_d","0")
end event
...
type cb_close from w_com010_d`cb_close within w_55033_d
end type

type cb_delete from w_com010_d`cb_delete within w_55033_d
end type

type cb_insert from w_com010_d`cb_insert within w_55033_d
integer x = 677
integer y = 48
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_55033_d
end type

type cb_update from w_com010_d`cb_update within w_55033_d
end type

type cb_print from w_com010_d`cb_print within w_55033_d
boolean visible = false
end type

type cb_preview from w_com010_d`cb_preview within w_55033_d
boolean visible = false
end type

type gb_button from w_com010_d`gb_button within w_55033_d
end type

type cb_excel from w_com010_d`cb_excel within w_55033_d
end type

type dw_head from w_com010_d`dw_head within w_55033_d
integer x = 521
integer y = 152
integer width = 4165
integer height = 384
string dataobject = "d_55033_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_55033_d
integer beginy = 536
integer endy = 536
end type

type ln_2 from w_com010_d`ln_2 within w_55033_d
integer beginy = 540
integer endy = 540
end type

type dw_body from w_com010_d`dw_body within w_55033_d
integer x = 9
integer y = 556
integer width = 3598
integer height = 1440
string dataobject = "d_55033_d01"
...
type dw_print from w_com010_d`dw_print within w_55033_d
integer x = 1573
integer y = 860
...
dw_body.DataObject = "d_55033_d04"
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = "d_55033_r04"
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject = "d_55033_d02"
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = "d_55033_r02"
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject = "d_55033_d01"
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = "d_55033_r01"
dw_print.SetTransObject(SQLCA)
...
dw_body.DataObject = "d_55033_d03"
dw_body.SetTransObject(SQLCA)
dw_print.DataObject = "d_55033_r03"
dw_print.SetTransObject(SQLCA)
