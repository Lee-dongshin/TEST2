...
String is_diff_opt, is_plan_opt, is_chi_opt, is_style, is_sale_gubn, is_shop_div,  is_amount_opt, is_shop_gubn
integer ii_tab_chk
end variables
...
if dw_body.visible = true then
	il_rows =  dw_body.retrieve(is_fr_ymd, is_to_ymd, is_brand, is_year, is_season, is_sojae, is_item, is_chno_opt, is_chi_opt, "%", is_plan_opt, is_sale_opt, is_style, is_dep_except,is_sale_gubn)
