$PBExportHeader$w_55005_d.srw
$PBExportComments$매장별 손익보고서
forward
global type w_55005_d from w_com010_d
end type
type rb_shop from radiobutton within w_55005_d
end type
type rb_sale from radiobutton within w_55005_d
end type
type rb_season from radiobutton within w_55005_d
end type
type rb_sale_season from radiobutton within w_55005_d
end type
type rb_season_sale from radiobutton within w_55005_d
end type
type rb_shop_day from radiobutton within w_55005_d
end type
type rb_make_type from radiobutton within w_55005_d
end type
type rb_shopseason from radiobutton within w_55005_d
end type
type rb_shop_month from radiobutton within w_55005_d
end type
type rb_yymmseason from radiobutton within w_55005_d
end type
type rb_shopseasonyymm from radiobutton within w_55005_d
end type
type rb_yymmddseason from radiobutton within w_55005_d
end type
type gb_1 from groupbox within w_55005_d
end type
end forward
...
il_rows = dw_body.retrieve(is_brand, is_fr_yymmdd, is_to_yymmdd, is_year, is_season, &
									is_shop_div, is_shop_cd, is_sale_type1, is_sale_type2, is_sale_type3, is_sale_type4, is_sale_type9, is_except_eshop, is_dotcom, is_opt_goods)
...
type cb_close from w_com010_d`cb_close within w_55005_d
end type

type cb_delete from w_com010_d`cb_delete within w_55005_d
end type

type cb_insert from w_com010_d`cb_insert within w_55005_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_55005_d
end type

type cb_update from w_com010_d`cb_update within w_55005_d
end type

type cb_print from w_com010_d`cb_print within w_55005_d
end type

type cb_preview from w_com010_d`cb_preview within w_55005_d
end type

type gb_button from w_com010_d`gb_button within w_55005_d
integer x = 526
integer width = 3077
end type

type cb_excel from w_com010_d`cb_excel within w_55005_d
end type

type dw_head from w_com010_d`dw_head within w_55005_d
integer x = 526
integer width = 3031
integer height = 316
string dataobject = "d_55005_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_55005_d
integer beginy = 744
integer endy = 744
end type

type ln_2 from w_com010_d`ln_2 within w_55005_d
integer beginy = 748
integer endy = 748
end type

type dw_body from w_com010_d`dw_body within w_55005_d
integer y = 764
integer width = 3570
integer height = 1244
string dataobject = "d_55005_d01"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

type dw_print from w_com010_d`dw_print within w_55005_d
integer x = 814
integer y = 888
string dataobject = "d_55005_r01"
end type
