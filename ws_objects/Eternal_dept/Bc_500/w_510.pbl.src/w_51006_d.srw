$PBExportHeader$w_51006_d.srw
$PBExportComments$판매사원 휴무계획현황
forward
global type w_51006_d from w_com000
end type
type dw_head from u_dw within w_51006_d
end type
type ln_1 from line within w_51006_d
end type
type ln_2 from line within w_51006_d
end type
type dw_list from u_dw within w_51006_d
end type
type dw_body from u_dw within w_51006_d
end type
type st_1 from u_st within w_51006_d
end type
type dw_print from u_dw within w_51006_d
end type
end forward
...
string is_brand, is_yymm, is_shop_cd ,is_person_id
DataWindowChild idw_person_id
...
dw_body.Reset()
il_rows = dw_list.retrieve(is_brand, is_shop_cd)
IF il_rows > 0 THEN
   dw_list.SetFocus()
...
dw_body.Object.DataWindow.HorizontalScrollSplit  = 1210
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_51006_d","0")
end event

type cb_close from w_com000`cb_close within w_51006_d
integer taborder = 110
end type

type cb_delete from w_com000`cb_delete within w_51006_d
boolean visible = false
integer x = 1079
integer taborder = 60
end type

type cb_insert from w_com000`cb_insert within w_51006_d
boolean visible = false
integer x = 736
integer taborder = 50
...
type cb_retrieve from w_com000`cb_retrieve within w_51006_d
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_51006_d
boolean visible = false
integer taborder = 100
end type

type cb_print from w_com000`cb_print within w_51006_d
integer x = 1422
integer taborder = 70
end type

type cb_preview from w_com000`cb_preview within w_51006_d
integer x = 1765
integer taborder = 80
end type

type gb_button from w_com000`gb_button within w_51006_d
integer taborder = 0
end type

type cb_excel from w_com000`cb_excel within w_51006_d
integer x = 2107
integer taborder = 90
end type
...
il_rows = dw_body.retrieve(is_brand, ls_yymm, is_shop_cd, is_person_id)
