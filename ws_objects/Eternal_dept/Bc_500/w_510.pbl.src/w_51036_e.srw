$PBExportHeader$w_51036_e.srw
$PBExportComments$담당별 인벤트 승인 및 반려
forward
global type w_51036_e from w_com010_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_51036_d","0")
end event
...
//		dw_body.Setitem(i, "no", string(ld_max_id + 1, '0000'))
   ...
   ELSEIF idw_status = DataModified! THEN		/* Modify Record */
		if (dw_body.getitemstring(i,'sing_gubn') = 'Y' or dw_body.getitemstring(i,'sing_gubn') = 'N') then
			if dw_body.getitemstring(i,'sing_ymd') = '' or isnull(dw_body.getitemstring(i,'sing_ymd')) then
				dw_body.setitem(i,'sing_ymd', ls_date)  
			end if
		end if
		if dw_body.getitemstring(i,'accept_gubn') = 'Y' then
...
type cb_close from w_com010_d`cb_close within w_51036_e
end type

type cb_delete from w_com010_d`cb_delete within w_51036_e
end type

type cb_insert from w_com010_d`cb_insert within w_51036_e
boolean enabled = false
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_51036_e
end type

type cb_update from w_com010_d`cb_update within w_51036_e
boolean visible = true
end type

type cb_print from w_com010_d`cb_print within w_51036_e
end type

type cb_preview from w_com010_d`cb_preview within w_51036_e
end type

type gb_button from w_com010_d`gb_button within w_51036_e
end type

type cb_excel from w_com010_d`cb_excel within w_51036_e
end type

type dw_head from w_com010_d`dw_head within w_51036_e
integer x = 9
integer y = 160
integer width = 3584
integer height = 212
string dataobject = "d_51036_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_51036_e
integer beginy = 380
integer endy = 380
end type

type ln_2 from w_com010_d`ln_2 within w_51036_e
integer beginy = 384
integer endy = 384
end type

type dw_body from w_com010_d`dw_body within w_51036_e
integer y = 400
integer width = 3598
integer height = 1612
string dataobject = "d_51036_d01"
...
type dw_print from w_com010_d`dw_print within w_51036_e
integer x = 2601
integer y = 152
end type
