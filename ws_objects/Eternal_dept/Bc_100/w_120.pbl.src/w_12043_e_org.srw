$PBExportHeader$w_12043_e_org.srw
$PBExportComments$품번별 상품태깅정보 입력
forward
global type w_12043_e_org from w_com020_e
end type
end forward

global type w_12043_e_org from w_com020_e
end type
global w_12043_e_org w_12043_e_org
...
on w_12043_e_org.create
call super::create
end on

on w_12043_e_org.destroy
call super::destroy
...
type cb_close from w_com020_e`cb_close within w_12043_e_org
end type

type cb_delete from w_com020_e`cb_delete within w_12043_e_org
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_12043_e_org
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_12043_e_org
end type

type cb_update from w_com020_e`cb_update within w_12043_e_org
end type

type cb_print from w_com020_e`cb_print within w_12043_e_org
boolean visible = false
end type

type cb_preview from w_com020_e`cb_preview within w_12043_e_org
boolean visible = false
end type

type gb_button from w_com020_e`gb_button within w_12043_e_org
end type

type cb_excel from w_com020_e`cb_excel within w_12043_e_org
boolean visible = false
end type

type dw_head from w_com020_e`dw_head within w_12043_e_org
...
//	idw_brand.Filter( )
//else	
//	ls_filter_str = "inter_cd not in ( 'B','F','H','L','P','R','F','T','U','W', 'N','E,'M','O','D','Y','A') " 
//	idw_brand.SetFilter(ls_filter_str)
//	idw_brand.Filter( )	
//	
//end if

	ls_filter_str = "inter_cd not in ( 'B','F', 'H','L','P') " 
//	ls_filter_str = "inter_cd not in ( 'B','F','H','L','P','R','F','T','U','W', 'N','E,'M','O','D','Y','A') " 
	idw_brand.SetFilter(ls_filter_str)
	idw_brand.Filter( )	
	
	
	ls_filter_str = "inter_cd not in ( 'R','F','T','U','W') " 
//	ls_filter_str = "inter_cd not in ( 'B','F','H','L','P','R','F','T','U','W', 'N','E,'M','O','D','Y','A') " 
	idw_brand.SetFilter(ls_filter_str)
	idw_brand.Filter( )	
...
type ln_1 from w_com020_e`ln_1 within w_12043_e_org
end type

type ln_2 from w_com020_e`ln_2 within w_12043_e_org
end type

type dw_list from w_com020_e`dw_list within w_12043_e_org
integer x = 9
integer y = 444
integer width = 1536
integer height = 1556
...
String ls_style , ls_chno, ls_year, ls_season, ls_item_lrg_class, ls_item_mid_class, ls_null, ls_filter_str, ls_auto
Long   ll_row,  ll_rows
...
type dw_body from w_com020_e`dw_body within w_12043_e_org
integer x = 1563
integer y = 440
integer width = 2030
integer height = 1560
...
type st_1 from w_com020_e`st_1 within w_12043_e_org
integer x = 1550
end type

type dw_print from w_com020_e`dw_print within w_12043_e_org
end type
