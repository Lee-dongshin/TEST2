$PBExportHeader$w_12044_e.srw
$PBExportComments$품번별 상품태깅정보 입력
forward
global type w_12044_e from w_com020_e
end type
end forward

global type w_12044_e from w_com020_e
end type
global w_12044_e w_12044_e
...
type cb_close from w_com020_e`cb_close within w_12044_e
end type

type cb_delete from w_com020_e`cb_delete within w_12044_e
boolean visible = false
end type

type cb_insert from w_com020_e`cb_insert within w_12044_e
boolean visible = false
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_12044_e
end type

type cb_update from w_com020_e`cb_update within w_12044_e
end type

type cb_print from w_com020_e`cb_print within w_12044_e
boolean visible = false
end type

type cb_preview from w_com020_e`cb_preview within w_12044_e
boolean visible = false
end type

type gb_button from w_com020_e`gb_button within w_12044_e
end type

type cb_excel from w_com020_e`cb_excel within w_12044_e
boolean visible = false
end type

type dw_head from w_com020_e`dw_head within w_12044_e
...
type ln_1 from w_com020_e`ln_1 within w_12044_e
end type

type ln_2 from w_com020_e`ln_2 within w_12044_e
end type

type dw_list from w_com020_e`dw_list within w_12044_e
integer x = 9
integer y = 444
integer width = 2162
integer height = 1556
...
type dw_body from w_com020_e`dw_body within w_12044_e
integer x = 2181
integer y = 440
integer width = 1413
integer height = 1560
...
type st_1 from w_com020_e`st_1 within w_12044_e
integer x = 2167
end type

type dw_print from w_com020_e`dw_print within w_12044_e
end type
