$PBExportHeader$w_12a17_e.srw
$PBExportComments$후가공입력
forward
global type w_12a17_e from w_com020_e
end type
end forward
...
type cb_close from w_com020_e`cb_close within w_12a17_e
end type

type cb_delete from w_com020_e`cb_delete within w_12a17_e
end type

type cb_insert from w_com020_e`cb_insert within w_12a17_e
boolean visible = false
boolean enabled = true
string text = "신규(&A)"
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_12a17_e
end type

type cb_update from w_com020_e`cb_update within w_12a17_e
end type

type cb_print from w_com020_e`cb_print within w_12a17_e
end type

type cb_preview from w_com020_e`cb_preview within w_12a17_e
end type

type gb_button from w_com020_e`gb_button within w_12a17_e
end type

type cb_excel from w_com020_e`cb_excel within w_12a17_e
end type

type dw_head from w_com020_e`dw_head within w_12a17_e
integer x = 14
integer y = 152
integer width = 3584
integer height = 108
string dataobject = "d_12a17_h01"
end type
...
type ln_1 from w_com020_e`ln_1 within w_12a17_e
integer beginy = 260
integer endy = 260
end type

type ln_2 from w_com020_e`ln_2 within w_12a17_e
integer beginy = 264
integer endy = 264
end type

type dw_list from w_com020_e`dw_list within w_12a17_e
integer x = 5
integer y = 280
integer width = 681
integer height = 1720
string dataobject = "D_12a17_D01"
end type
...
type dw_body from w_com020_e`dw_body within w_12a17_e
integer x = 713
integer y = 268
integer width = 3429
integer height = 1940
string dataobject = "D_12a17_D02"
...
type st_1 from w_com020_e`st_1 within w_12a17_e
integer x = 690
integer y = 276
integer height = 1752
end type

type dw_print from w_com020_e`dw_print within w_12a17_e
integer x = 3031
integer y = 248
