$PBExportHeader$w_12010_e_20130724.srw
$PBExportComments$작업 지시서
forward
global type w_12010_e_20130724 from w_com010_e
end type
type cb_del_all from commandbutton within w_12010_e_20130724
end type
type dw_master from datawindow within w_12010_e_20130724
end type
type dw_spec from datawindow within w_12010_e_20130724
end type
type dw_detail from datawindow within w_12010_e_20130724
end type
type cb_2 from commandbutton within w_12010_e_20130724
end type
type dw_label from datawindow within w_12010_e_20130724
end type
type tab_1 from tab within w_12010_e_20130724
end type
...
type cb_sketch from commandbutton within w_12010_e_20130724
end type
type cb_copy_style from commandbutton within w_12010_e_20130724
end type
type dw_7 from datawindow within w_12010_e_20130724
end type
type dw_copy_style from datawindow within w_12010_e_20130724
end type
type dw_9 from datawindow within w_12010_e_20130724
end type
type dw_10 from datawindow within w_12010_e_20130724
end type
type cbx_pop from checkbox within w_12010_e_20130724
end type
end forward
...
global w_12010_e_20130724 w_12010_e_20130724
...
String  is_size[], is_zsojae, is_zitem, is_ctrl_brand, is_out_seq_chn, is_make_ymd
Boolean ib_read[]
...
/* 수정일      : 2002.01.08                                                  */
/*===========================================================================*/
String     ls_style, ls_chno, ls_emp_nm, ls_dept, ls_fr_style, ls_fr_chno, ls_mat_cd, ls_cust_nm
Boolean    lb_check 
DataStore  lds_Source
...
datetime ld_datetime
String   ls_mat_cd, ls_mat_nm, ls_mat_nm_chk, ls_ErrMsg, ls_flag, ls_mat_fg, ls_brand
...
type cb_close from w_com010_e`cb_close within w_12010_e_20130724
integer taborder = 140
end type

type cb_delete from w_com010_e`cb_delete within w_12010_e_20130724
integer x = 919
integer taborder = 90
end type

type cb_insert from w_com010_e`cb_insert within w_12010_e_20130724
integer x = 576
integer taborder = 70
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_12010_e_20130724
end type

type cb_update from w_com010_e`cb_update within w_12010_e_20130724
integer taborder = 130
end type

type cb_print from w_com010_e`cb_print within w_12010_e_20130724
integer x = 1262
...
type cb_preview from w_com010_e`cb_preview within w_12010_e_20130724
integer x = 1605
...
type gb_button from w_com010_e`gb_button within w_12010_e_20130724
end type

type cb_excel from w_com010_e`cb_excel within w_12010_e_20130724
...
type dw_head from w_com010_e`dw_head within w_12010_e_20130724
integer width = 3561
integer height = 148
...
type ln_1 from w_com010_e`ln_1 within w_12010_e_20130724
integer beginy = 328
integer endy = 328
end type

type ln_2 from w_com010_e`ln_2 within w_12010_e_20130724
integer beginy = 332
integer endy = 332
end type

type dw_body from w_com010_e`dw_body within w_12010_e_20130724
boolean visible = false
integer x = 5431
integer y = 684
integer width = 489
...
type dw_print from w_com010_e`dw_print within w_12010_e_20130724
