$PBExportHeader$w_11010_e.srw
$PBExportComments$시즌별총괄 매출계획
forward
global type w_11010_e from w_com010_e
end type
type dw_1 from datawindow within w_11010_e
end type
type dw_2 from datawindow within w_11010_e
end type
type st_1 from statictext within w_11010_e
end type
type em_seq from editmask within w_11010_e
end type
type cb_copy from commandbutton within w_11010_e
end type
type dw_3 from datawindow within w_11010_e
end type
type gb_1 from groupbox within w_11010_e
end type
end forward
...
type cb_close from w_com010_e`cb_close within w_11010_e
integer taborder = 120
end type

type cb_delete from w_com010_e`cb_delete within w_11010_e
boolean visible = false
integer taborder = 70
end type

type cb_insert from w_com010_e`cb_insert within w_11010_e
integer taborder = 60
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_11010_e
end type

type cb_update from w_com010_e`cb_update within w_11010_e
integer taborder = 110
end type

type cb_print from w_com010_e`cb_print within w_11010_e
boolean visible = false
integer taborder = 80
end type

type cb_preview from w_com010_e`cb_preview within w_11010_e
boolean visible = false
integer taborder = 90
end type

type gb_button from w_com010_e`gb_button within w_11010_e
end type

type cb_excel from w_com010_e`cb_excel within w_11010_e
boolean visible = false
integer taborder = 100
end type

type dw_head from w_com010_e`dw_head within w_11010_e
integer height = 160
string dataobject = "d_11010_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_11010_e
integer beginy = 352
integer endy = 352
end type

type ln_2 from w_com010_e`ln_2 within w_11010_e
integer beginy = 356
integer endy = 356
end type

type dw_body from w_com010_e`dw_body within w_11010_e
integer y = 364
integer width = 2683
integer height = 352
string dataobject = "d_11010_d03"
end type
...
type dw_print from w_com010_e`dw_print within w_11010_e
end type
