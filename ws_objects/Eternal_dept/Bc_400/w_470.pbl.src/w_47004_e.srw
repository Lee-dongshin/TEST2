$PBExportHeader$w_47004_e.srw
$PBExportComments$반품처리
forward
global type w_47004_e from w_com010_e
end type
end forward
	...
	if li_sale_qty <> 0 and ls_sale_yn = "Y" and ls_proc_stat =  "02" and ls_rtrn_stat = "01" then	
	 ...
	 DECLARE sp_47003_p02 PROCEDURE FOR sp_47003_p02  
		 ...
		 EXECUTE sp_47003_p02 ;
 		 fetch   sp_47003_p02  into :ls_sale_ymd, :ldc_sale_price, :ls_rtrn_no, :ls_r_no, :ls_ok, :ls_r_shop_type;
		 CLOSE   sp_47003_p02 ;
...
type cb_close from w_com010_e`cb_close within w_47004_e
end type

type cb_delete from w_com010_e`cb_delete within w_47004_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_47004_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_47004_e
end type

type cb_update from w_com010_e`cb_update within w_47004_e
integer width = 521
string text = "반품처리/저장(&S)"
end type

type cb_print from w_com010_e`cb_print within w_47004_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_47004_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_47004_e
end type

type cb_excel from w_com010_e`cb_excel within w_47004_e
end type

type dw_head from w_com010_e`dw_head within w_47004_e
integer y = 156
integer height = 380
string dataobject = "d_47004_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_47004_e
integer beginy = 540
integer endy = 540
end type

type ln_2 from w_com010_e`ln_2 within w_47004_e
integer beginy = 544
integer endy = 544
end type

type dw_body from w_com010_e`dw_body within w_47004_e
integer y = 568
integer height = 1472
string dataobject = "d_47004_D01"
...
type dw_print from w_com010_e`dw_print within w_47004_e
end type
