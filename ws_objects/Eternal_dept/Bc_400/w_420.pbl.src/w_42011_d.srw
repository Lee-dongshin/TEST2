$PBExportHeader$w_42011_d.srw
$PBExportComments$출고합계출력
forward
global type w_42011_d from w_com020_d
end type
type cb_print1 from commandbutton within w_42011_d
end type
type cbx_a4 from checkbox within w_42011_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_42011_d","0")
end event
...
type cb_close from w_com020_d`cb_close within w_42011_d
end type

type cb_delete from w_com020_d`cb_delete within w_42011_d
end type

type cb_insert from w_com020_d`cb_insert within w_42011_d
end type

type cb_retrieve from w_com020_d`cb_retrieve within w_42011_d
end type

type cb_update from w_com020_d`cb_update within w_42011_d
end type

type cb_print from w_com020_d`cb_print within w_42011_d
end type

type cb_preview from w_com020_d`cb_preview within w_42011_d
boolean visible = false
end type

type gb_button from w_com020_d`gb_button within w_42011_d
end type

type cb_excel from w_com020_d`cb_excel within w_42011_d
end type

type dw_head from w_com020_d`dw_head within w_42011_d
integer y = 144
integer height = 372
string dataobject = "d_42011_h01"
end type
...
type ln_1 from w_com020_d`ln_1 within w_42011_d
integer beginy = 520
integer endy = 520
end type

type ln_2 from w_com020_d`ln_2 within w_42011_d
integer beginy = 524
integer endy = 524
end type

type dw_list from w_com020_d`dw_list within w_42011_d
integer x = 14
integer y = 540
integer width = 933
integer height = 1500
string dataobject = "d_42011_d01"
end type
...
il_rows = dw_body.retrieve(is_brand, is_yymmdd, is_shop_cd_st, is_shop_cd_ed, is_house_cd, &
									is_jup_gubn, is_out_type, il_rqst_chno, il_work_no, is_gubun)
...
type dw_body from w_com020_d`dw_body within w_42011_d
integer x = 965
integer y = 536
integer width = 2633
integer height = 1504
string dataobject = "d_42011_d02"
end type
...
type st_1 from w_com020_d`st_1 within w_42011_d
integer x = 951
integer y = 540
integer height = 1500
end type

type dw_print from w_com020_d`dw_print within w_42011_d
integer x = 50
integer y = 192
integer width = 2281
integer height = 440
