$PBExportHeader$w_43015_e_old.srw
$PBExportComments$매장실사등록
forward
global type w_43015_e_old from w_com010_e
end type
type dw_color from datawindow within w_43015_e_old
end type
type dw_size from datawindow within w_43015_e_old
end type
end forward
...
global w_43015_e_old w_43015_e_old

type variables
DataWindowChild idw_brand,idw_color,idw_size,idw_shop_type
string is_brand, is_yymmdd, is_shop_cd,is_silsa_emp,is_file_nm, is_shop_type


end variables

on w_43015_e_old.create
int iCurrent
call super::create
...
if LenA(is_file_nm) > 0 then
		...
		MEssagebox("오류확인", "총" + "" + string(il_rows) + "" + "건중 " + "" +  string(li_cnt_err) + "" + "개의 잘못된 데이터가 있습니다!" )
			...
			il_rows = dw_body.retrieve(is_brand, is_shop_cd, is_shop_type,is_yymmdd, is_silsa_emp )
		IF il_rows > 0 THEN
			dw_body.SetFocus()
...
FOR i=1 TO ll_row_count
   ...
   IF idw_status = NewModified! THEN				/* New Record */
      ...
      ls_style = dw_body.getitemstring(i, "style")
	   ...
	   DW_BODY.SETITEM(I, "shop_type" , dw_head.getitemstring(1, "shop_type"))
...
type cb_close from w_com010_e`cb_close within w_43015_e_old
end type

type cb_delete from w_com010_e`cb_delete within w_43015_e_old
end type

type cb_insert from w_com010_e`cb_insert within w_43015_e_old
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_43015_e_old
end type

type cb_update from w_com010_e`cb_update within w_43015_e_old
end type

type cb_print from w_com010_e`cb_print within w_43015_e_old
end type

type cb_preview from w_com010_e`cb_preview within w_43015_e_old
end type

type gb_button from w_com010_e`gb_button within w_43015_e_old
end type

type cb_excel from w_com010_e`cb_excel within w_43015_e_old
end type

type dw_head from w_com010_e`dw_head within w_43015_e_old
integer y = 160
integer height = 292
...
type ln_1 from w_com010_e`ln_1 within w_43015_e_old
integer beginy = 468
integer endy = 468
end type

type ln_2 from w_com010_e`ln_2 within w_43015_e_old
integer beginy = 472
integer endy = 472
end type

type dw_body from w_com010_e`dw_body within w_43015_e_old
integer x = 14
integer y = 484
integer width = 3557
integer height = 1552
...
type dw_print from w_com010_e`dw_print within w_43015_e_old
integer x = 2510
integer y = 1464
end type
