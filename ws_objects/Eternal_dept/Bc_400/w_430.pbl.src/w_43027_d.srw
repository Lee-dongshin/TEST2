$PBExportHeader$w_43027_d.srw
$PBExportComments$매장창고재고현황조회
forward
global type w_43027_d from w_com010_d
end type
type rb_1 from radiobutton within w_43027_d
end type
type rb_2 from radiobutton within w_43027_d
end type
type rb_3 from radiobutton within w_43027_d
end type
type rb_4 from radiobutton within w_43027_d
end type
type rb_5 from radiobutton within w_43027_d
end type
type rb_6 from radiobutton within w_43027_d
end type
type gb_1 from groupbox within w_43027_d
end type
end forward
...
string  is_color, is_size, is_class, is_opt_chi,is_style
end variables
...
il_rows = dw_body.retrieve(is_yymmdd, is_brand, is_house_cd, is_year, is_season, is_sojae, &
          is_item, is_style_no, is_chno, is_color,is_size, ls_option, is_opt_chi)
...
type cb_close from w_com010_d`cb_close within w_43027_d
end type

type cb_delete from w_com010_d`cb_delete within w_43027_d
end type

type cb_insert from w_com010_d`cb_insert within w_43027_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_43027_d
end type

type cb_update from w_com010_d`cb_update within w_43027_d
end type

type cb_print from w_com010_d`cb_print within w_43027_d
end type

type cb_preview from w_com010_d`cb_preview within w_43027_d
end type

type gb_button from w_com010_d`gb_button within w_43027_d
end type

type cb_excel from w_com010_d`cb_excel within w_43027_d
end type

type dw_head from w_com010_d`dw_head within w_43027_d
integer y = 156
integer width = 2715
integer height = 392
...
type ln_1 from w_com010_d`ln_1 within w_43027_d
integer beginx = 5
integer beginy = 548
integer endx = 3625
integer endy = 548
...
type ln_2 from w_com010_d`ln_2 within w_43027_d
integer beginy = 552
integer endy = 552
end type

type dw_body from w_com010_d`dw_body within w_43027_d
integer x = 14
integer y = 560
integer height = 1472
...
type dw_print from w_com010_d`dw_print within w_43027_d
integer x = 1650
integer y = 1052
integer width = 1280
integer height = 556
