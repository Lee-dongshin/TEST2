...
type p_2 from picture within w_menu01
end type
type p_1 from picture within w_menu01
end type
...
this.Control[iCurrent+4]=this.lv_1
this.Control[iCurrent+5]=this.st_var
end on
...
inv_resize.of_Register(p_2, "FixedToBottom")
