$PBExportHeader$w_mesage_d14.srw
$PBExportComments$중국라벨확인
forward
global type w_mesage_d14 from w_com010_d
end type
end forward
...
global w_mesage_d14 w_mesage_d14
...
on w_mesage_d14.create
call super::create
end on

on w_mesage_d14.destroy
call super::destroy
end on
...
type cb_close from w_com010_d`cb_close within w_mesage_d14
boolean visible = false
end type

type cb_delete from w_com010_d`cb_delete within w_mesage_d14
end type

type cb_insert from w_com010_d`cb_insert within w_mesage_d14
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_mesage_d14
boolean visible = false
end type

type cb_update from w_com010_d`cb_update within w_mesage_d14
integer x = 631
integer y = 40
end type

type cb_print from w_com010_d`cb_print within w_mesage_d14
boolean visible = false
end type

type cb_preview from w_com010_d`cb_preview within w_mesage_d14
boolean visible = false
end type

type gb_button from w_com010_d`gb_button within w_mesage_d14
boolean visible = false
integer x = 617
integer y = 4
end type

type cb_excel from w_com010_d`cb_excel within w_mesage_d14
boolean visible = false
end type

type dw_head from w_com010_d`dw_head within w_mesage_d14
boolean visible = false
integer x = 745
integer width = 2811
end type

type ln_1 from w_com010_d`ln_1 within w_mesage_d14
boolean visible = false
end type

type ln_2 from w_com010_d`ln_2 within w_mesage_d14
boolean visible = false
end type

type dw_body from w_com010_d`dw_body within w_mesage_d14
integer x = 0
integer y = 0
integer width = 791
integer height = 960
string dataobject = "d_message_014"
boolean minbox = true
end type
...
type dw_print from w_com010_d`dw_print within w_mesage_d14
integer x = 690
integer y = 520
end type
