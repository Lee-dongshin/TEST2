$PBExportHeader$w_31014_d.srw
$PBExportComments$QC 등록 현황
forward
global type w_31014_d from w_com000
end type
type dw_head from u_dw within w_31014_d
end type
type ln_1 from line within w_31014_d
end type
type ln_2 from line within w_31014_d
end type
type dw_body from u_dw within w_31014_d
end type
type dw_print from u_dw within w_31014_d
end type
end forward
...
type variables
string is_brand, is_year, is_season, is_item, is_opt
...
il_rows = dw_body.retrieve(is_brand, is_year, is_season, is_item, is_opt)
IF il_rows > 0 THEN
   dw_body.SetFocus()
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_31014_d","0")
end event

type cb_close from w_com000`cb_close within w_31014_d
integer taborder = 100
end type

type cb_delete from w_com000`cb_delete within w_31014_d
boolean visible = false
integer x = 1083
integer taborder = 50
end type

type cb_insert from w_com000`cb_insert within w_31014_d
boolean visible = false
integer x = 741
integer taborder = 40
end type

type cb_retrieve from w_com000`cb_retrieve within w_31014_d
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_31014_d
boolean visible = false
integer taborder = 90
end type

type cb_print from w_com000`cb_print within w_31014_d
integer x = 1426
integer taborder = 60
end type

type cb_preview from w_com000`cb_preview within w_31014_d
integer x = 1769
integer taborder = 70
end type

type gb_button from w_com000`gb_button within w_31014_d
integer taborder = 0
end type

type cb_excel from w_com000`cb_excel within w_31014_d
integer x = 2112
end type
