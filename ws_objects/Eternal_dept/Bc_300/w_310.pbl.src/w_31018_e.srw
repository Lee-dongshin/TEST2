$PBExportHeader$w_31018_e.srw
$PBExportComments$검사결과보고서
forward
global type w_31018_e from w_com020_e
end type
type dw_2 from datawindow within w_31018_e
end type
type dw_3 from datawindow within w_31018_e
end type
type dw_1 from datawindow within w_31018_e
end type
end forward
...
type cb_close from w_com020_e`cb_close within w_31018_e
end type

type cb_delete from w_com020_e`cb_delete within w_31018_e
end type

type cb_insert from w_com020_e`cb_insert within w_31018_e
end type

type cb_retrieve from w_com020_e`cb_retrieve within w_31018_e
end type

type cb_update from w_com020_e`cb_update within w_31018_e
end type

type cb_print from w_com020_e`cb_print within w_31018_e
end type

type cb_preview from w_com020_e`cb_preview within w_31018_e
end type

type gb_button from w_com020_e`gb_button within w_31018_e
end type

type cb_excel from w_com020_e`cb_excel within w_31018_e
end type

type dw_head from w_com020_e`dw_head within w_31018_e
integer y = 156
integer height = 124
...
type ln_1 from w_com020_e`ln_1 within w_31018_e
integer beginy = 284
integer endy = 284
end type

type ln_2 from w_com020_e`ln_2 within w_31018_e
integer beginy = 288
integer endy = 288
end type

type dw_list from w_com020_e`dw_list within w_31018_e
integer y = 300
integer width = 654
integer height = 1688
...
type dw_body from w_com020_e`dw_body within w_31018_e
integer x = 709
integer y = 296
integer width = 2903
integer height = 1696
...
type st_1 from w_com020_e`st_1 within w_31018_e
...
type dw_print from w_com020_e`dw_print within w_31018_e
integer y = 300
...
CHOOSE CASE dwo.name
	...
	CASE "b_del"	     //  Popup 검색창이 존재하는 항목 
		ll_row = dw_3.getrow()
		idw_status = dw_3.GetItemStatus(ll_row, 0, Primary!)
