$PBExportHeader$w_31031_d.srw
$PBExportComments$입고 예정 현황(CALENDAR)
forward
global type w_31031_d from w_com010_d
end type
type cbx_1 from checkbox within w_31031_d
end type
end forward
...
global w_31031_d w_31031_d

type variables
DataWindowChild idw_brand, idw_season, idw_make_type, idw_sojae, idw_country_cd, idw_jup_gubn, idw_item

String is_bill_dt, is_brand, is_year, is_season, is_make_type, is_sojae, is_country_cd, is_jup_gubn, is_cust_cd, is_style, is_ing_gubn
string is_dlvy_fr, is_dlvy_to, is_out_seq, is_out_seq2, is_mis_gbn, is_reorder, is_chn_gbn, is_chn_exp, is_item, is_fr_yymmdd, is_to_yymmdd
...
IF Trigger Event ue_keycheck('1') = FALSE THEN RETURN
	...
	il_rows = dw_body.retrieve(is_brand, is_year, is_season, is_sojae, is_item, is_fr_yymmdd, is_to_yymmdd, is_make_type, is_country_cd, is_cust_cd, is_style, is_out_seq2, 'T', is_ing_gubn)
...
is_ing_gubn  = dw_head.GetitemString(1,"status")
...
ls_datetime = String(ld_datetime, "yyyy/mm/dd-hh:mm:ss")
	...
	dw_print.object.t_yymm.text = String(is_fr_yymmdd, '@@@@/@@/@@') + " - " + String(is_to_yymmdd, '@@@@/@@/@@')
...
dw_print.retrieve(is_brand, is_year, is_season, is_sojae, is_item, is_fr_yymmdd, is_to_yymmdd, is_make_type, is_country_cd, is_cust_cd, is_style, is_out_seq2, 'T' , is_ing_gubn)
...
type cb_close from w_com010_d`cb_close within w_31031_d
end type

type cb_delete from w_com010_d`cb_delete within w_31031_d
end type

type cb_insert from w_com010_d`cb_insert within w_31031_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_31031_d
end type

type cb_update from w_com010_d`cb_update within w_31031_d
end type

type cb_print from w_com010_d`cb_print within w_31031_d
end type

type cb_preview from w_com010_d`cb_preview within w_31031_d
end type

type gb_button from w_com010_d`gb_button within w_31031_d
end type

type cb_excel from w_com010_d`cb_excel within w_31031_d
end type

type dw_head from w_com010_d`dw_head within w_31031_d
integer x = 27
integer y = 168
integer width = 4727
integer height = 224
string dataobject = "d_31031_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_31031_d
integer beginy = 392
integer endy = 392
end type

type ln_2 from w_com010_d`ln_2 within w_31031_d
integer beginy = 396
integer endy = 396
end type

type dw_body from w_com010_d`dw_body within w_31031_d
integer x = 0
integer y = 408
integer height = 1632
string dataobject = "d_31031_d01"
...
type dw_print from w_com010_d`dw_print within w_31031_d
integer x = 46
integer y = 516
string dataobject = "d_31031_r01"
end type
...
event clicked;if this.checked then 
	dw_body.dataobject = "d_31005_d03_t"
