$PBExportHeader$w_33020_e.srw
$PBExportComments$입고종결처리
forward
global type w_33020_e from w_com010_e
end type
type cbx_cust from checkbox within w_33020_e
end type
end forward
...
string   ls_date , ls_style, ls_chno, ls_last_yn, ls_claim_gubn
...
FOR i=1 TO ll_row_count
	ls_last_yn 	  = dw_body.GetItemString(i,"last_yn")
	ls_claim_gubn = dw_body.GetItemString(i,"t_claim_gubn")
   idw_status = dw_body.GetItemStatus(i, 0, Primary!)
   IF idw_status = NewModified! THEN				/* New Record */
		dw_body.Setitem(i, "reg_id", gs_user_id)
      dw_body.Setitem(i, "last_ymd", ls_date)
		dw_body.SetItem(i, "claim_gubn", ls_claim_gubn)		
...
if il_rows = 1 then    
	 FOR i=1 TO ll_row_count
		...
		IF idw_status = DataModified! THEN		/* Modify Record */				 		 
				 ...
				 DECLARE sp_set_mis_qty PROCEDURE FOR sp_set_mis_qty  
							@style   = :ls_style,   
							@chno 	= :ls_chno,
							@last_yn = :ls_last_yn;
				execute sp_set_mis_qty;	
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_33020_e","0")
end event
...
type cb_close from w_com010_e`cb_close within w_33020_e
end type

type cb_delete from w_com010_e`cb_delete within w_33020_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_33020_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_33020_e
end type

type cb_update from w_com010_e`cb_update within w_33020_e
end type

type cb_print from w_com010_e`cb_print within w_33020_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_33020_e
end type

type gb_button from w_com010_e`gb_button within w_33020_e
end type

type cb_excel from w_com010_e`cb_excel within w_33020_e
end type

type dw_head from w_com010_e`dw_head within w_33020_e
integer x = 32
integer y = 176
integer height = 212
...
type ln_1 from w_com010_e`ln_1 within w_33020_e
integer beginy = 420
integer endy = 420
end type

type ln_2 from w_com010_e`ln_2 within w_33020_e
integer beginx = 9
integer beginy = 660
integer endx = 3630
integer endy = 660
...
type dw_body from w_com010_e`dw_body within w_33020_e
integer y = 436
integer height = 1600
...
CHOOSE CASE dwo.name
	CASE "cb_last"
		If is_check1 = 'N' then
			is_check1 = 'Y'
			This.Object.cb_last.Text = '제외'
		Else
			is_check1 = 'N'
			This.Object.cb_last.Text = '선택'
		End If
		
		ll_row_count = This.RowCount()
		For i = 1 to ll_row_count
			This.SetItem(i, "last_yn", is_check1)
		Next
...
type dw_print from w_com010_e`dw_print within w_33020_e
integer y = 584
string dataobject = "d_33020_r02"
end type
