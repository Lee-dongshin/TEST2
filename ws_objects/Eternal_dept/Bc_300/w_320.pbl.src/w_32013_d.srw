$PBExportHeader$w_32013_d.srw
$PBExportComments$복종별 생산현황
forward
global type w_32013_d from w_com000
end type
type dw_head from u_dw within w_32013_d
end type
type ln_1 from line within w_32013_d
end type
type ln_2 from line within w_32013_d
end type
type dw_list from u_dw within w_32013_d
end type
type dw_body from u_dw within w_32013_d
end type
type st_1 from u_st within w_32013_d
end type
type dw_print from u_dw within w_32013_d
end type
type rb_sojae from radiobutton within w_32013_d
end type
type rb_item from radiobutton within w_32013_d
end type
type rb_cust_cd from radiobutton within w_32013_d
end type
type dw_1 from datawindow within w_32013_d
end type
type gb_1 from groupbox within w_32013_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_32013_d","0")
end event

type cb_close from w_com000`cb_close within w_32013_d
integer taborder = 110
end type

type cb_delete from w_com000`cb_delete within w_32013_d
boolean visible = false
integer x = 1079
integer taborder = 60
end type

type cb_insert from w_com000`cb_insert within w_32013_d
boolean visible = false
integer x = 736
integer taborder = 50
...
type cb_retrieve from w_com000`cb_retrieve within w_32013_d
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_32013_d
boolean visible = false
integer taborder = 100
end type

type cb_print from w_com000`cb_print within w_32013_d
integer x = 1422
integer taborder = 70
end type

type cb_preview from w_com000`cb_preview within w_32013_d
integer x = 1765
integer taborder = 80
boolean enabled = true
end type

type gb_button from w_com000`gb_button within w_32013_d
integer taborder = 0
end type

type cb_excel from w_com000`cb_excel within w_32013_d
integer x = 2107
integer taborder = 90
end type
...
/* 수정일      : 2001..                                                  */
/*===========================================================================*/
string ls_sojae, ls_item, ls_cust_cd
IF row <= 0 THEN Return
...
IF IsNull(is_brand_key) or IsNull(is_year_key) or IsNull(is_season_key) THEN return
il_rows = dw_1.retrieve(is_brand_key, is_year_key, is_season_key, ls_sojae, ls_item, ls_cust_cd, is_make_type, is_country_cd, is_mat_cd)
...
event clicked;if dw_body.dataobject <> "d_32013_d01" then
	dw_body.dataobject = "d_32013_d01"
	dw_body.SetTransObject(SQLCA)
	dw_body.retrieve(is_brand_key, is_year_key, is_season_key, is_item, is_make_type, is_country_cd, is_cust_cd, is_mat_cd)

	dw_print.object.dw_2.dataobject = "d_32013_r01"
	dw_print.SetTransObject(SQLCA)
...
event clicked;if dw_body.dataobject <> "d_32013_d02" then
	dw_body.dataobject = "d_32013_d02"
	dw_body.SetTransObject(SQLCA)
	dw_body.retrieve(is_brand_key, is_year_key, is_season_key, is_item, is_make_type, is_country_cd, is_cust_cd, is_mat_cd)
	
	dw_print.object.dw_2.dataobject = "d_32013_r02"
	dw_print.SetTransObject(SQLCA)
...
event clicked;if dw_body.dataobject <> "d_32013_d03" then
	dw_body.dataobject = "d_32013_d03"
	dw_body.SetTransObject(SQLCA)
	dw_body.retrieve(is_brand_key, is_year_key, is_season_key, is_item, is_make_type, is_country_cd, is_cust_cd, is_mat_cd)
	
	dw_print.object.dw_2.dataobject = "d_32013_r03"
	dw_print.SetTransObject(SQLCA)	
end if
