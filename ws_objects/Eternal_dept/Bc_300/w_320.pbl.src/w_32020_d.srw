$PBExportHeader$w_32020_d.srw
$PBExportComments$사전원가계산서조회(TasseTasse)
forward
global type w_32020_d from w_com010_e
end type
type dw_mast2 from u_dw within w_32020_d
end type
type dw_1 from datawindow within w_32020_d
end type
end forward
...
ll_rows2 = dw_mast2.retrieve(is_style_no,'1')
...
type cb_close from w_com010_e`cb_close within w_32020_d
integer taborder = 120
end type

type cb_delete from w_com010_e`cb_delete within w_32020_d
boolean visible = false
integer taborder = 70
end type

type cb_insert from w_com010_e`cb_insert within w_32020_d
boolean visible = false
integer taborder = 60
boolean enabled = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_32020_d
end type

type cb_update from w_com010_e`cb_update within w_32020_d
boolean visible = false
integer taborder = 110
end type

type cb_print from w_com010_e`cb_print within w_32020_d
integer taborder = 80
end type

type cb_preview from w_com010_e`cb_preview within w_32020_d
integer taborder = 90
end type

type gb_button from w_com010_e`gb_button within w_32020_d
end type

type cb_excel from w_com010_e`cb_excel within w_32020_d
boolean visible = false
integer taborder = 100
end type

type dw_head from w_com010_e`dw_head within w_32020_d
integer y = 164
integer height = 184
...
type ln_1 from w_com010_e`ln_1 within w_32020_d
integer beginy = 356
integer endy = 356
end type

type ln_2 from w_com010_e`ln_2 within w_32020_d
integer beginy = 360
integer endy = 360
end type

type dw_body from w_com010_e`dw_body within w_32020_d
integer y = 1504
integer height = 560
integer taborder = 50
boolean enabled = false
...
type dw_print from w_com010_e`dw_print within w_32020_d
integer x = 201
integer y = 588
