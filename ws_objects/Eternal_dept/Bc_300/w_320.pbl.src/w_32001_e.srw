...
type dw_2 from datawindow within w_32001_e
end type
type st_1 from statictext within w_32001_e
end type
end forward
...
string ls_file_name, ls_style, ls_color,ls_apply_rate
...
//					RETURN 0
			...
			END IF
			   gst_cd.ai_div          = ai_div
				...
				gst_cd.default_where   = " where brand not in ('J','Y') "		//WHERE TB_11010_M.PART_FG IN ('1', '2', '3') 
...
string ls_modify, ls_datetime,ls_title,ls_style, ls_color,ls_file_name
int jj, ii
long ll_row
...
event dw_body::itemchanged;call super::itemchanged;String ls_year, ls_brand ,ls_apply_rate
