$PBExportHeader$w_74018_d.srw
$PBExportComments$회원모집현황(매장별)
forward
global type w_74018_d from w_com010_d
end type
type rb_shop_age from radiobutton within w_74018_d
end type
type rb_shop from radiobutton within w_74018_d
end type
type gb_1 from groupbox within w_74018_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_74018_d","0")
end event

type cb_close from w_com010_d`cb_close within w_74018_d
end type

type cb_delete from w_com010_d`cb_delete within w_74018_d
end type

type cb_insert from w_com010_d`cb_insert within w_74018_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_74018_d
end type

type cb_update from w_com010_d`cb_update within w_74018_d
end type

type cb_print from w_com010_d`cb_print within w_74018_d
end type

type cb_preview from w_com010_d`cb_preview within w_74018_d
end type

type gb_button from w_com010_d`gb_button within w_74018_d
end type

type cb_excel from w_com010_d`cb_excel within w_74018_d
end type

type dw_head from w_com010_d`dw_head within w_74018_d
integer x = 498
integer y = 188
integer width = 3058
integer height = 128
string dataobject = "d_74018_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_74018_d
integer beginy = 352
integer endy = 352
end type

type ln_2 from w_com010_d`ln_2 within w_74018_d
integer beginy = 356
integer endy = 356
end type

type dw_body from w_com010_d`dw_body within w_74018_d
integer y = 364
integer height = 1676
string dataobject = "d_74018_d01"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

type dw_print from w_com010_d`dw_print within w_74018_d
integer x = 658
integer y = 420
integer width = 1829
integer height = 816
string dataobject = "d_74018_r01"
end type
...
dw_body.DataObject = 'd_74018_d01'
dw_print.DataObject = 'd_74018_r01'
...
dw_body.DataObject = 'd_74018_d02'
dw_print.DataObject = 'd_74018_r02'
dw_body.SetTransObject(SQLCA)
dw_print.SetTransObject(SQLCA)
