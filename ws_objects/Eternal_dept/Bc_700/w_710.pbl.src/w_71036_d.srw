$PBExportHeader$w_71036_d.srw
$PBExportComments$상품권 지급/회수 내역
forward
global type w_71036_d from w_com000
end type
type dw_head from u_dw within w_71036_d
end type
type ln_1 from line within w_71036_d
end type
type ln_2 from line within w_71036_d
end type
type dw_body from u_dw within w_71036_d
end type
type dw_print from u_dw within w_71036_d
end type
end forward
...
type variables
string is_brand, is_event_id, is_shop_cd, is_fr_yymmdd, is_to_yymmdd
...
type cb_close from w_com000`cb_close within w_71036_d
integer taborder = 100
end type

type cb_delete from w_com000`cb_delete within w_71036_d
boolean visible = false
integer x = 1083
integer taborder = 50
end type

type cb_insert from w_com000`cb_insert within w_71036_d
boolean visible = false
integer x = 741
integer taborder = 40
end type

type cb_retrieve from w_com000`cb_retrieve within w_71036_d
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_71036_d
boolean visible = false
integer taborder = 90
end type

type cb_print from w_com000`cb_print within w_71036_d
integer x = 1426
integer taborder = 60
end type

type cb_preview from w_com000`cb_preview within w_71036_d
integer x = 1769
integer taborder = 70
end type

type gb_button from w_com000`gb_button within w_71036_d
integer taborder = 0
end type

type cb_excel from w_com000`cb_excel within w_71036_d
integer x = 2112
end type
