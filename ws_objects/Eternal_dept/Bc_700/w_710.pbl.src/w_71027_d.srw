$PBExportHeader$w_71027_d.srw
$PBExportComments$폐점고객 구매내역
forward
global type w_71027_d from w_com010_d
end type
type dw_1 from datawindow within w_71027_d
end type
type dw_member from datawindow within w_71027_d
end type
end forward
...
inv_resize.of_Register(dw_member, "ScaleToRight&Bottom")
...
type cb_close from w_com010_d`cb_close within w_71027_d
end type

type cb_delete from w_com010_d`cb_delete within w_71027_d
end type

type cb_insert from w_com010_d`cb_insert within w_71027_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_71027_d
end type

type cb_update from w_com010_d`cb_update within w_71027_d
end type

type cb_print from w_com010_d`cb_print within w_71027_d
end type

type cb_preview from w_com010_d`cb_preview within w_71027_d
end type

type gb_button from w_com010_d`gb_button within w_71027_d
end type

type cb_excel from w_com010_d`cb_excel within w_71027_d
end type

type dw_head from w_com010_d`dw_head within w_71027_d
integer y = 168
integer height = 148
string dataobject = "d_71027_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_71027_d
integer beginy = 332
integer endy = 332
end type

type ln_2 from w_com010_d`ln_2 within w_71027_d
integer beginy = 336
integer endy = 336
end type

type dw_body from w_com010_d`dw_body within w_71027_d
integer y = 356
integer height = 1656
string dataobject = "d_71027_d01"
...
ll_rows = dw_1.retrieve(is_brand, ls_shop_cd)
if ll_rows > 0 then 
	dw_1.visible = true
end if
...
type dw_print from w_com010_d`dw_print within w_71027_d
string dataobject = "d_71027_r01"
end type
