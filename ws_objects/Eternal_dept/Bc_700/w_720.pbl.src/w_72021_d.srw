$PBExportHeader$w_72021_d.srw
$PBExportComments$매장별 판매/반품 내역현황
forward
global type w_72021_d from w_com000
end type
type dw_head from u_dw within w_72021_d
end type
type ln_1 from line within w_72021_d
end type
type ln_2 from line within w_72021_d
end type
type dw_list from u_dw within w_72021_d
end type
type dw_body from u_dw within w_72021_d
end type
type st_1 from u_st within w_72021_d
end type
type dw_print from u_dw within w_72021_d
end type
type dw_1 from datawindow within w_72021_d
end type
type cb_ListExcel from commandbutton within w_72021_d
end type
end forward
...
dw_print dw_print
dw_1 dw_1
cb_ListExcel cb_ListExcel
end type
global w_72021_d w_72021_d
...
this.cb_ListExcel=create cb_ListExcel
...
this.Control[iCurrent+9]=this.cb_ListExcel
end on

on w_72021_d.destroy
call super::destroy
...
type cb_close from w_com000`cb_close within w_72021_d
integer taborder = 110
end type

type cb_delete from w_com000`cb_delete within w_72021_d
boolean visible = false
integer x = 1079
integer taborder = 60
end type

type cb_insert from w_com000`cb_insert within w_72021_d
boolean visible = false
integer x = 736
integer taborder = 50
...
type cb_retrieve from w_com000`cb_retrieve within w_72021_d
integer taborder = 20
end type
...
type cb_update from w_com000`cb_update within w_72021_d
boolean visible = false
integer taborder = 100
end type

type cb_print from w_com000`cb_print within w_72021_d
integer x = 1422
integer taborder = 70
end type

type cb_preview from w_com000`cb_preview within w_72021_d
integer x = 1765
integer taborder = 80
end type

type gb_button from w_com000`gb_button within w_72021_d
integer taborder = 0
end type

type cb_excel from w_com000`cb_excel within w_72021_d
integer x = 2107
integer taborder = 90
end type
...
//	end choose	
//end if
string ls_shop_cd, ls_style, ls_chno, ls_color, ls_size
...
IF IsNull(ls_shop_cd) THEN return
il_rows = dw_1.retrieve(ls_shop_cd, ls_style, ls_chno, ls_color, ls_size)
dw_1.visible = true
Parent.Trigger Event ue_button(7, il_rows)
Parent.Trigger Event ue_msg(1, il_rows)
end event
