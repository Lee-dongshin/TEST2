$PBExportHeader$w_72013_d.srw
$PBExportComments$매장/일자/스타일별판매조회
forward
global type w_72013_d from w_com010_d
end type
type dw_member from datawindow within w_72013_d
end type
end forward
...
global w_72013_d w_72013_d

type variables
DataWindowChild idw_brand, idw_year, idw_season, idw_area, idw_shop_div, idw_sale_type

String is_fr_ymd, is_to_ymd, is_brand, is_year, is_season, is_area, is_shop_div, is_shop_cd, is_vip
String is_frm_join_date, is_to_join_date
end variables
...
il_rows = dw_body.retrieve(is_fr_ymd, is_to_ymd, is_brand, is_year, is_season,is_area,is_shop_div,is_shop_cd, is_vip, is_frm_join_date, is_to_join_date)
...
is_frm_join_date = dw_head.GetItemString(1, "frm_join_date")
if IsNull(is_frm_join_date) or is_frm_join_date = "" then
 is_frm_join_date = "00000000"
end if


is_to_join_date = dw_head.GetItemString(1, "to_join_date")
if IsNull(is_to_join_date) or is_to_join_date = "" then
 is_to_join_date = "99999999"
end if
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_72013_d","0")
end event

event pfc_preopen();call super::pfc_preopen;dw_member.SetTransObject(SQLCA)
end event

type cb_close from w_com010_d`cb_close within w_72013_d
end type

type cb_delete from w_com010_d`cb_delete within w_72013_d
end type

type cb_insert from w_com010_d`cb_insert within w_72013_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_72013_d
end type

type cb_update from w_com010_d`cb_update within w_72013_d
end type

type cb_print from w_com010_d`cb_print within w_72013_d
end type

type cb_preview from w_com010_d`cb_preview within w_72013_d
end type

type gb_button from w_com010_d`gb_button within w_72013_d
end type

type cb_excel from w_com010_d`cb_excel within w_72013_d
end type

type dw_head from w_com010_d`dw_head within w_72013_d
integer y = 136
integer width = 3401
integer height = 292
string dataobject = "d_72013_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_72013_d
integer beginy = 436
integer endy = 436
end type

type ln_2 from w_com010_d`ln_2 within w_72013_d
integer beginy = 440
integer endy = 440
end type

type dw_body from w_com010_d`dw_body within w_72013_d
integer y = 444
integer height = 1580
string dataobject = "d_72013_d01"
...
type dw_print from w_com010_d`dw_print within w_72013_d
integer height = 588
string dataobject = "d_72013_r01"
end type
