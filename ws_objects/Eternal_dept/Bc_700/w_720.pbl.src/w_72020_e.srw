$PBExportHeader$w_72020_e.srw
$PBExportComments$회원신상정보관리[팝업]
forward
global type w_72020_e from w_com010_e
end type
type dw_3 from datawindow within w_72020_e
end type
type dw_4 from datawindow within w_72020_e
end type
type tab_1 from tab within w_72020_e
end type
...
type dw_6 from datawindow within w_72020_e
end type
type dw_2 from datawindow within w_72020_e
end type
type dw_1 from datawindow within w_72020_e
end type
end forward
...
dw_head.setitem(1,"jumin",gsv_cd.gs_cd5)
...
type cb_close from w_com010_e`cb_close within w_72020_e
end type

type cb_delete from w_com010_e`cb_delete within w_72020_e
boolean visible = false
end type

type cb_insert from w_com010_e`cb_insert within w_72020_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_72020_e
end type

type cb_update from w_com010_e`cb_update within w_72020_e
end type

type cb_print from w_com010_e`cb_print within w_72020_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_72020_e
integer width = 549
boolean enabled = true
string text = "미리보기(구매내역)"
end type

type gb_button from w_com010_e`gb_button within w_72020_e
end type

type cb_excel from w_com010_e`cb_excel within w_72020_e
integer x = 2322
end type

type dw_head from w_com010_e`dw_head within w_72020_e
...
type ln_1 from w_com010_e`ln_1 within w_72020_e
integer beginy = 396
integer endy = 396
end type

type ln_2 from w_com010_e`ln_2 within w_72020_e
integer beginy = 400
integer endy = 400
end type

type dw_body from w_com010_e`dw_body within w_72020_e
integer x = 32
integer y = 524
integer width = 3552
integer height = 1732
...
type dw_print from w_com010_e`dw_print within w_72020_e
