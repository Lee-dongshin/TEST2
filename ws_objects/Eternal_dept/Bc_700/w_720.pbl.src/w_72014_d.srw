$PBExportHeader$w_72014_d.srw
$PBExportComments$스타일별 구매자 조회
forward
global type w_72014_d from w_com010_d
end type
type dw_member from datawindow within w_72014_d
end type
end forward
...
il_rows = dw_body.retrieve(is_style, is_fr_ymd, is_to_ymd, is_brand, is_year, is_season, is_area, is_shop_div, is_shop_cd, is_vip)
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_72014_d","0")
end event

event pfc_preopen();call super::pfc_preopen;dw_member.SetTransObject(SQLCA)
end event

type cb_close from w_com010_d`cb_close within w_72014_d
end type

type cb_delete from w_com010_d`cb_delete within w_72014_d
end type

type cb_insert from w_com010_d`cb_insert within w_72014_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_72014_d
end type

type cb_update from w_com010_d`cb_update within w_72014_d
end type

type cb_print from w_com010_d`cb_print within w_72014_d
boolean visible = false
end type

type cb_preview from w_com010_d`cb_preview within w_72014_d
string text = "Print(&V)"
end type

type gb_button from w_com010_d`gb_button within w_72014_d
end type

type cb_excel from w_com010_d`cb_excel within w_72014_d
end type

type dw_head from w_com010_d`dw_head within w_72014_d
integer height = 312
string dataobject = "d_72014_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_72014_d
integer beginy = 492
integer endy = 492
end type

type ln_2 from w_com010_d`ln_2 within w_72014_d
integer beginx = 5
integer beginy = 488
integer endx = 3625
integer endy = 488
...
type dw_body from w_com010_d`dw_body within w_72014_d
integer y = 524
integer height = 1612
string dataobject = "d_72014_d01"
...
type dw_print from w_com010_d`dw_print within w_72014_d
integer x = 169
integer y = 560
integer height = 588
string dataobject = "d_72014_r01"
end type
