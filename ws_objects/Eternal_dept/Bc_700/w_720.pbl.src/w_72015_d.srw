$PBExportHeader$w_72015_d.srw
$PBExportComments$매장 고객별 구매조회
forward
global type w_72015_d from w_com010_d
end type
type dw_member from datawindow within w_72015_d
end type
end forward
...
event pfc_close();call super::pfc_close;gf_user_connect_pgm(gs_user_id,"w_72015_d","0")
end event

event pfc_preopen();call super::pfc_preopen;dw_member.SetTransObject(SQLCA)
end event

type cb_close from w_com010_d`cb_close within w_72015_d
end type

type cb_delete from w_com010_d`cb_delete within w_72015_d
end type

type cb_insert from w_com010_d`cb_insert within w_72015_d
boolean enabled = false
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_72015_d
end type

type cb_update from w_com010_d`cb_update within w_72015_d
end type

type cb_print from w_com010_d`cb_print within w_72015_d
end type

type cb_preview from w_com010_d`cb_preview within w_72015_d
integer width = 384
end type

type gb_button from w_com010_d`gb_button within w_72015_d
end type

type cb_excel from w_com010_d`cb_excel within w_72015_d
integer x = 2153
end type

type dw_head from w_com010_d`dw_head within w_72015_d
integer height = 196
string dataobject = "d_72015_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_72015_d
integer beginy = 384
integer endy = 384
end type

type ln_2 from w_com010_d`ln_2 within w_72015_d
integer beginx = 5
integer beginy = 380
integer endx = 3625
integer endy = 380
...
type dw_body from w_com010_d`dw_body within w_72015_d
integer y = 400
integer height = 1716
string dataobject = "d_72015_d01"
...
type dw_print from w_com010_d`dw_print within w_72015_d
integer x = 686
integer y = 604
integer height = 588
string dataobject = "d_72015_r01"
end type
