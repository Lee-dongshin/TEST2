...
type prototypes
function long SP_SHOP_LOGIN(string shop_cd,string pass_wd,string new_pass,ref long user_level,ref string brand,ref string user_grp,ref long pi_ret,ref string msg) RPCFUNC ALIAS FOR "dbo.SP_SHOP_LOGIN" 
