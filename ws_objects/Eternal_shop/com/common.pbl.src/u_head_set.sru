...
FOR i=1 TO li_column_count
   ...
   CHOOSE CASE ls_column_nm
      ...
      CASE "season", "mat_season", "fr_season", "to_season" 
			...
			if gs_brand = 'B' and ls_year > '2017' then
				if ls_season = 'S' or ls_season = 'M' then
					ls_season = 'S'
				elseif ls_season = 'A' or ls_season = 'W' then
					ls_season = 'A'
				end if
			else
				ls_season = '%'
      ...
      CASE "house" 
		   adw_head.Setitem(1, ls_column_nm, '010000') 
			adw_head.SetColumn(ls_column_nm)
		CASE "yymmdd", "yymm",  "yyyy", "frm_ymd","fr_ymd", "to_ymd", "fr_yymm", "to_yymm" 
			CHOOSE CASE ls_ColType
				...
				CASE ELSE
					IF ls_column_nm = "yymmdd" or ls_column_nm = "fr_ymd" or ls_column_nm = "to_ymd" or ls_column_nm = "frm_ymd" THEN
