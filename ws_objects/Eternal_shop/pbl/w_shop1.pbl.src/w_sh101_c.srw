...
public function boolean wf_max_seq (string ls_yymmdd, ref long ll_max_seq);  ll_max_seq = 0
  ...
  SELECT  max(point_seq)  
	  into    :ll_max_seq
	  from   beaucre.dbo.tb_71011_h with (nolock)
...
NEXT
  ...
  insert into beaucre.dbo.tb_71011_h(jumin, give_date, point_flag,point_seq,coupon_no, card_no, give_point,accept_flag,Reg_id, give_rate,use_ymd)
