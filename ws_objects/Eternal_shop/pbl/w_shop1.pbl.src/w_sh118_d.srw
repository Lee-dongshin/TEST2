$PBExportHeader$w_sh118_d.srw
$PBExportComments$완불진행사항 조회
forward
global type w_sh118_d from w_com010_d
end type
end forward
...
type cb_close from w_com010_d`cb_close within w_sh118_d
end type

type cb_delete from w_com010_d`cb_delete within w_sh118_d
end type

type cb_insert from w_com010_d`cb_insert within w_sh118_d
end type

type cb_retrieve from w_com010_d`cb_retrieve within w_sh118_d
end type

type cb_update from w_com010_d`cb_update within w_sh118_d
end type

type cb_print from w_com010_d`cb_print within w_sh118_d
boolean visible = false
end type

type cb_preview from w_com010_d`cb_preview within w_sh118_d
boolean visible = false
end type

type gb_button from w_com010_d`gb_button within w_sh118_d
long backcolor = 16777215
end type

type dw_head from w_com010_d`dw_head within w_sh118_d
integer height = 144
string dataobject = "d_sh118_h01"
end type
...
type ln_1 from w_com010_d`ln_1 within w_sh118_d
integer beginy = 320
integer endy = 320
end type

type ln_2 from w_com010_d`ln_2 within w_sh118_d
integer beginy = 324
integer endy = 324
end type

type dw_body from w_com010_d`dw_body within w_sh118_d
integer y = 344
integer width = 2857
integer height = 1440
string dataobject = "d_sh118_d01"
boolean hscrollbar = true
boolean hsplitscroll = true
end type

type dw_print from w_com010_d`dw_print within w_sh118_d
end type
