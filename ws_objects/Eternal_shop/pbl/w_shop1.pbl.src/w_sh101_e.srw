...
if MidA(gs_shop_cd,3,4) >= "1900" and MidA(gs_shop_cd,3,4) <= "1913" then 
	Select brand,     year,     season,     
	 ...
	 where brand = :gs_brand 
		...
		and size  = :ls_size
		and sojae  <> 'C'   ;
elseif MidA(gs_shop_cd,2,5) = "X2710" then 
	Select brand,     year,     season,     
			 sojae,     item,     tag_price,     plan_yn   
	  into :ls_brand, :ls_year, :ls_season, 
			 :ls_sojae, :ls_item, :ll_tag_price, :ls_plan_yn    
...
//					gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and  year + convert(char(01),dbo.sf_inter_sort_seq('003',season))  >=  '20091'  " 				 			
				...
				elseif gs_brand = "B" or gs_brand = "P" or gs_brand = "K" then 					
					...
					if gs_brand = "O" then
						if ls_date <= '20150602' then
//							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20141' ) or ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) = '20141'  and plan_yn = 'Y' )  )" + &
							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20143' ) )" + &
											" or style in (select a.style from tb_56012_d a (nolock)	where a.shop_type = '3'	and a.sale_type = '33' " + &
											" and a.shop_cd = '" + gs_shop_cd + "' and '" + is_yymmdd + "' between a.start_ymd and a.end_ymd " + &
											" and  a.year + a.season in (select year + season from tb_51036_d a (nolock), tb_51035_h b (nolock) where '" + is_yymmdd + "' between a.frm_ymd and a.to_ymd " + &
...
//							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20141' ) or ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) = '20141'  and plan_yn = 'Y' )  )" + &
							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20144' ) )" + &
											" or style in (select a.style from tb_56012_d a (nolock)	where a.shop_type = '3'	and a.sale_type = '33' " + &
											" and a.shop_cd = '" + gs_shop_cd + "' and '" + is_yymmdd + "' between a.start_ymd and a.end_ymd " + &
											" and  a.year + a.season in (select year + season from tb_51036_d a (nolock), tb_51035_h b (nolock) where '" + is_yymmdd + "' between a.frm_ymd and a.to_ymd " + &
											" and a.shop_cd = '" + gs_shop_cd + "' and a.shop_cd = b.shop_cd and a.frm_ymd = b.frm_ymd and b.cancel <> 'Y') )) and sojae <> 'C' and isnull(for_lotte,'N') <> 'Y' "
					...
					elseif gs_brand = "N" then
						if ls_date <= '20150614' then
//							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20133' ) or ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) = '20133'  and plan_yn = 'Y' )  )" + &
//							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20143' ) )" + &
							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20145' ) or ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) = '20144'  and plan_yn = 'Y' )  )" + &							
											" or style in (select a.style from tb_56012_d a (nolock)	where a.shop_type = '3'	and a.sale_type = '33' " + &
											" and a.shop_cd = '" + gs_shop_cd + "' and '" + is_yymmdd + "' between a.start_ymd and a.end_ymd " + &
											" and  a.year + a.season in (select year + season from tb_51036_d a (nolock), tb_51035_h b (nolock) where '" + is_yymmdd + "' between a.frm_ymd and a.to_ymd " + &
											" and a.shop_cd = '" + gs_shop_cd + "' and a.shop_cd = b.shop_cd and a.frm_ymd = b.frm_ymd and b.cancel <> 'Y') )) and sojae <> 'C' and isnull(for_lotte,'N') <> 'Y' "							
...
//							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20133' ) or ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) = '20133'  and plan_yn = 'Y' )  )" + &
//							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20143' ) )" + &
							gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20151' ) or ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) = '20151'  and plan_yn = 'Y' )  )" + &
											" or style in (select a.style from tb_56012_d a (nolock)	where a.shop_type = '3'	and a.sale_type = '33' " + &
											" and a.shop_cd = '" + gs_shop_cd + "' and '" + is_yymmdd + "' between a.start_ymd and a.end_ymd " + &
											" and  a.year + a.season in (select year + season from tb_51036_d a (nolock), tb_51035_h b (nolock) where '" + is_yymmdd + "' between a.frm_ymd and a.to_ymd " + &
											" and a.shop_cd = '" + gs_shop_cd + "' and a.shop_cd = b.shop_cd and a.frm_ymd = b.frm_ymd and b.cancel <> 'Y') )) and sojae <> 'C' and isnull(for_lotte,'N') <> 'Y' "							
					...
					elseif gs_brand = "I" then
						if gs_user_id = 'IE1912' or gs_user_id = 'IG0017' or gs_user_id = 'IG0019' or gs_user_id = 'IG0681' then
							if ls_date <= '20150419' then
//									gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20133' ) )" + &
									gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and ( ( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20143' ) )" + &
												" or style in (select a.style from tb_56012_d a (nolock)	where a.shop_type = '3'	and a.sale_type = '33' " + &
												" and a.shop_cd = '" + gs_shop_cd + "' and '" + is_yymmdd + "' between a.start_ymd and a.end_ymd " + &
												" and  a.year + a.season in (select year + season from tb_51036_d a (nolock), tb_51035_h b (nolock) where '" + is_yymmdd + "' between a.frm_ymd and a.to_ymd " + &
...
//									gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20133' ) )" + &
					...
					elseif gs_brand = 'B' or gs_brand = 'P' or gs_brand = 'K' then
//						gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and ( ( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20093' ) or ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) = '20093'  and plan_yn = 'Y' )  )" + &
						gst_cd.default_where   = "WHERE brand = '" + gs_brand + "' and (( ( year + convert(char(01),dbo.sf_inter_sort_seq('003', SEASON)) > '20101' ) )" + &
										" or style in (select a.style from tb_56012_d a (nolock)	where a.shop_type = '3'	and a.sale_type = '33' " + &
										" and a.shop_cd = '" + gs_shop_cd + "' and '" + is_yymmdd + "' between a.start_ymd and a.end_ymd " + &
										" and  a.year + a.season in (select year + season from tb_51036_d a (nolock), tb_51035_h b (nolock) where '" + is_yymmdd + "' between a.frm_ymd and a.to_ymd " + &
...
if MidA(gs_shop_cd,2,1) = 'I' then //and gs_brand =  "N" then
	messagebox("주의!", '행사(B등급) 매장에서는 사용할 수 없습니다!')
...
//		ls_card_no_origin = dw_body.getitemnumber(i, "card_no")	
	   ...
	   if ii > 1 then 
		...
		if GS_BRAND = "N"  and dw_body.Getitemnumber(i, "sale_qty") > 0 and idw_status = NewModified! THEN  // 반품일때는 처리하지말고 RETURN    
		  if wf_stock_chk(i, ls_style_no1) = false then 
			 IF ls_ok_coupon = "1" THEN 
				MESSAGEBOX("알림!" , "9월10일부터 예약(완불)의 경우 예약(완불)판매 별도 화면에서 등록이 시행됩니다. !")
		  	 ELSE 	
				MESSAGEBOX("알림!" , "9월4일부터 재고가 없는 품번의 판매 제한이 시행됩니다!")
			   return 0
    		 END IF 
		  end	if
		end if				
			...
			if ls_rtrn_yn = 'Y' and ls_shop_type1 <= '2' then
				if ll_rtrn_tag_amt + (ll_real_rtrn_amt * -1) > ll_limit_rtrn_amt then
					messagebox('확인','반품 누적금액이 반품 제한금액을 초과 하였습니다!!!')
						if is_yymmdd >= '20181101' and MidA(gs_shop_cd,1,1) = "O" then 
							Return 0				
						end if	
				end if
			end if
...
if dwo.name <> "sale_type" then return
