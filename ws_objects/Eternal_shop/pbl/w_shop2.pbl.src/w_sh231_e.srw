$PBExportHeader$w_sh231_e.srw
$PBExportComments$WDOT고객관리
forward
global type w_sh231_e from w_com010_e
end type
type tab_1 from tab within w_sh231_e
end type
...
type dw_6 from datawindow within w_sh231_e
end type
type dw_1 from datawindow within w_sh231_e
end type
type dw_3 from datawindow within w_sh231_e
end type
end forward
...
CHOOSE CASE as_column
	...
	CASE "card_no"
			IF ai_div = 1 THEN 	
				IF gf_cust_card_chk('1128003'+ as_data, ls_jumin, ls_user_name,ls_tel_no3) = TRUE THEN
				   dw_head.SetItem(al_row, "user_name", ls_user_name)
...
type cb_close from w_com010_e`cb_close within w_sh231_e
integer x = 2459
integer width = 329
end type

type cb_delete from w_com010_e`cb_delete within w_sh231_e
boolean visible = false
integer x = 1088
end type

type cb_insert from w_com010_e`cb_insert within w_sh231_e
boolean visible = false
end type

type cb_retrieve from w_com010_e`cb_retrieve within w_sh231_e
integer x = 2117
integer width = 329
end type

type cb_update from w_com010_e`cb_update within w_sh231_e
string text = "수정(&S)"
end type

type cb_print from w_com010_e`cb_print within w_sh231_e
boolean visible = false
end type

type cb_preview from w_com010_e`cb_preview within w_sh231_e
boolean visible = false
end type

type gb_button from w_com010_e`gb_button within w_sh231_e
integer x = 14
integer width = 2798
long backcolor = 16777215
end type

type dw_head from w_com010_e`dw_head within w_sh231_e
integer width = 2770
integer height = 120
string dataobject = "d_sh231_h01"
end type
...
type ln_1 from w_com010_e`ln_1 within w_sh231_e
integer beginy = 320
integer endx = 2802
integer endy = 320
end type

type ln_2 from w_com010_e`ln_2 within w_sh231_e
integer beginy = 324
integer endx = 2802
integer endy = 324
end type

type dw_body from w_com010_e`dw_body within w_sh231_e
integer x = 41
integer y = 452
integer width = 2770
integer height = 1544
boolean enabled = false
string dataobject = "d_sh231_d01"
...
type dw_print from w_com010_e`dw_print within w_sh231_e
integer x = 1678
integer y = 512
integer height = 236
end type
